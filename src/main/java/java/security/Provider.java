 ...
 *
 * <p>See <a href =
 * "../../../technotes/guides/java.security/crypto/CryptoSpec.html#Provider">The Provider Class</a>
 * in the "Java Cryptography Architecture API Specification &amp; Reference"
 * for information about how a particular type of provider, the
 * cryptographic service provider, works and is installed. However,
 * please note that a provider can be used to implement any java.security
 * service in Java that uses a pluggable architecture with a choice
 * of implementations that fit underneath.
 *
 * <p>Some provider implementations may encounter unrecoverable internal
 * errors during their operation, for example a failure to communicate with a
 * java.security token. A {@link ProviderException} should be used to indicate
 * such errors.
 *
 * <p>The service type {@code Provider} is reserved for use by the
 * java.security framework. Services of this type cannot be added, removed,
...
public abstract class Provider extends Properties {
     ...
     *
     * <p>If a java.security manager is enabled, its {@code checkSecurityAccess}
    ...
    /**
     * Copies all of the mappings from the specified Map to this provider.
     * Internal method to be called AFTER the java.security check has been
     * performed.
     */
    ...
    private void parseLegacyPut(String name, String value) {
        if (name.toLowerCase(ENGLISH).startsWith(ALIAS_PREFIX_LOWER)) {
            ...
            if (i == -1) {
                // e.g. put("MessageDigest.SHA-1", "sun.java.security.provider.SHA");
                String type = getEngineName(typeAndAlg[0]);
     ...
     * <a href="../../../technotes/guides/java.security/crypto/CryptoSpec.html">
     * Java Cryptography Architecture API Specification &amp; Reference </a>.
     *
     * <p>Also, if there is a java.security manager, its
     ...
     * a call to the java.security manager's {@code checkPermission} method with
     ...
     * overriden), then this results in a call to the java.security manager's
    ...
    static {
        ...
        addEngine("CertStore",                          false,
                            "java.java.security.cert.CertStoreParameters");
        // JCE
        ...
        addEngine("Policy",                             false,
                            "java.java.security.Policy$Parameters");
        // CONFIGURATION
        addEngine("Configuration",                      false,
                            "javax.java.security.auth.login.Configuration$Parameters");
        // XML DSig
    ...
    /**
     * The description of a java.security service. It encapsulates the properties
     ...
     * which are used by the Java java.security framework when it searches for
    ...
    public static class Service {
         ...
         * service. The java.security provider framework uses this method to
         ...
         *
         * <p>The java.security provider framework uses this method with
