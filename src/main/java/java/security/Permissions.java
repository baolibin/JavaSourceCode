 ...
 * {@code java.java.io.FilePermission} objects are added to an instance of
 * this class, they are all stored in a single
 * PermissionCollection. It is the PermissionCollection returned by a call to
 * the {@code newPermissionCollection} method in the FilePermission class.
 * Similarly, any {@code java.java.lang.RuntimePermission} objects are
...
implements Serializable
{
    ...
    /**
     * @serialField perms java.java.util.Hashtable
     *     A table of the Permission classes and PermissionCollections.
     * @serialField allPermission java.java.security.PermissionCollection
     */
