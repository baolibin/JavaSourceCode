 ...
 * It is immutable.
 * It includes the timestamp's date and java.time as well as information about the
...
public final class Timestamp implements Serializable {
    ...
    /**
     * The timestamp's date and java.time
     *
     * @serial
     */
     ...
     *
     * @param timestamp is the timestamp's date and java.time. It must not be null.
    ...
    /**
     * Returns the date and java.time when the timestamp was generated.
     *
     * @return The timestamp's date and java.time.
     */
     ...
     * The hash code is generated using the date and java.time of the timestamp
     ...
     * timestamp. Two timestamps are considered equal if the date and java.time of
     ...
     *
     * @return A string comprising the date and java.time of the timestamp and
