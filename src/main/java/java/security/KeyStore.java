 ...
 * "{@docRoot}/../technotes/guides/java.security/StandardNames.html#KeyStore">
...
public class KeyStore {
    ...
    public static class PasswordProtection implements
         ...
         * "{@docRoot}/../technotes/guides/java.security/StandardNames.html#Cipher">
         ...
         * {@code 'keystore.<type>.keyProtectionAlgorithm'} java.security property.
         * For example, the
         * {@code keystore.PKCS12.keyProtectionAlgorithm} property stores the
         * name of the default key protection algorithm used for PKCS12
         * keystores. If the java.security property is not set, an
     ...
     * {@code keystore.type} java.security property, or the string
     ...
     * {@code keystore.type} java.security property to the desired keystore type.
     *
     * @return the default keystore type as specified by the
     * {@code keystore.type} java.security property, or the string {@literal "jks"}
     * if no such property exists.
     ...
     * password.
     *
     * <p>If the given key is of type {@code java.java.security.PrivateKey},
     ...
     * {@code java.java.security.PrivateKey}).
     *
     * @exception KeyStoreException if the keystore has not been initialized
     ...
     * {@code java.java.security.PrivateKey}, it must be accompanied by a
