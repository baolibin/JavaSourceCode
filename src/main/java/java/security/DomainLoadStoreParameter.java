 ...
 *         keystoreURI="${java.home}/lib/java.security/cacerts";
 *
...
public final class DomainLoadStoreParameter implements LoadStoreParameter {
     ...
     *     {@code java.java.net.URI} fragment component when it is necessary
     ...
     *     A {@code java.java.util.Collections.EMPTY_MAP} should be used
