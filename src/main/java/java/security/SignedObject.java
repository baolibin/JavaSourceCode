 ...
 *     } catch (java.java.lang.ClassNotFoundException e) {};
 * }</pre>
 *
 ...
 * verification in an attempt to bypass a java.security check.
 *
...
public final class SignedObject implements Serializable {
     ...
     * byte array.
     *
     * @return the signature. Returns a new array each java.time this
     * method is called.
     */
