...
/**
 * This class is for java.security permissions.
 ...
 * or you don't.
 * <P>
 * The target name is the name of a java.security configuration parameter (see below).
 ...
 * <tr>
 *   <td>getPolicy</td>
 *   <td>Retrieval of the system-wide java.security policy (specifically, of the
 ...
 * While revealing the policy does not compromise the java.security of
 ...
 * <tr>
 *   <td>setPolicy</td>
 *   <td>Setting of the system-wide java.security policy (specifically,
 ...
 *   <td>Retrieval of the java.security property with the specified key</td>
 *   <td>Depending on the particular key for which access has
 * been granted, the code may have access to the list of java.security
 * providers, as well as the location of the system-wide and user
 * java.security policies.  while revealing this information does not
 * compromise the java.security of the system, it does provide malicious
 ...
 *   <td>Setting of the java.security property with the specified key</td>
 *   <td>This could include setting a java.security provider or defining
 * the location of the system-wide java.security policy.  Malicious
 * code that has permission to set a new java.security provider may
 ...
 * permission to set the location of the system-wide java.security policy
 * may point it to a java.security policy that grants the attacker
 ...
 * certificates that should not be trusted, thereby granting java.applet or
 ...
 * by the system's identity scope, thereby granting java.applet or
