 ...
 * a java.security check that should be made within a given context
...
public final class AccessControlContext {
     ...
     *
     * @exception SecurityException if a java.security manager is installed and the
     ...
     * the java.security check for {@linkplain SecurityConstants.CREATE_ACC_PERMISSION}
     * permission
     */
    AccessControlContext(AccessControlContext acc,
        ...
        //
        // at this point in java.time, we simply throw away the old
     ...
     *          if there is none.
     *
     * @exception SecurityException if a java.security manager is installed and
     ...
     * the java.security policy currently in effect, and the context in
     ...
     * is not permitted, based on the current java.security policy and the
