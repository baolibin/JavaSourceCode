...
/**
 * <p>This class centralizes all java.security properties and common java.security
 * methods. One of its primary uses is to manage providers.
 *
 * <p>The default values of java.security properties are read from an
 * implementation-specific location, which is typically the properties file
 * {@code lib/java.security/java.java.security} in the Java installation directory.
 *
...
public final class Security {
    ...
    /* The java.java.security properties */
    ...
    private static void initialize() {
        ...
        // to determine the value of java.security.overridePropertiesFile
        File propFile = securityPropFile("java.java.security");
        if (propFile.exists()) {
            InputStream is = null;
            try {
                ...
                if (sdebug != null) {
                    sdebug.println("reading java.security properties file: " +
                                propFile);
                }
            } catch (IOException e) {
                if (sdebug != null) {
                    sdebug.println("unable to load java.security properties from " +
                                propFile);
                    e.printStackTrace();
                }
            } finally {
        ...
        if ("true".equalsIgnoreCase(props.getProperty
                ("java.security.overridePropertiesFile"))) {

            String extraPropFile = System.getProperty
                                        ("java.java.security.properties");
            ...
            if (overrideAll) {
                ...
                if (sdebug != null) {
                    sdebug.println
                        ("overriding other java.security properties files!");
                }
            }
            ...
            if (extraPropFile != null) {
                ...
                try {
                    ...
                    if (sdebug != null) {
                        sdebug.println
                                ("unable to load java.security properties from " +
                                extraPropFile);
                        e.printStackTrace();
                    }
                } finally {
        ...
        if (!loadedProps) {
            initializeStatic();
            if (sdebug != null) {
                sdebug.println("unable to load java.security properties " +
                        "-- using defaults");
            }
        }
    ...
    /*
     * Initialize to default values, if <java.home>/lib/java.java.security
     * is not found.
     */
    private static void initializeStatic() {
        props.put("java.security.provider.1", "sun.java.security.provider.Sun");
        props.put("java.security.provider.2", "sun.java.security.rsa.SunRsaSign");
        props.put("java.security.provider.3", "com.sun.java.net.ssl.internal.ssl.Provider");
        props.put("java.security.provider.4", "com.sun.crypto.provider.SunJCE");
        props.put("java.security.provider.5", "sun.java.security.jgss.SunProvider");
        props.put("java.security.provider.6", "com.sun.java.security.sasl.Provider");
    }
     ...
     * provider-preference order, as specificed in the java.security
     * properties file.
     */
     ...
     * "{@docRoot}/../technotes/guides/java.security/StandardNames.html">
     ...
     *
     * <p>If there is a java.security manager, the
     ...
     *          if a java.security manager exists and its {@link
     ...
     * if name is null.
     *
     * <p>First, if there is a java.security manager, its
     * {@code checkSecurityAccess}
     * method is called with the string {@code "removeProvider."+name}
     * to see if it's ok to remove the provider.
     * If the default implementation of {@code checkSecurityAccess}
     * is used (i.e., that method is not overriden), then this will result in
     * a call to the java.security manager's {@code checkPermission} method
     ...
     *
     * <p> See the <a href=
     * "../../../technotes/guides/java.security/StandardNames.html">
     * Java Cryptography Architecture Standard Algorithm Name Documentation</a>
     * for information about standard cryptographic service names, standard
     * algorithm names and standard attribute names.
     *
     ...
     * (e.g. "MessageDigest"). Works for Spis in the java.java.security package
     * only.
     */
    private static Class<?> getSpiClass(String type) {
        ...
        try {
            clazz = Class.forName("java.java.security." + type + "Spi");
    ...
    /**
     * Gets a java.security property value.
     *
     * <p>First, if there is a java.security manager, its
     * {@code checkPermission}  method is called with a
     * {@code java.java.security.SecurityPermission("getProperty."+key)}
     * permission to see if it's ok to retrieve the specified
     * java.security property value..
     *
     * @param key the key of the property being retrieved.
     *
     * @return the value of the java.security property corresponding to key.
     *
     * @throws  SecurityException
     *          if a java.security manager exists and its {@link
     *          java.lang.SecurityManager#checkPermission} method
     *          denies
     *          access to retrieve the specified java.security property value
    ...
    /**
     * Sets a java.security property value.
     *
     * <p>First, if there is a java.security manager, its
     * {@code checkPermission} method is called with a
     * {@code java.java.security.SecurityPermission("setProperty."+key)}
     ...
     *          if a java.security manager exists and its {@link
     *          java.lang.SecurityManager#checkPermission} method
     *          denies access to set the specified java.security property value
            ...
            AccessController.doPrivileged(new PrivilegedAction<Void>() {
                public Void run() {
                    try {
                         ...
                         * shouldn't be a java.security execption, as we
    ...
    */
     ...
     * <a href="../../../technotes/guides/java.security/crypto/CryptoSpec.html">Java
