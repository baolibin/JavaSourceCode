 ...
 * resource is to be allowed or denied, based on the java.security policy
 * currently in effect,
 ...
 * // that java.time is stored and associated with the new thread, as the
 * // "inherited" context.
 *
 ...
 *
 *
 * <p> Note that {@code checkPermission} always performs java.security checks
...
public final class AccessController {
     ...
     * <p>
     * If a java.security manager is installed and the specified
     ...
     * the current AccessControlContext and java.security policy.
     ...
     *            is not permitted, based on the current java.security policy.
     * @exception NullPointerException if the specified permission
     *            is {@code null} and is checked based on the
     *            java.security policy currently in effect.
     */
