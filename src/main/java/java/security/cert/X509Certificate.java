 ...
 * other functionality in Internet java.security systems. Common applications
...
implements X509Extension {
     ...
     * the current date and java.time are within the validity period given in the
     * certificate.
     * <p>
     * The validity period consists of two date/java.time values:
     ...
     * certificate would be valid at the given date/java.time.
     *
     * @param date the Date to check against to see if this certificate
     *        is valid at that date/java.time.
     *
     * @exception CertificateExpiredException if the certificate has expired
     ...
     * to handle the possibility of reuse of issuer names over java.time.
