 ...
 * is a java.time-stamped list identifying revoked certificates, and RFC 5280
...
public abstract class PKIXRevocationChecker extends PKIXCertPathChecker {
     ...
     * overrides the {@code ocsp.responderURL} java.security property and any
     ...
     * overrides the {@code ocsp.responderURL} java.security property. If this
     ...
     * and {@code ocsp.responderCertSerialNumber} java.security properties.
     *
     ...
     * {@code ocsp.responderCertSubjectName},
     * {@code ocsp.responderCertIssuerName},
     * and {@code ocsp.responderCertSerialNumber} java.security properties. If this
     ...
     * is set. The list is cleared each java.time {@link #init init} is called.
