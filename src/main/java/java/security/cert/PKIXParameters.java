 ...
 * the current java.time when the path is validated. The default for the
...
public class PKIXParameters implements CertPathParameters {
     ...
     * are not of type {@code java.java.security.cert.TrustAnchor}
     */
        ...
        for (Iterator<TrustAnchor> i = trustAnchors.iterator(); i.hasNext(); ) {
            if (!(i.next() instanceof TrustAnchor)) {
                throw new ClassCastException("all elements of set must be "
                    + "of type java.java.security.cert.TrustAnchor");
            }
        }
     ...
     * not of type {@code java.java.security.cert.CertStore}
     *
     * @see #getCertStores
     */
            ...
            for (Iterator<CertStore> i = stores.iterator(); i.hasNext();) {
                if (!(i.next() instanceof CertStore)) {
                    throw new ClassCastException("all elements of list must be "
                        + "of type java.java.security.cert.CertStore");
                }
            }
    ...
    /**
     * Returns the java.time for which the validity of the certification path
     * should be determined. If {@code null}, the current java.time is used.
     * <p>
    ...
    /**
     * Sets the java.time for which the validity of the certification path
     * should be determined. If {@code null}, the current java.time is used.
     * <p>
     ...
     * are not of type {@code java.java.security.cert.PKIXCertPathChecker}
