 ...
 * "{@docRoot}/../technotes/guides/java.security/StandardNames.html#CertPathValidator">
...
public class CertPathValidator {
     ...
     * the {@code certpathvalidator.type} java.security property, or the string
     ...
     * setting the value of the {@code certpathvalidator.type} java.security
     ...
     * by the {@code certpathvalidator.type} java.security property, or the string
     * {@literal "PKIX"} if no such property exists.
     */
