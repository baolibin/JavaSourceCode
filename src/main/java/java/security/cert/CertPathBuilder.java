 ...
 * "{@docRoot}/../technotes/guides/java.security/StandardNames.html#CertPathBuilder">
...
public class CertPathBuilder {
     ...
     * the {@code certpathbuilder.type} java.security property, or the string
     ...
     * setting the value of the {@code certpathbuilder.type} java.security property
     * to the desired type.
     *
     * @see java.security.Security java.security properties
     * @return the default {@code CertPathBuilder} type as specified
     * by the {@code certpathbuilder.type} java.security property, or the string
     * {@literal "PKIX"} if no such property exists.
     */
