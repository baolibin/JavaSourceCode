 ...
 * does not yet exist at the java.time the Policy is initialized (see below).
 *
 ...
 * to instantiate a java.java.io.FilePermission, since the
...
implements java.io.Serializable
{
     ...
     * Returns a new array each java.time this method is called.
     *
     * @since 1.5
     */
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        if (size > 0) {
            ...
            // could all be present in the stream at the same java.time
