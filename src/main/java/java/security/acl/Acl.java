 ...
 * </ul>
 *
 * The {@code  java.java.security.acl } package provides the
 * interfaces to the ACL and related data structures (ACL entries,
 * groups, permissions, etc.), and the {@code  sun.java.security.acl }
 * classes provide a default implementation of the interfaces. For
 * example, {@code  java.java.security.acl.Acl } provides the
 * interface to an ACL and the {@code  sun.java.security.acl.AclImpl }
 * class provides the default implementation of the interface.<p>
 *
 * The {@code  java.java.security.acl.Acl } interface extends the
 * {@code  java.java.security.acl.Owner } interface. The Owner
