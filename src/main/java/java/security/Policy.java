 ...
 * java.security-sensitive operation.
 *
 * <p> There is only one Policy object installed in the runtime at any
 * given java.time.  A Policy object can be installed by calling the
 ...
 * of the {@code policy.provider} java.security property to the fully qualified
 ...
 * @see java.security.Security java.security properties
 */
...
public abstract class Policy {
    ...
    /**
     * Returns the installed Policy object, skipping the java.security check.
            ...
            synchronized (Policy.class) {
                ...
                if (pinfo.policy == null) {
                    ...
                    if (policy_class == null) {
                        policy_class = "sun.java.security.provider.PolicyFile";
                    }
                    ...
                    try {
                        ...
                        if (pol != null) {
                            ...
                            if (debug != null) {
                                debug.println("using sun.java.security.provider.PolicyFile");
                            }
    ...
    private static void initPolicy (final Policy p) {
         ...
         * java.security checks fulfilling a call to either Policy.implies
         * or Policy.getPermissions. If this does occur the provider
         * must be able to answer for it's own ProtectionDomain
         * without triggering additional java.security checks, otherwise
         ...
         * so that the provider can be java.security checked while processing
     ...
     *    <a href=
     *    "{@docRoot}/../technotes/guides/java.security/StandardNames.html#Policy">
