 ...
 * "{@docRoot}/../technotes/guides/java.security/StandardNames.html#Signature">
...
public abstract class Signature extends SignatureSpi {
     ...
     * algorithm.
     *
     * <p> This method traverses the list of registered java.security Providers,
    ...
    static {
        ...
        signatureInfo.put("sun.java.security.provider.DSA$RawDSA", TRUE);
        signatureInfo.put("sun.java.security.provider.DSA$SHA1withDSA", TRUE);
        signatureInfo.put("sun.java.security.rsa.RSASignature$MD2withRSA", TRUE);
        signatureInfo.put("sun.java.security.rsa.RSASignature$MD5withRSA", TRUE);
        signatureInfo.put("sun.java.security.rsa.RSASignature$SHA1withRSA", TRUE);
        signatureInfo.put("sun.java.security.rsa.RSASignature$SHA256withRSA", TRUE);
        signatureInfo.put("sun.java.security.rsa.RSASignature$SHA384withRSA", TRUE);
        signatureInfo.put("sun.java.security.rsa.RSASignature$SHA512withRSA", TRUE);
        signatureInfo.put("com.sun.java.net.ssl.internal.ssl.RSASignature", TRUE);
        signatureInfo.put("sun.java.security.pkcs11.P11Signature", TRUE);
    }
     ...
     * in the java.security provider list.
     *
     * <p> Note that the list of registered providers may be retrieved via
     * the {@link Security#getProviders() Security.getProviders()} method.
     *
     ...
     *          registered in the java.security provider list.
     *
     ...
     * and cannot be set again, a java.security exception occurs, and so on.
     *
     * @see #getParameter
     *
     * @deprecated Use
     ...
     * parameter is desirable but left unspecified at this java.time.
     *
