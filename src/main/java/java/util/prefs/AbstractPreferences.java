 ...
 * java.time.  While implementations are not required to throw an exception under
 ...
 * <i>strongly</i> encouraged to determine the user at the java.time preferences
...
public abstract class AbstractPreferences extends Preferences {
    ...
    private void removeNode2() throws BackingStoreException {
        synchronized(lock) {
            ...
            // Now we have no descendants - it's java.time to die!
            removeNodeSpi();
            removed = true;
     ...
     * was computed at the java.time that this node was constructed (based on
     ...
     * association cannot be determined at this java.time.  It is guaranteed that
     ...
     *          key, or the association cannot be determined at this java.time.
     */
     ...
     * it contains.  The named child will have no descendants at the java.time this
     ...
     * last java.time that it was removed.  In other words, a cached value will
     ...
     * after the last java.time that it was removed.  In other words, a cached
    ...
    /**
     * This method starts the event dispatch thread the first java.time it
