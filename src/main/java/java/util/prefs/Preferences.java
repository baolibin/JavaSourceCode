 ...
 * node has an arbitrary node name, specified at the java.time it is created.  The
 ...
 * <tt>java.java.util.prefs.PreferencesFactory</tt> is defined, then it is
 ...
 * <tt>java.java.util.prefs.PreferencesFactory</tt> in the resource
...
public abstract class Preferences {
            ...
            new PrivilegedAction<String>() {
                public String run() {
                    return System.getProperty(
                        "java.java.util.prefs.PreferencesFactory");}});
        if (factoryName != null) {
    ...
    private static PreferencesFactory factory1() {
        ...
        while (itr.hasNext()) {
            try {
                ...
                if (sce.getCause() instanceof SecurityException) {
                    // Ignore the java.security exception, try the next provider
                    continue;
                }
                throw sce;
            }
        ...
        if (osName.startsWith("Windows")) {
            platformFactory = "java.java.util.prefs.WindowsPreferencesFactory";
        } else if (osName.contains("OS X")) {
            platformFactory = "java.java.util.prefs.MacOSXPreferencesFactory";
        } else {
            platformFactory = "java.java.util.prefs.FileSystemPreferencesFactory";
        }
        try {
            return (PreferencesFactory)
     ...
     * preferences node and decreases the likelihood of a run-java.time failure.
     * (If the class name is misspelled, it will typically result in a
     * compile-java.time error.)
     *
     ...
     * at any java.time.  They do not need to wait for this method to be called.
     *
