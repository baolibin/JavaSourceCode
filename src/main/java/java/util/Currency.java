 ...
 * property {@code java.java.util.currency.data}. If this system property is
 ...
 * loading java.time. The format of the timestamp must be of ISO 8601 format :
...
public final class Currency implements Serializable {
    ...
    // - scCutOverTimes: cut-over java.time in millis as returned by
    ...
    static {
        AccessController.doPrivileged(new PrivilegedAction<Void>() {
            ...
            public Void run() {
                ...
                String propsFile = System.getProperty("java.java.util.currency.data");
                if (propsFile == null) {
     ...
     * are ignored. The result may vary over java.time, as countries change their
     * currencies. For example, for the original member countries of the
     * European Monetary Union, the method returns the old national currencies
     * until December 31, 2001, and the Euro from January 1, 2002, local java.time
     ...
     *    UTC java.time is past 1st January 2014 00:00:00 GMT.
     */
    ...
    private static void info(String message, Throwable t) {
        PlatformLogger logger = PlatformLogger.getLogger("java.java.util.Currency");
