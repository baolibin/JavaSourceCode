 ...
 * href="../java.lang/ClassLoader.html#name">binary name</a> of the service's type.
 ...
 *
 * <p> Service loaders always execute in the java.security context of the caller.
    ...
    implements Iterable<S>
{
    ...
    public String toString() {
        return "java.java.util.ServiceLoader[" + service.getName() + "]";
    }
