...
/**
 * A simple java.text scanner which can parse primitive types and strings using
 * regular expressions.
 *
 ...
 * space at a java.time.
 *
 * <p> A scanner can read java.text from any object which implements the {@link
...
public final class Scanner implements Iterator<String>, Closeable {
    ...
    public String toString() {
        ...
        sb.append("java.java.util.Scanner");
     ...
     * @return the java.text that matched the specified pattern
     * @throws IllegalStateException if this scanner is closed
     */
