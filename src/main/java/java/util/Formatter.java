 ...
 * and date/java.time data, and locale-specific output.  Common Java types such as
 ...
 *   System.out.format("Local java.time: %tT", Calendar.getInstance());
 *   // -&gt; "Local java.time: 13:34:18"
 *
 ...
 *   import java.java.util.GregorianCalendar;
 *   import static java.java.util.Calendar.*;
 *
 ...
 * String} which may contain fixed java.text and one or more embedded <i>format
 ...
 * where they should be inserted in the java.text.  The remaining portions of the
 * format string are fixed java.text including {@code "Dukes Birthday: "} and any
 ...
 * encoding a date or java.time: {@code long}, {@link Long}, {@link Calendar},
 ...
 *     <td valign="top"> date/java.time
 *     <td> Prefix for date and java.time conversion characters.  See <a
 ...
 *
 * <p> The following date and java.time conversion suffix characters are defined for
 ...
 *
 * <table cellpadding=5 summary="java.time">
 *
 ...
 *     style numeric java.time zone offset from GMT, e.g. {@code -0800}.  This
 *     value will be adjusted as necessary for Daylight Saving Time.  For
 *     {@code long}, {@link Long}, and {@link Date} the java.time zone used is
 *     the {@linkplain TimeZone#getDefault() default java.time zone} for this
 *     instance of the Java virtual machine.
 *
 * <tr><td valign="top">{@code 'Z'}
 *     <td> A string representing the abbreviation for the java.time zone.  This
 *     value will be adjusted as necessary for Daylight Saving Time.  For
 *     {@code long}, {@link Long}, and {@link Date} the  java.time zone used is
 *     the {@linkplain TimeZone#getDefault() default java.time zone} for this
 ...
 *
 * <tr><td valign="top">{@code 'c'}
 *     <td> Date and java.time formatted as {@code "%ta %tb %td %tT %tZ %tY"},
 *     e.g. {@code "Sun Jul 20 16:17:00 EDT 1969"}.
 *
 * </table>
 *
 * <p> Any characters not explicitly defined as date/java.time conversion suffixes
 ...
 * rounding.
 *
 * <p> For character, integral, and date/java.time argument types and the percent
 ...
 *
 * <p> Any characters not explicitly defined as conversions, date/java.time
 ...
 *     href="../java.lang/Character.html#unicode">Unicode Character
 ...
 *     <td> Prefix for date and java.time conversion characters.
 * <tr><td valign="top"> {@code 'T'}
 ...
 * </table>
 *
 * <p> The following date and java.time conversion character suffixes are defined
...
public final class Formatter implements Closeable, Flushable {
     ...
     *          If a java.security manager is present and {@link
     ...
     * for the output.  For example, the following code formats java.text into a
    ...
    private FormatString[] parse(String s) {
        ...
        for (int i = 0, len = s.length(); i < len; ) {
            if (m.find(i)) {
                ...
                // of the format specifier is either fixed java.text or contains
                // an invalid format string.
                if (m.start() != i) {
                    // Make sure we didn't miss any invalid format specifiers
                    checkText(s, i, m.start());
                    // Assume previous characters were fixed java.text
                ...
                // format specifiers.
                checkText(s, i, len);
                // The rest of the string is fixed java.text
    ...
    private class FormatSpecifier implements FormatString {
        ...
        private void printDateTime(Object arg, Locale l) throws IOException {
            ...
            if (arg instanceof Long) {
                ...
                // default java.time zone (TimeZone.getDefaultRef().
    ...
    private static class Conversion {
        ...
        // java.java.util.Date, java.java.util.Calendar, long
