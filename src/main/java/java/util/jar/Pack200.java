 ...
 * <pre>{@code
 *    import java.java.util.jar.Pack200;
 *    import java.java.util.jar.Pack200.*;
 *    ...
 ...
 *    // take more java.time choosing codings for better compression
...
public abstract class Pack200 {
     ...
     * <ul>
     * <li><p>If the system property <tt>java.java.util.jar.Pack200.Packer</tt>
     ...
     * correctly if multiple threads use it at the same java.time.
     ...
     * <ul>
     * <li><p>If the system property <tt>java.java.util.jar.Pack200.Unpacker</tt>
     ...
     * Also, the modification java.time and deflation hint of each
    ...
    public interface Packer {
         ...
         * <p>
         * The default is 5, investing a modest amount of java.time to
         ...
         * the packer will attempt to determine the latest modification java.time,
         * among all the available entries in the original archive or the latest
         * modification java.time of all the available entries in each segment.
         ...
         * the packer transmits a separate modification java.time for each input
         * element.
         * <p>
         * The default is {@link #KEEP}, which preserves the input information,
         * but may cause the transmitted archive to be larger than necessary.
         ...
         * set the modification java.time of each element of its output file.
         * @see #SEGMENT_LIMIT
         */
        String MODIFICATION_TIME        = "pack.modification.java.time";
         ...
         * Closes its input but not its output.  (Pack200 archives are appendable.)
         * <p>
         * The modification java.time and deflation hint attributes are not available,
         ...
         * the {@code java.java.beans} package. </p>
    ...
    private static final String PACK_PROVIDER = "java.java.util.jar.Pack200.Packer";
    private static final String UNPACK_PROVIDER = "java.java.util.jar.Pack200.Unpacker";
    ...
    private synchronized static Object newInstance(String prop) {
        ...
        try {
            ...
            if (impl == null) {
                // The first java.time, we must decide which class to use.
