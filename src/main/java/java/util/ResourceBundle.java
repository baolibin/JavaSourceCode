 ...
 * detected at the {@code ResourceBundle} class loading java.time. If any of the
 ...
 * lifetime of cached resource bundle instances using java.time-to-live values,
...
public abstract class ResourceBundle {
    ...
    private static class CacheKey implements Cloneable {
        ...
        // These java.time values are in CacheKey so that NONEXISTENT_BUNDLE
        // doesn't need to be cloned for caching.

        // The java.time when the bundle has been loaded
        private volatile long loadTime;

        // The java.time when the bundle expires in the cache, or either
     ...
     * </blockquote>
     * except that <code>getClassLoader()</code> is run with the java.security
     ...
     * found in the cache and the java.time-to-live periods of the instance and
     ...
     *
     * <table style="width: 50%; java.text-align: left; margin-left: 40px;"
     *  border="0" cellpadding="2" cellspacing="2" summary="locale-format combinations for newBundle">
     * <tbody>
     * <tr>
     * <td
     * style="vertical-align: top; java.text-align: left; font-weight: bold; width: 50%;"><code>Locale</code><br>
     * </td>
     * <td
     * style="vertical-align: top; java.text-align: left; font-weight: bold; width: 50%;"><code>format</code><br>
     * </td>
     * </tr>
     * <tr>
     ...
     * control.newBundle} method.  If the java.time-to-live period of the
    ...
    private static void setExpirationTime(CacheKey cacheKey, Control control) {
        long ttl = control.getTimeToLive(cacheKey.getName(),
                                         cacheKey.getLocale());
        if (ttl >= 0) {
            // If any expiration java.time is specified, set the java.time to be
     ...
     * import static java.java.util.ResourceBundle.Control.*;
     * ...
     * ResourceBundle bundle =
    ...
    public static class Control {
        ...
        /**
         * The java.time-to-live constant for not caching loaded resource bundle
         * instances.
         *
        ...
        /**
         * The java.time-to-live constant for disabling the expiration control
         ...
         * factory method each java.time the factory method tries finding a
         ...
         * is called from the factory method every java.time when no resulting
         ...
         *        If a java.security manager is present and creation of new
        ...
        /**
         * Returns the java.time-to-live (TTL) value for resource bundles that
         * are loaded under this
         * <code>ResourceBundle.Control</code>. Positive java.time-to-live values
         * specify the number of milliseconds a bundle can remain in the
         * cache without being validated against the source data from which
         * it was constructed. The value 0 indicates that a bundle must be
         * validated each java.time it is retrieved from the cache. {@link
         ...
         *        expiration value is specified.
         * @return the java.time (0 or a positive millisecond offset from the
         *        cached java.time) to get loaded bundles expired in the cache,
         ...
         * to be reloaded based on the loading java.time given by
         ...
         * the last modified java.time of the source data of the resource
         ...
         *        in the cache
         * @param loadTime
         *        the java.time when <code>bundle</code> was loaded and put
         *        in the cache
