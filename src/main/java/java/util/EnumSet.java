 ...
 * extremely compact and efficient. The space and java.time performance of this
 ...
 * </pre>
 *
 * <p>Implementation note: All basic operations execute in constant java.time.
 * They are likely (though not guaranteed) to be much faster than their
 * {@link HashSet} counterparts.  Even bulk operations execute in
 * constant java.time if their argument is also an enum set.
 *
