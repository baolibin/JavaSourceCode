 ...
 * specified in the {@code java.java.util.logging.SimpleFormatter.format}
...
public class SimpleFormatter extends Formatter {
     ...
     * {@code java.java.util.logging.SimpleFormatter.format}</a> property.
     ...
     *     java.java.util.Formatter} format string specified in the
     *     {@code java.java.util.logging.SimpleFormatter.format} property
     *     or the default format.</li>
     * <li>{@code date} - a {@link Date} object representing
     *     {@linkplain LogRecord#getMillis event java.time} of the log record.</li>
     ...
     *     method.  It uses {@link java.text.MessageFormat java.java.text}
     *     formatting and does not use the {@code java.java.util.Formatter
     *     format} argument.</li>
     ...
     * <ul>
     * <li> {@code java.java.util.logging.SimpleFormatter.format="%4$s: %5$s [%1$tc]%n"}
     ...
     *     </pre></li>
     * <li> {@code java.java.util.logging.SimpleFormatter.format="%1$tc %2$s%n%4$s: %5$s%6$s%n"}
     ...
     *     java.java.lang.IllegalArgumentException: invalid argument
     *             at MyClass.mash(MyClass.java:9)
     *             at MyClass.crunch(MyClass.java:6)
     *             at MyClass.main(MyClass.java:3)
     *     </pre></li>
     * <li> {@code java.java.util.logging.SimpleFormatter.format="%1$tb %1$td, %1$tY %1$tl:%1$tM:%1$tS %1$Tp %2$s%n%4$s: %5$s%n"}
     *      <p>This prints 2 lines similar to the example above
     *         with a different date/java.time formatting and does not print
