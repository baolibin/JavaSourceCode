 ...
 * java.java.util.logging.manager system property.
 * <p>
 * The LogManager defines two optional system properties that allow control over
 * the initial configuration:
 * <ul>
 * <li>"java.java.util.logging.config.class"
 * <li>"java.java.util.logging.config.file"
 * </ul>
 ...
 * <p>
 * If the "java.java.util.logging.config.class" property is set, then the
 ...
 * <p>
 * If "java.java.util.logging.config.class" property is <b>not</b> set,
 * then the "java.java.util.logging.config.file" system property can be used
 * to specify a properties file (in java.java.util.Properties format). The
...
public class LogManager {
    ...
    // (Must be done after a suitable amount of java.java.lang.System
    ...
    static {
        manager = AccessController.doPrivileged(new PrivilegedAction<LogManager>() {
            ...
            public LogManager run() {
                ...
                String cname = null;
                try {
                    cname = System.getProperty("java.java.util.logging.manager");
                    if (cname != null) {
                        try {
                    ...
                    try {
                        AccessController.doPrivileged(new PrivilegedExceptionAction<Void>() {
                                ...
                                public Void run() throws Exception {
                                    ...
                                    // Platform loggers begin to delegate to java.java.util.logging.Logger
     ...
     * Profiles of Java SE that do not include the {@code java.java.beans} package.
     * </p>
     *
     * @param l  event listener
     * @exception  SecurityException  if a java.security manager exists and if
    ...
    private LoggerContext getUserContext() {
        ...
        if (sm != null && javaAwtAccess != null) {
            // for each java.applet, it has its own LoggerContext isolated from others
            final Object ecx = javaAwtAccess.getAppletContext();
            if (ecx != null) {
                synchronized (javaAwtAccess) {
                    // find the AppContext of the java.applet code
                    ...
                    if (context == null) {
                        // Create a new LoggerContext for the java.applet.
    ...
    private static void doSetLevel(final Logger logger, final Level level) {
        SecurityManager sm = System.getSecurityManager();
        if (sm == null) {
            // There is no java.security manager, so things are easy.
            logger.setLevel(level);
            return;
        }
        // There is a java.security manager.  Raise privilege before
        // calling setLevel.
        AccessController.doPrivileged(new PrivilegedAction<Object>() {
            @Override
            public Object run() {
     ...
     * find Loggers for java.security sensitive logging.
     * It is also important to note that the Logger associated with the
     * String {@code name} may be garbage collected at any java.time if there
     ...
     * java.time since its name was returned by this method.
     * <p>
    ...
    public void readConfiguration() throws IOException, SecurityException {
        ...
        String cname = System.getProperty("java.java.util.logging.config.class");
        if (cname != null) {
            try {
        ...
        String fname = System.getProperty("java.java.util.logging.config.file");
        if (fname == null) {
    ...
    /**
     * Reinitialize the logging properties and reread the logging configuration
     * from the given stream, which should be in java.java.util.Properties format.
     * A PropertyChangeEvent will be fired after the properties are read.
     * <p>
     * Any log level definitions in the new configuration file will be
     * applied using Logger.setLevel(), if the target Logger exists.
    ...
    public final static String LOGGING_MXBEAN_NAME
        = "java.java.util.logging:type=Logging";
    ...
    /**
     * A class that provides access to the java.java.beans.PropertyChangeListener
     * and java.java.beans.PropertyChangeEvent without creating a static dependency
     * on java.java.beans. This class can be removed once the addPropertyChangeListener
     * and removePropertyChangeListener methods are removed.
     */
    private static class Beans {
        private static final Class<?> propertyChangeListenerClass =
            getClass("java.java.beans.PropertyChangeListener");

        private static final Class<?> propertyChangeEventClass =
            getClass("java.java.beans.PropertyChangeEvent");
        ...
        /**
         * Returns {@code true} if java.java.beans is present.
         */
