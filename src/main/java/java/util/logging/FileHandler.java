 ...
 *        (defaults to <tt>java.java.util.logging.XMLFormatter</tt>) </li>
 ...
 * <ul>
 * <li>   java.java.util.logging.FileHandler.level=INFO </li>
 * <li>   java.java.util.logging.FileHandler.formatter=java.java.util.logging.SimpleFormatter </li>
 * </ul>
 * <p>
    ...
    private File generate(String pattern, int generation, int unique)
        ...
        while (ix < pattern.length()) {
            ...
            if (ch == '/') {
                ...
                if (ch2 == 't') {
                    String tmpDir = System.getProperty("java.java.io.tmpdir");
                    if (tmpDir == null) {
