 ...
 * as java.java.net or javax.swing.  In addition it is possible to create
 ...
 * may be garbage collected at any java.time if a strong reference to the
 * Logger is not kept.
 * <p>
 ...
 * java.java.text.MessageFormat style formatting to format parameters, so
...
public class Logger {
    ...
    static final String SYSTEM_LOGGER_RB_NAME = "sun.java.util.logging.resources.logging";
    ...
    public static final Logger getGlobal() {
        ...
        // but the other thread could come in at a java.time when global.manager
     ...
     *                          of the subsystem, such as java.java.net
    ...
    // Until all JDK code converted to call sun.java.util.logging.PlatformLogger
    ...
    private static class SystemLoggerHelper {
        static boolean disableCallerCheck = getBooleanProperty("sun.java.util.logging.disableCallerCheck");
     ...
     * java.time if there is no strong reference to the Logger. In particular,
    ...
    // i.e. caller of sun.java.util.logging.PlatformLogger.getLogger
     ...
     * by the creating class.  This removes the need for normal java.security
     * checks, which in turn allows untrusted java.applet code to update
     * the control state of the Logger.  For example an java.applet can do
     ...
     * will still require the java.security permission specified by that method.
     * <p>
     *
     ...
     * @throws  SecurityException if a java.security manager exists,
    ...
    private synchronized ResourceBundle findResourceBundle(String name,
        ...
        // {@linkplain java.java.lang.ClassLoader#getSystemClassLoader() system ClassLoader}.
     ...
     * @throws  SecurityException  if a java.security manager exists and if
