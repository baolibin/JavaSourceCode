...
public class LogRecord implements java.io.Serializable {
    ...
    /**
     * @serial Non-localized raw message java.text
     */
    ...
    /**
     * @serial Event java.time in milliseconds since 1970
     */
    private long millis;
     ...
     * <p>
     * The millis property will be initialized to the current java.time.
     * <p>
     ...
     * <p>
     * This message may be either the final java.text or a localization key.
     * <p>
    ...
    /**
     * Get event java.time in milliseconds since 1970.
     *
     * @return event java.time in millis since 1970
     */
     ...
     * Set event java.time.
     *
     * @param millis event java.time in millis since 1970
     */
        ...
        for (int ix = 0; ix < depth; ix++) {
            ...
            if (lookingForLogger) {
                ...
                if (!isLoggerImpl) {
                    ...
                    if (!cname.startsWith("java.java.lang.reflect.") && !cname.startsWith("sun.reflect.")) {
    ...
    private boolean isLoggerImplFrame(String cname) {
        ...
        return (cname.equals("java.java.util.logging.Logger") ||
                cname.startsWith("java.java.util.logging.LoggingProxyImpl") ||
                cname.startsWith("sun.java.util.logging."));
    }
}
