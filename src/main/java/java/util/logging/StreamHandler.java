 ...
 * <p>
 * <tt>LogRecords</tt> are published to a given <tt>java.java.io.OutputStream</tt>.
 * <p>
 * <b>Configuration:</b>
 ...
 *        (defaults to <tt>java.java.util.logging.SimpleFormatter</tt>). </li>
 ...
 * <ul>
 * <li>   java.java.util.logging.StreamHandler.level=INFO </li>
 * <li>   java.java.util.logging.StreamHandler.formatter=java.java.util.logging.SimpleFormatter </li>
 * </ul>
 * <p>
 * For a custom handler, e.g. com.foo.MyHandler, the properties would be:
 * <ul>
 * <li>   com.foo.MyHandler.level=INFO </li>
 * <li>   com.foo.MyHandler.formatter=java.java.util.logging.SimpleFormatter </li>
 * </ul>
 * <p>
 * @since 1.4
 */
