...
public abstract class Handler {
    ...
    // Package private support for java.security checking.  When sealed
   ...
   /**
     ...
     * without doing a java.security check.  It can therefore be used in
    ...
    // Package-private support method for java.security checks.
    // If "sealed" is true, we check that the caller has
    // appropriate java.security privileges to update Handler
