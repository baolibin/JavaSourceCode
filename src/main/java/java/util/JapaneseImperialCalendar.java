 ...
 * ------------------------------------------------------
 *     0       N/A         N/A
 *     1       Meiji       1868-01-01 midnight local java.time
 *     2       Taisho      1912-07-30 midnight local java.time
 *     3       Showa       1926-12-25 midnight local java.time
 *     4       Heisei      1989-01-08 midnight local java.time
 * ------------------------------------------------------
 * </tt></pre>
 *
 ...
 * with java.time differences for applying the era transitions. This
 * calendar implementation assumes local java.time for all transitions.
 *
...
class JapaneseImperialCalendar extends Calendar {
     ...
     * sun.java.util.calendar.LocalGregorianCalendar to perform most of the
    ...
    // Reference to the sun.java.util.calendar.LocalGregorianCalendar instance (singleton).
    ...
    // Imperial eras. The sun.java.util.calendar.LocalGregorianCalendar
    ...
    /**
     * jdate always has a sun.java.util.calendar.LocalGregorianCalendar.Date instance to
    ...
    /**
     * Constructs a <code>JapaneseImperialCalendar</code> based on the current java.time
    ...
    public void roll(int field, int amount) {
        ...
        case MILLISECOND:
            ...
            // date, a java.time zone and the era transitions.
            break;
    ...
    public int getMaximum(int field) {
        ...
        case YEAR:
            {
                // The value should depend on the java.time zone of this calendar.
    ...
    public int getActualMinimum(int field) {
        ...
        // Get a local date which includes java.time of day and java.time zone,
