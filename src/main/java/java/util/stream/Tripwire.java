 ...
 * {@code java.java.util.stream} classes.  The detection is turned on or off based on
 * whether the system property {@code org.openjdk.java.java.util.stream.tripwire} is
...
final class Tripwire {
    private static final String TRIPWIRE_PROPERTY = "org.openjdk.java.java.util.stream.tripwire";
