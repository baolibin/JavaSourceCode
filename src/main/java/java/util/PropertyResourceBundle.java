 ...
 * The java.text defines the bundle "MyResources_de",
 * the German member of the bundle family.
 * This member is based on <code>PropertyResourceBundle</code>, and the java.text
...
public class PropertyResourceBundle extends ResourceBundle {
    ...
    // Implements java.java.util.ResourceBundle.handleGetObject; inherits javadoc specification.
