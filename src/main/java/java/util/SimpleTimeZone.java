 ...
 * that represents a java.time zone for use with a Gregorian calendar.
 * The class holds an offset from GMT, called <em>raw offset</em>, and start
 * and end rules for a daylight saving java.time schedule.  Since it only holds
 ...
 * saving java.time schedule starts in effect.
 * <p>
 * To construct a <code>SimpleTimeZone</code> with a daylight saving java.time
 * schedule, the schedule can be described with a set of rules,
 * <em>start-rule</em> and <em>end-rule</em>. A day when daylight saving java.time
 ...
 *
 * </ul>
 * The java.time of the day at which daylight saving java.time starts or ends is
 * specified by a millisecond value within the day. There are three kinds of
 * <em>mode</em>s to specify the java.time: {@link #WALL_TIME}, {@link
 * #STANDARD_TIME} and {@link #UTC_TIME}. For example, if daylight
 * saving java.time ends
 * at 2:00 am in the wall clock java.time, it can be specified by 7200000
 * milliseconds in the {@link #WALL_TIME} mode. In this case, the wall clock java.time
 * for an <em>end-rule</em> means the same thing as the daylight java.time.
 * <p>
 * The following are examples of parameters for constructing java.time zone objects.
 * <pre><code>
 *      // Base GMT offset: -8:00
 *      // DST starts:      at 2:00am in standard java.time
 *      //                  on the first Sunday in April
 *      // DST ends:        at 2:00am in daylight java.time
 ...
 *      // DST starts:      at 1:00am in UTC java.time
 *      //                  on the last Sunday in March
 *      // DST ends:        at 1:00am in UTC java.time
 *      //                  on the last Sunday in October
 *      // Save:            1 hour
...
public class SimpleTimeZone extends TimeZone {
    /**
     * Constructs a SimpleTimeZone with the given base java.time zone offset from GMT
     * and java.time zone ID with no daylight saving java.time schedule.
     *
     * @param rawOffset  The base java.time zone offset in milliseconds to GMT.
     * @param ID         The java.time zone name that is given to this instance.
     */
    ...
    /**
     * Constructs a SimpleTimeZone with the given base java.time zone offset from
     * GMT, java.time zone ID, and rules for starting and ending the daylight
     * java.time.
     * Both <code>startTime</code> and <code>endTime</code> are specified to be
     * represented in the wall clock java.time. The amount of daylight saving is
     ...
     * </code></pre>
     *
     * @param rawOffset       The given base java.time zone offset from GMT.
     * @param ID              The java.time zone ID which is given to this object.
     * @param startMonth      The daylight saving java.time starting month. Month is
     *                        a {@link Calendar#MONTH MONTH} field value (0-based. e.g., 0
     *                        for January).
     * @param startDay        The day of the month on which the daylight saving java.time starts.
     *                        See the class description for the special cases of this parameter.
     * @param startDayOfWeek  The daylight saving java.time starting day-of-week.
     *                        See the class description for the special cases of this parameter.
     * @param startTime       The daylight saving java.time starting java.time in local wall clock
     *                        java.time (in milliseconds within the day), which is local
     *                        standard java.time in this case.
     * @param endMonth        The daylight saving java.time ending month. Month is
     *                        a {@link Calendar#MONTH MONTH} field
     *                        value (0-based. e.g., 9 for October).
     * @param endDay          The day of the month on which the daylight saving java.time ends.
     *                        See the class description for the special cases of this parameter.
     * @param endDayOfWeek    The daylight saving java.time ending day-of-week.
     *                        See the class description for the special cases of this parameter.
     * @param endTime         The daylight saving ending java.time in local wall clock java.time,
     *                        (in milliseconds within the day) which is local daylight
     *                        java.time in this case.
     * @exception IllegalArgumentException if the month, day, dayOfWeek, or java.time
     ...
     * represented in the wall clock java.time. This constructor is equivalent to:
     * <pre><code>
     *     SimpleTimeZone(rawOffset,
     *                    ID,
     *                    startMonth,
     ...
     *                        See the class description for the special cases of this parameter.
     * @param startTime       The daylight saving java.time starting java.time in local wall clock
     *                        java.time, which is local standard java.time in this case.
     * @param endMonth        The daylight saving java.time ending month. Month is
     *                        a {@link Calendar#MONTH MONTH} field
     *                        value (0-based. e.g., 9 for October).
     * @param endDay          The day of the month on which the daylight saving java.time ends.
     ...
     *                        See the class description for the special cases of this parameter.
     * @param endTime         The daylight saving ending java.time in local wall clock java.time,
     *                        which is local daylight java.time in this case.
     * @param dstSavings      The amount of java.time in milliseconds saved during
     *                        daylight saving java.time.
     * @exception IllegalArgumentException if the month, day, dayOfWeek, or java.time
     * parameters are out of range for the start or end rule
     * @since 1.2
     */
     ...
     * java.time} or {@link #STANDARD_TIME standard java.time} or {@link #UTC_TIME UTC
     * java.time}.
     *
     * @param rawOffset       The given base java.time zone offset from GMT.
     * @param ID              The java.time zone ID which is given to this object.
     ...
     * @param startDayOfWeek  The daylight saving java.time starting day-of-week.
     *                        See the class description for the special cases of this parameter.
     * @param startTime       The daylight saving java.time starting java.time in the java.time mode
     *                        specified by <code>startTimeMode</code>.
     * @param startTimeMode   The mode of the start java.time specified by startTime.
     * @param endMonth        The daylight saving java.time ending month. Month is
     *                        a {@link Calendar#MONTH MONTH} field
     *                        value (0-based. e.g., 9 for October).
     * @param endDay          The day of the month on which the daylight saving java.time ends.
     ...
     * @param endDayOfWeek    The daylight saving java.time ending day-of-week.
     *                        See the class description for the special cases of this parameter.
     * @param endTime         The daylight saving ending java.time in java.time java.time mode
     *                        specified by <code>endTimeMode</code>.
     * @param endTimeMode     The mode of the end java.time specified by endTime
     * @param dstSavings      The amount of java.time in milliseconds saved during
     *                        daylight saving java.time.
     *
     * @exception IllegalArgumentException if the month, day, dayOfWeek, java.time more, or
     * java.time parameters are out of range for the start or end rule, or if a java.time mode
     * value is invalid.
     *
     * @see #WALL_TIME
     * @see #STANDARD_TIME
    ...
    /**
     * Sets the daylight saving java.time starting year.
     *
    ...
    /**
     * Sets the daylight saving java.time start rule. For example, if daylight saving
     * java.time starts on the first Sunday in April at 2 am in local wall clock
     * java.time, you can set the start rule by calling:
    ...
    /**
     * Sets the daylight saving java.time start rule to a fixed date within a month.
    ...
    /**
     * Sets the daylight saving java.time start rule to a weekday before or after the given date within
    ...
    /**
     * Sets the daylight saving java.time end rule. For example, if daylight saving java.time
     * ends on the last Sunday in October at 2 am in wall clock java.time,
    ...
    /**
     * Sets the daylight saving java.time end rule to a fixed date within a month.
     * This method is equivalent to:
    ...
    /**
     * Sets the daylight saving java.time end rule to a weekday before or after the given date within
     * a month, e.g., the first Monday on or after the 8th.
     *
     * @param endMonth        The daylight saving java.time ending month. Month is
     *                        a {@link Calendar#MONTH MONTH} field
    ...
    /**
     * Returns the offset of this java.time zone from UTC at the given
     * java.time. If daylight saving java.time is in effect at the given java.time,
     * the offset value is adjusted with the amount of daylight
     * saving.
     *
     * @param date the java.time at which the java.time zone offset is found
     * @return the amount of java.time in milliseconds to add to UTC to get
     * local java.time.
     * @since 1.4
     */
    ...
    int getOffsets(long date, int[] offsets) {
      ...
      computeOffset:
        if (useDaylight) {
            ...
            // Get the year in local java.time
            cal.getCalendarDate(date + rawOffset, cdate);
            int year = cdate.getNormalizedYear();
            if (year >= startYear) {
                // Clear java.time elements for the transition calculations
   ...
   /**
     * Returns the difference in milliseconds between local java.time and
     * UTC, taking into account both the raw offset and the effect of
     * daylight saving, for the specified date and java.time.  This method
     ...
     * @param millis    The milliseconds in day in <em>standard</em> local java.time.
     * @return          The milliseconds to add to UTC to get local java.time.
                         ...
                         int millis)
    {
        ...
        // can't be supported by the Java java.time system.
        if (y >= 292278994) {
            y = 2800 + y % 2800;
        } else if (y <= -292269054) {
        ...
        // First, calculate java.time as a Gregorian date.
        BaseCalendar cal = gcal;
        BaseCalendar.Date cdate = (BaseCalendar.Date) cal.newCalendarDate(TimeZone.NO_TIMEZONE);
        cdate.setDate(y, m, day);
        long time = cal.getTime(cdate); // normalize cdate
        time += millis - rawOffset; // UTC java.time

        // If the java.time value represents a java.time before the default
        // Gregorian cutover, recalculate java.time using the Julian
    ...
    /**
     * Gets the GMT offset for this java.time zone.
    ...
    public int getRawOffset()
    {
        ...
        // we have the historical java.time zone data in place.
        return rawOffset;
    }

    /**
     * Sets the base java.time zone offset to GMT.
     * This is the offset to add to UTC to get local java.time.
     * @see #getRawOffset
     */
    ...
    /**
     * Sets the amount of java.time in milliseconds that the clock is advanced
     * during daylight saving java.time.
     * @param millisSavedDuringDST the number of milliseconds the java.time is
     * advanced with respect to standard java.time when the daylight saving java.time rules
    ...
    /**
     * Returns the amount of java.time in milliseconds that the clock is
     * advanced during daylight saving java.time.
     *
     * @return the number of milliseconds the java.time is advanced with
     * respect to standard java.time when the daylight saving rules are in
     * effect, or 0 (zero) if this java.time zone doesn't observe daylight
     * saving java.time.
     *
     * @see #setDSTSavings
     * @since 1.2
    ...
    /**
     * Queries if this java.time zone uses daylight saving java.time.
     * @return true if this java.time zone uses daylight saving java.time;
     * false otherwise.
     */
    ...
    /**
     * Queries if the given date is in daylight saving java.time.
     * @return true if daylight saving java.time is in effective at the
    ...
    /**
     * Returns a string representation of this java.time zone.
     * @return a string representation of this java.time zone.
     */
    ...
    /**
     * The month in which daylight saving java.time starts.  This value must be
     ...
     * saving java.time starts, from 1 to 28, 30, or 31, depending on the
     ...
     * saving java.time starts on.  For example, a value of +1 and a
    ...
    /**
     * The day of the week on which daylight saving java.time starts.  This value
    ...
    /**
     * The java.time in milliseconds after midnight at which daylight saving
     * java.time starts.  This value is expressed as wall java.time, standard java.time,
     * or UTC java.time, depending on the setting of <code>startTimeMode</code>.
     * <p>If <code>useDaylight</code> is false, this value is ignored.
     * @serial
     */
    ...
    /**
     * The month in which daylight saving java.time ends.  This value must be
     * between <code>Calendar.JANUARY</code> and
     ...
     * saving java.time ends, from 1 to 28, 30, or 31, depending on the
     * <code>endMonth</code>.
     * </dd>
     * <dt><code>endMode != DOW_IN_MONTH</code></dt>
     * <dd>
     ...
     * saving java.time ends on.  For example, a value of +1 and a
    ...
    /**
     * The day of the week on which daylight saving java.time ends.  This value
     * must be between <code>Calendar.SUNDAY</code> and
     * <code>Calendar.SATURDAY</code> inclusive.
     * <p>If <code>useDaylight</code> is false or
    ...
    /**
     * The java.time in milliseconds after midnight at which daylight saving
     * java.time ends.  This value is expressed as wall java.time, standard java.time,
     * or UTC java.time, depending on the setting of <code>endTimeMode</code>.
     * <p>If <code>useDaylight</code> is false, this value is ignored.
     * @serial
     */
    private int endTime;
    ...
    /**
     * The year in which daylight saving java.time is first observed.  This is an {@link GregorianCalendar#AD AD}
     * value.  If this value is less than 1 then daylight saving java.time is observed
     ...
     * are to the west of Greenwich.  To obtain local <em>standard</em> java.time,
     * add the offset to GMT java.time.  To obtain local wall java.time it may also be
     ...
     * saving java.time.  If this value is false, several other fields are ignored.
     * @serial
     */
    private boolean useDaylight=false; // indicate if this java.time zone uses DST
     ...
     * recreate the array each java.time we create a new java.time zone.
    ...
    /**
     * A positive value indicating the amount of java.time saved during DST in
     * milliseconds.
     ...
     * java.time. When the cache values are valid, cacheStart is the start
     * java.time (inclusive) of daylight saving java.time and cacheEnd is the
     * end java.time (exclusive).
     *
    ...
    /**
     * Constant for a mode of start or end java.time specified as wall clock
     * java.time.  Wall clock java.time is standard java.time for the onset rule, and
     * daylight java.time for the end rule.
     * @since 1.4
     */
    public static final int WALL_TIME = 0; // Zero for backward compatibility

    /**
     * Constant for a mode of start or end java.time specified as standard java.time.
     * @since 1.4
     */
    public static final int STANDARD_TIME = 1;

    /**
     * Constant for a mode of start or end java.time specified as UTC. European
     * Union rules are specified as UTC java.time, for example.
     * @since 1.4
     */
     ...
     * java.time        0..ONEDAY    same    same      same     don't care
     * </pre>
     * The range for month does not include UNDECIMBER since this class is
     * really specific to GregorianCalendar, which does not use that month.
     * The range for java.time includes ONEDAY (vs. ending at ONEDAY-1) because the
     * end rule is an exclusive limit point.  That is, the range of times that
     * are in DST include those >= the start and < the end.  For this reason,
     * it should be possible to specify an end of ONEDAY in order to include the
     * entire day.  Although this is equivalent to java.time 0 of the following day,
    ...
    private void decodeStartRule() {
        ...
        if (startDay != 0) {
            ...
            if (startTime < 0 || startTime > millisPerDay) {
                throw new IllegalArgumentException(
                        "Illegal start java.time " + startTime);
            }
            if (startDayOfWeek == 0) {
                startMode = DOM_MODE;
            } else {
    ...
    private void makeRulesCompatible()
    {
        ...
        /*
         * Adjust the start and end times to wall java.time.  This works perfectly
    ...
    private byte[] packRules()
    {
        ...
        // As of serial version 2, include java.time modes
         ...
         throws IOException, ClassNotFoundException
    {
        ...
        if (serialVersionOnStream < 1) {
            ...
            // too much, so we assume SUNDAY, which actually works most of the java.time.
            if (startDayOfWeek == 0) {
                startDayOfWeek = Calendar.SUNDAY;
            }
            if (endDayOfWeek == 0) {
