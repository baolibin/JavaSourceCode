...
class Properties extends Hashtable<Object,Object> {
     ...
     * compile java.time error.  In contrast, this method silently drops
     ...
     * {@code #} character, the current date and java.time (as if produced
     * by the {@code toString} method of {@code Date} for the
     * current java.time), and a line separator as generated by the {@code Writer}.
     * <p>
     ...
     *                  <a href="../java.lang/package-summary.html#charenc">
     ...
     *
     * <ol>
     *   <li> If the system property {@code sun.java.util.spi.XmlPropertiesProvider}
     ...
     *   loader and {@code sun.java.util.spi.XmlPropertiesProvider} as the service
    ...
    private static class XmlSupport {
        ...
        private static XmlPropertiesProvider loadProviderFromProperty(ClassLoader cl) {
            String cn = System.getProperty("sun.java.util.spi.XmlPropertiesProvider");
            if (cn == null)
                return null;
            try {
