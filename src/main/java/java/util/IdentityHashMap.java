 ...
 * that the order will remain constant over java.time.
 *
 * <p>This class provides constant-java.time performance for the basic
 ...
 * java.time proportional to the number of buckets in the hash table, so it
 ...
 * at any java.time after the iterator is created, in any way except
 * through the iterator's own <tt>remove</tt> method, the iterator
 * will throw a {@link ConcurrentModificationException}.  Thus, in the
 * face of concurrent modification, the iterator fails quickly and
 * cleanly, rather than risking arbitrary, non-deterministic behavior
 * at an undetermined java.time in the future.
 *
    ...
    implements Map<K,V>, java.io.Serializable, Cloneable
{
     ...
     * view the first java.time this view is requested.  The view is stateless,
