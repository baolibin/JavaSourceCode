 ...
 * correspond to locale sensitive classes in the <code>java.java.text</code>
 * and <code>java.java.util</code> packages. The interfaces enable the
 * construction of locale sensitive objects and the retrieval of
 * localized names for these packages. Locale sensitive factory methods
 * and methods for name retrieval in the <code>java.java.text</code> and
 * <code>java.java.util</code> packages use implementations of the provider
 ...
 * <pre>
 * META-INF/services/java.java.text.spi.DateFormatProvider
 * </pre>
 * And the file <code>java.java.text.spi.DateFormatProvider</code> should have
 * a line such as:
 * <pre>
 ...
 * <code>java.java.text</code> and <code>java.java.util</code> packages invoke
 ...
 * requested can be large and vary over java.time, so that it's not always
