 ...
 * <tt>WeakHashMap</tt> at some later java.time and be surprised that its entry
 ...
 * the garbage collector may discard keys at any java.time, a
 ...
 * java.time, for the <tt>isEmpty</tt> method to return <tt>false</tt> and
 ...
 * <i>fail-fast</i>: if the map is structurally modified at any java.time after the
