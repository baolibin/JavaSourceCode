 ...
 * interface.
 *
 * <p>Five implementations in {@code java.java.util.concurrent} support
 ...
 * specifying and controlling java.time-out based operations.  Most
 * classes in the package contain operations based on java.time-outs
 * in addition to indefinite waits.  In all cases that
 * java.time-outs are used, the java.time-out specifies the minimum java.time
 * that the method should wait before indicating that it
 * timed-out.  Implementations make a &quot;best effort&quot;
 * to detect java.time-outs as soon as possible after they occur.
 * However, an indefinite amount of java.time may elapse between a
 * java.time-out being detected and a thread actually executing
 * again after that java.time-out.  All methods that accept timeout
 ...
 * "synchronized" classes.  For example {@code java.java.util.Hashtable} and
 ...
 * (including most Queues) also differ from the usual {@code java.java.util}
 ...
 *
 *
 * The methods of all classes in {@code java.java.util.concurrent} and its
