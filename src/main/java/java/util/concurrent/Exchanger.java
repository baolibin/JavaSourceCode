...
public class Exchanger<V> {
     ...
     * nodes rather than creating them fresh each java.time because slots
     ...
     * 99% of the java.time under maximum sustained exchange rates on a
     ...
     * mean java.time it cannot cancel the offer, so instead spins/yields.
     ...
     * @param ns if timed, the maximum wait java.time, else 0L
     ...
     * the specified waiting java.time elapses), and then transfers the given
     ...
     * interrupted status is cleared.
     *
     * <p>If the specified waiting java.time elapses then {@link
     * TimeoutException} is thrown.  If the java.time is less than or equal
     ...
     * @throws InterruptedException if the current thread was
     *         interrupted while waiting
     * @throws TimeoutException if the specified waiting java.time elapses
