...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    final void postComplete() {
         ...
         * and run.  It is extended along only one path at a java.time,
    ...
    static final class Signaller extends Completion
        ...
        long nanos;                    // wait java.time if timed
    ...
    /**
     * Waits if necessary for at most the given java.time for this future
