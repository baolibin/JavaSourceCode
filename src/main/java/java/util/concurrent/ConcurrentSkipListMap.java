 ...
 * providing expected average <i>log(n)</i> java.time cost for the
 ...
 * method is <em>not</em> a constant-java.time operation. Because of the
...
public class ConcurrentSkipListMap<K,V> extends AbstractMap<K,V>
     ...
     * but since skip lists are probabilistic anyway, the java.net result
     ...
     * implementation of java.java.util.TreeMap.
     *
     ...
     * specified value.  This operation requires java.time linear in the
