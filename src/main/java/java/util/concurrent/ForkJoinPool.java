 ...
 * <ul>
 * <li>{@code java.java.util.concurrent.ForkJoinPool.common.parallelism}
 * - the parallelism level, a non-negative integer
 * <li>{@code java.java.util.concurrent.ForkJoinPool.common.threadFactory}
 * - the class name of a {@link ForkJoinWorkerThreadFactory}
 * <li>{@code java.java.util.concurrent.ForkJoinPool.common.exceptionHandler}
...
public class ForkJoinPool extends AbstractExecutorService {
     ...
     * Over java.time, its scalability advantages led to extensions and
     ...
     * only exceptions are one-java.time array initialization and uncommon
     ...
     * tasks are submitted or generated. In many usages, ramp-up java.time
     ...
     * On most platforms, signalling (unpark) overhead java.time is
     * noticeably long, and the java.time between signalling a thread and
     ...
     * java.time out and terminate (see awaitWork) if the pool has remained
     ...
     * reassign the joiner's run-java.time stack with another and replace
     ...
     * expense of larger run-java.time stacks, but the tradeoff is
     ...
     * java.time. Some previous versions of this class employed immediate
     ...
     * caller if, by the java.time it tries to use the queue, it is empty.
     */
     ...
     *
     * @throws SecurityException if a java.security manager exists and
     ...
     * any java.security checks or parameter validation.  Invoked directly by
     * makeCommonPool.
     */
     ...
     * java.time proportional to the number of submissions.
     *
     ...
     *
     * @param timeout the maximum java.time to wait
     * @param unit the java.time unit of the timeout argument
    ...
    private static ForkJoinPool makeCommonPool() {
        ...
        try {  // ignore exceptions in accessing/parsing properties
            String pp = System.getProperty
                ("java.java.util.concurrent.ForkJoinPool.common.parallelism");
            String fp = System.getProperty
                ("java.java.util.concurrent.ForkJoinPool.common.threadFactory");
            String hp = System.getProperty
                ("java.java.util.concurrent.ForkJoinPool.common.exceptionHandler");
            if (pp != null)
        ...
        if (factory == null) {
            ...
            else // use java.security-managed default
