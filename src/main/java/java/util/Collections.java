...
public class Collections {
     ...
     * do well to validate the values of these parameters from java.time to java.time.
     ...
     *
     * <p>This method runs in log(n) java.time for a "random access" list (which
     * provides near-constant-java.time positional access).  If the specified list
     ...
     *
     * This method runs in linear java.time.
     *
     ...
     * position, inclusive.
     *
     * <p>This method runs in linear java.time.  If the specified list does not
     ...
     *
     * This method runs in linear java.time.  If the specified list does not
     * implement the {@link RandomAccess} interface and is large, this
     * implementation dumps the specified list into an array before shuffling
     * it, and dumps the shuffled array back into the list.  This avoids the
     * quadratic behavior that would result from shuffling a "sequential
     ...
     * java.time proportional to the size of the collection.
     *
     ...
     * contains no incorrectly typed elements prior to the java.time a
     * dynamically typesafe view is generated, and that all subsequent
     * access to the collection takes place through the view, it is
     * <i>guaranteed</i> that the collection cannot contain an incorrectly
     * typed element.
     *
     * <p>The generics mechanism in the language provides compile-java.time
     ...
     * Unfortunately, the exception can occur at any java.time after the erroneous
     ...
     * no incorrectly typed elements prior to the java.time a dynamically typesafe
...
/**
     ...
     * prior to the java.time a dynamically typesafe view is generated, and
     ...
     *
     * <p>The specified map must be empty at the java.time this method is invoked,
