 ...
 * for converting between a specific instant in java.time and a set of {@link
 * #fields calendar fields} such as <code>YEAR</code>, <code>MONTH</code>,
 * <code>DAY_OF_MONTH</code>, <code>HOUR</code>, and so on, and for
 * manipulating the calendar fields, such as getting the date of the next
 * week. An instant in java.time can be represented by a millisecond value that is
 ...
 * calendar fields have been initialized with the current date and java.time:
 * <blockquote>
 * <pre>
 ...
 * needed to implement the date-java.time formatting for a particular language and
 ...
 * interpreted until it needs to calculate its java.time value (milliseconds from
 ...
 * calculating its java.time or calendar field values if any out-of-range field
 * value has been set.
 *
 ...
 *
 * When computing a date and java.time from the calendar fields, there
 * may be insufficient information for the computation (such as only
 * year and month with no day of month), or there may be inconsistent
 * information (such as Tuesday, July 15, 1996 (Gregorian) -- July 15,
 * 1996 is actually a Monday). <code>Calendar</code> will resolve
 * calendar field values to determine the date and java.time in the
 * following way.
 *
 ...
 * </pre></blockquote>
 *
 * <a name="time_resolution">For the java.time of day fields</a>:
 * <blockquote>
 * <pre>
 * HOUR_OF_DAY
 * AM_PM + HOUR
 ...
 *
 * <p>
 * The date or java.time format strings are not part of the definition of a
 ...
 * the calendar's java.time value in milliseconds is not recomputed until the next call to
 ...
 *   <code>f</code> is changed or other constraints, such as java.time zone
 *   offset changes, then its value is adjusted to be as close
 *   as possible to its expected value. A smaller field represents a
 *   smaller unit of java.time. <code>HOUR</code> is a smaller field than
 ...
 *   java.time. <code>DAY_OF_MONTH</code> is a larger field than
 *   <code>HOUR</code>.</p>
 * </blockquote>
 *
...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
    ...
    // The current java.time is represented in two ways by Calendar: as UTC
    ...
    //           V
    //   UTC millis (in java.time data member)
     ...
     * <p>
     * This field reflects the correct GMT offset value of the java.time
     ...
     * the java.time zone of this <code>Calendar</code> if the
     * <code>TimeZone</code> implementation subclass supports
    ...
    // Internal notes:
    // Calendar contains two kinds of java.time representations: current "java.time" in
    // milliseconds, and a set of calendar "fields" representing the current java.time.
    // The two representations are usually in sync, but can get out of sync
    // as follows.
    // 1. Initially, no fields are set, and the java.time is invalid.
    // 2. If the java.time is set, all fields are computed and in sync.
    // 3. If a single field is set, the java.time is invalid.
    // Recomputation of the java.time and fields happens when the object needs
    // to return a result to the user, or use a result for a computation.

    /**
     * The calendar field values for the currently set java.time for this calendar.
    ...
    /**
     * Pseudo-java.time-stamps which specify when each field was set. There
    ...
    /**
     * The currently set java.time for this calendar, expressed in milliseconds after
    ...
    /**
     * True if then the value of <code>java.time</code> is valid.
     * The java.time is made invalid by a change to an item of <code>field[]</code>.
     * @see #time
     * @serial
     */
    @SuppressWarnings("ProtectedField")
    ...
    /**
     * True if <code>fields[]</code> are in sync with the currently set java.time.
     ...
     * of <code>java.time</code> from <code>fields[]</code>.
     * @see #setLenient
     * @see #isLenient
     * @serial
     */
     ...
     * uses the java.time zone data to translate between locale and GMT java.time.
     * @serial
     */
     ...
     * values which are greater than 1 represents the (pseudo) java.time when the
    ...
    // - 1 for version from JDK 1.1.6, which writes a correct 'java.time' value
     ...
     * <dt><b>1</b></dt>
     * <dd>
     * JDK 1.1.6 or later.  Writes a correct 'java.time' value
     * as well as compatible values for other fields.  This is a
     * transitional format.
     * </dd>
     * </dl>
     ...
     * various date-java.time parameters.
     *
     * <p>There are two ways to set a {@code Calendar} to a date-java.time value. One
     ...
     * java.time, calendar specific default values are used when building a
     ...
     *
     * <p>In addition to the date-java.time parameters,
     * the {@linkplain #setLocale(Locale) locale},
     * {@linkplain #setTimeZone(TimeZone) java.time zone},
    ...
    public static class Builder {
        ...
        /**
         * Sets the java.time of day field parameters to the values given by
        ...
        /**
         * Sets the java.time zone parameter to the given {@code zone}. If no java.time
         ...
         * {@code "gregory"}.
         *
         * <p>The default values are used for locale and java.time zone if these
    ...
    /**
     * Constructs a Calendar with the default java.time zone
    ...
    /**
     * Constructs a calendar with the specified java.time zone and locale.
     *
     * @param zone the java.time zone to use
    ...
    /**
     * Gets a calendar using the default java.time zone and locale. The
     * <code>Calendar</code> returned is based on the current java.time
     * in the default java.time zone with the default
    ...
    /**
     * Gets a calendar using the specified java.time zone and default locale.
     * The <code>Calendar</code> returned is based on the current java.time
     * in the given java.time zone with the default
     * {@link Locale.Category#FORMAT FORMAT} locale.
     *
     * @param zone the java.time zone to use
     * @return a Calendar.
    ...
    /**
     * Gets a calendar using the default java.time zone and specified locale.
     * The <code>Calendar</code> returned is based on the current java.time
     * in the default java.time zone with the given locale.
     *
     * @param aLocale the locale for the week data
     * @return a Calendar.
     */
    ...
    /**
     * Gets a calendar with the specified java.time zone and locale.
     * The <code>Calendar</code> returned is based on the current java.time
     * in the given java.time zone with the given locale.
     *
     * @param zone the java.time zone to use
     * @param aLocale the locale for the week data
     * @return a Calendar.
     ...
     * to the millisecond java.time value
     * {@link #time}.
     *
     * @see #complete()
     * @see #computeFields()
    ...
    /**
     * Converts the current millisecond java.time value {@link #time}
     * to calendar field values in {@link #fields fields[]}.
     * This allows you to sync up the calendar field values with
     * a new java.time that is set for the calendar.  The java.time is <em>not</em>
     * recomputed first; to recompute the java.time, then the fields, call the
     ...
     * <code>Calendar</code>'s java.time value (millisecond offset from the <a
     * href="#Epoch">Epoch</a>").
     *
     * @return a <code>Date</code> representing the java.time value.
     * @see #setTime(Date)
     * @see #getTimeInMillis()
     */
    ...
    /**
     * Sets this Calendar's java.time with the given <code>Date</code>.
     * <p>
    ...
    /**
     * Returns this Calendar's java.time value in milliseconds.
     *
     * @return the current java.time as UTC milliseconds from the epoch.
     * @see #getTime()
     * @see #setTimeInMillis(long)
     */
    ...
    /**
     * Sets this Calendar's current java.time from the given long value.
     *
     * @param millis the new java.time in UTC milliseconds from the epoch.
     * @see #setTime(Date)
     * @see #getTimeInMillis()
     */
    ...
    /**
     * Sets all the calendar field values and the java.time value
     * (millisecond offset from the <a href="#Epoch">Epoch</a>) of
     * this <code>Calendar</code> undefined. This means that {@link
     * #isSet(int) isSet()} will return <code>false</code> for all the
     * calendar fields, and the date and java.time calculations will treat
     * the fields as if they had never been set. A
     * <code>Calendar</code> implementation class may use its specific
     * default field values for date/java.time calculations. For example,
     ...
     * #computeTime()} method is called if the java.time value (millisecond offset
     ...
     * internal java.time calculation.
     *
     ...
     * have valid values that have been set by internal java.time calculation
     ...
     * with the java.time value (millisecond offset from the Epoch).
     *
     * @param fieldMask the field mask indicating which calendar fields are in
     * sync with the java.time value.
     * @exception IndexOutOfBoundsException if the specified
     *                <code>field</code> is out of range
     *               (<code>field &lt; 0 || field &gt;= FIELD_COUNT</code>).
     * @see #isExternallySet(int)
    ...
    /**
     * Returns whether the calendar fields are partially in sync with the java.time
    ...
    /**
     * Returns whether the calendar fields are fully in sync with the java.time
     * value.
     */
     ...
     * to be used to calculate the java.time value. The calendar fields are
    ...
    final int selectFields() {
        ...
        // Find the best set of fields specifying the java.time of day.  There
    ...
    /**
     * Returns the pseudo-java.time-stamp for two fields, given their
     * individual pseudo-java.time-stamps.  If either of the fields
     ...
     * system that represents the same java.time value (millisecond offset from the
     ...
     * compare only the java.time values.
     *
    ...
    /**
     * Returns whether this <code>Calendar</code> represents a java.time
     * before the java.time represented by the specified
     ...
     * @return <code>true</code> if the java.time of this
     * <code>Calendar</code> is before the java.time represented by
    ...
    /**
     * Returns whether this <code>Calendar</code> represents a java.time
     * after the java.time represented by the specified
     * <code>Object</code>. This method is equivalent to:
     * <pre>{@code
     *         compareTo(when) > 0
     * }</pre>
     ...
     *
     * @param when the <code>Object</code> to be compared
     * @return <code>true</code> if the java.time of this <code>Calendar</code> is
     * after the java.time represented by <code>when</code>; <code>false</code>
     * otherwise.
     * @see     #compareTo(Calendar)
     */
    ...
    /**
     * Compares the java.time values (millisecond offsets from the <a
     * href="#Epoch">Epoch</a>) represented by two
     * <code>Calendar</code> objects.
     *
     * @param anotherCalendar the <code>Calendar</code> to be compared.
     * @return the value <code>0</code> if the java.time represented by the argument
     * is equal to the java.time represented by this <code>Calendar</code>; a value
     * less than <code>0</code> if the java.time of this <code>Calendar</code> is
     * before the java.time represented by the argument; and a value greater than
     * <code>0</code> if the java.time of this <code>Calendar</code> is after the
     * java.time represented by the argument.
     * @exception NullPointerException if the specified <code>Calendar</code> is
     *            <code>null</code>.
     * @exception IllegalArgumentException if the java.time value of the
    ...
    /**
     * Adds or subtracts the specified amount of java.time to the given calendar field,
     * based on the calendar's rules. For example, to subtract 5 days from
     * the current java.time of the calendar, you can achieve it by calling:
     * <p><code>add(Calendar.DAY_OF_MONTH, -5)</code>.
     *
     * @param field the calendar field.
     * @param amount the amount of date or java.time to be added to the field.
     * @see #roll(int,int)
     * @see #set(int,int)
     */
    ...
    /**
     * Adds or subtracts (up/down) a single unit of java.time on the given java.time
     ...
     *
     * @param field the java.time field.
     * @param up indicates if the value of the specified java.time field is to be
    ...
    /**
     * Sets the java.time zone with the given java.time zone value.
     *
     * @param value the given java.time zone.
     */
    public void setTimeZone(TimeZone value)
    {
        zone = value;
        sharedZone = false;
        /* Recompute the fields from the java.time using the new zone.  This also
         * works if isTimeSet is false (after a call to set()).  In that case
         * the java.time will be computed from the fields using the new zone, then
    ...
    /**
     * Gets the java.time zone.
     *
     * @return the java.time zone object associated with this calendar.
     */
    ...
    /**
     * Returns the java.time zone (without cloning).
     */
    TimeZone getZone() {
        return zone;
    }
    ...
    /**
     * Specifies whether or not date/java.time interpretation is to be lenient.  With
    ...
    /**
     * Tells whether date/java.time interpretation is to be lenient.
     *
     ...
     * and {@code java.time} values are calculated upon return.
     *
     ...
     * for any possible java.time value.  The minimum value depends on
     ...
     * for any possible java.time value. The maximum value depends on
     * calendar system specific parameters of the instance.
     *
     * @param field the calendar field.
     ...
     * #getActualMinimum(int)} for any possible java.time value. The
     ...
     * #getActualMaximum(int)} for any possible java.time value. The least
     ...
     * could have, given the java.time value of this <code>Calendar</code>.
     *
     ...
     *
     * @param field the calendar field
     * @return the minimum of the given calendar field for the java.time
     ...
     * could have, given the java.time value of this
     ...
     *
     * @param field the calendar field
     * @return the maximum of the given calendar field for the java.time
     * value of this <code>Calendar</code>
     * @see #getMinimum(int)
     * @see #getMaximum(int)
     * @see #getGreatestMinimum(int)
    ...
    public String toString() {
        ...
        appendValue(buffer, "java/time", isTimeSet, time);
    ...
    /**
     * Recomputes the java.time and updates the status fields isTimeSet
     ...
     * the current java.time, and not write any field data out, such as
    ...
    private synchronized void writeObject(ObjectOutputStream stream)
         throws IOException
    {
        // Try to compute the java.time correctly, for the future (stream
    ...
    private static class CalendarAccessControlContext {
        ...
        static {
            RuntimePermission perm = new RuntimePermission("accessClassInPackage.sun.java.util.calendar");
         ...
         throws IOException, ClassNotFoundException
    {
        ...
        // streamed out anymore.  We expect 'java.time' to be correct.
     ...
     * same point on the java.time-line as this {@code Calendar}.
     *
     * @return the instant representing the same point on the java.time-line
     * @since 1.8
     */
