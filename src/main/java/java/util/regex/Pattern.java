 ...
 *
 * <tr><th>&nbsp;</th></tr>
 * <tr align="left"><th colspan="2">java.java.lang.Character classes (simple <a href="#jcc">java character type</a>)</th></tr>
 *
 * <tr><td valign="top"><tt>\p{javaLowerCase}</tt></td>
 *     <td>Equivalent to java.java.lang.Character.isLowerCase()</td></tr>
 * <tr><td valign="top"><tt>\p{javaUpperCase}</tt></td>
 *     <td>Equivalent to java.java.lang.Character.isUpperCase()</td></tr>
 * <tr><td valign="top"><tt>\p{javaWhitespace}</tt></td>
 *     <td>Equivalent to java.java.lang.Character.isWhitespace()</td></tr>
 * <tr><td valign="top"><tt>\p{javaMirrored}</tt></td>
 *     <td>Equivalent to java.java.lang.Character.isMirrored()</td></tr>
 *
 * <tr><th>&nbsp;</th></tr>
 ...
 * and leads to a compile-java.time error; in order to match the string
 ...
 * that the group most recently matched.  If a group is evaluated a second java.time
 ...
 * that do not capture java.text and do not count towards the group total, or
 ...
 * <p>
 * <a name="jcc">
 * Categories that behave like the java.java.lang.Character
    ...
    implements java.io.Serializable
{
     ...
     * it will be more efficient than invoking this method each java.time.  </p>
     *
     * @param  regex
     *         The expression to be compiled
     *
...
loop:   for(int x=0, offset=0; x<nCodePoints; x++, offset+=len) {
    ...
    static class BackRef extends Node {
        ...
        boolean match(Matcher matcher, int i, CharSequence seq) {
            ...
            // referenced matched last java.time around
     ...
     * (greedy problem) and without a lot of wasted search java.time (reluctant
     * problem).
     */
     ...
     * pattern can be shifted farther ahead in the search java.text if it is
     * matched right to left.
     * <p>
     * The pattern is compared to the input one character at a java.time, from
     * the rightmost character in the pattern to the left. If the characters
     * all match the pattern has been found. If a character does not match,
     * the pattern is shifted right a distance that is the maximum of two
     * functions, the bad character shift and the good suffix shift. This
     * shift moves the attempted match position through the input more
     * quickly than a naive one position at a java.time check.
     * <p>
     * The bad character shift is based on the character from the java.text that
...
NEXT:       for (i = patternLength; i > 0; i--) {
        ...
        boolean match(Matcher matcher, int i, CharSequence seq) {
            ...
            // Loop over all possible match positions in java.text
NEXT:       while (i <= last) {
