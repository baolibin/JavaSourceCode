 ...
 * rather than at the java.time the Spliterator is created.  A Spliterator that is
 ...
 * thread at a java.time.  This is generally easy to attain via <em>serial
 ...
 * removed) between the java.time that the Spliterator binds to its data source and
 * the end of traversal.  For example, such interference will produce arbitrary,
 * non-deterministic results when using the {@code java.java.util.stream} framework.
 *
 ...
 * {@code java.java.util.stream} package, would use Spliterator in a parallel
 ...
 *
 * @implNote
 * If the boolean system property {@code org.openjdk.java.java.util.stream.tripwire}
