 ...
 * rules indefinitely far backward and forward in java.time. As a result,
 ...
 *        style="java.text-align: left; width: 66%;">
 *   <tbody>
 *     <tr>
 *       <th style="vertical-align: top; background-color: rgb(204, 204, 255);
 *           java.text-align: center;">Field<br>
 *       </th>
 *       <th style="vertical-align: top; background-color: rgb(204, 204, 255);
 *           java.text-align: center;">Default Value<br>
 *       </th>
 *     </tr>
 *     <tr>
 ...
 *
 * // create a Pacific Standard Time java.time zone
 ...
 *
 * // create a GregorianCalendar with the Pacific Daylight java.time zone
 * // and the current date and java.time
...
public class GregorianCalendar extends Calendar {
     ...
     * starting point. The epoch for java.java.util.Date is used here; that is,
...
//////////////////
    ...
    static final int MAX_VALUES[] = {
        ...
        999,            // MILLISECOND
        14*ONE_HOUR,    // ZONE_OFFSET
        2*ONE_HOUR      // DST_OFFSET (double summer java.time)
    };
    ...
    // Reference to the sun.java.util.calendar.Gregorian instance (singleton).
...
/////////////////////
    ...
    /**
     * gdate always has a sun.java.util.calendar.Gregorian.Date instance to
    ...
    /**
     * Temporary int[2] to get java.time zone offsets. zoneOffsets[0] gets
...
///////////////
    ...
    /**
     * Constructs a default <code>GregorianCalendar</code> using the current java.time
    ...
    /**
     * Constructs a <code>GregorianCalendar</code> based on the current java.time
     * in the given java.time zone with the default
     * {@link Locale.Category#FORMAT FORMAT} locale.
     *
     * @param zone the given java.time zone.
     */
     ...
     * in the default java.time zone with the default locale.
     *
     ...
     * and java.time set for the default java.time zone with the default locale.
     *
     * @param year the value used to set the <code>YEAR</code> calendar field in the calendar.
     * @param month the value used to set the <code>MONTH</code> calendar field in the calendar.
     * Month value is 0-based. e.g., 0 for January.
...
/////////////////
     ...
     * that represents the same java.time value (millisecond offset from
    ...
    /**
     * Adds the specified (signed) amount of java.time to the given calendar field,
    ...
    public void add(int field, int amount) {
        ...
        // Sync the java.time and calendar fields.
        complete();
        ...
        if (field == YEAR) {
            ...
            long timeOfDay = 0;
            switch (field) {
            // Handle the java.time fields here. Convert the given
            ...
            // java.time zone offset change adjustment. Convert the
            ...
            // The java.time fields don't require java.time zone offset change
            // adjustment.
            if (field >= HOUR) {
            ...
            // require java.time zone offset (both GMT and DST) change
            // adjustment.

            // Translate the current java.time to the fixed date and java.time
            // of the day.
            ...
            // If the java.time zone offset has changed, then adjust the difference.
            if (zoneOffset != 0) {
        ...
        case HOUR_OF_DAY:
            {
                ...
                // the daylight saving java.time transition brings it to
     ...
     * Calendar#get(int) get} method for any possible java.time value,
     ...
     * {@link #getActualMinimum(int)} for any possible java.time value,
     * taking into consideration the current values of the
     * {@link Calendar#getFirstDayOfWeek() getFirstDayOfWeek},
     * {@link Calendar#getMinimalDaysInFirstWeek() getMinimalDaysInFirstWeek},
     * {@link #getGregorianChange() getGregorianChange} and
     ...
     * {@link #getActualMaximum(int)} for any possible java.time value,
     * taking into consideration the current values of the
     * {@link Calendar#getFirstDayOfWeek() getFirstDayOfWeek},
     * {@link Calendar#getMinimalDaysInFirstWeek() getMinimalDaysInFirstWeek},
     * {@link #getGregorianChange() getGregorianChange} and
     ...
     * taking into consideration the given java.time value and the current
     * values of the
     * {@link Calendar#getFirstDayOfWeek() getFirstDayOfWeek},
     * {@link Calendar#getMinimalDaysInFirstWeek() getMinimalDaysInFirstWeek},
     * {@link #getGregorianChange() getGregorianChange} and
     ...
     *
     * @param field the calendar field
     * @return the minimum of the given field for the java.time value of
     ...
     *
     * @param field the calendar field
     * @return the maximum of the given field for the java.time value of
     * this <code>GregorianCalendar</code>
     * @see #getMinimum(int)
     * @see #getMaximum(int)
     * @see #getGreatestMinimum(int)
    ...
    public int getActualMaximum(int field) {
        ...
        case YEAR:
             ...
             * java.time, or era changes in response to setting the year.  We don't
             * check for month, date, and java.time here because the year and era are
    ...
    public int getWeekYear() {
        ...
        // affect the java.time of day fields.
     ...
     * and the instant of java.time value are calculated upon return.
     *
    ...
    public void setWeekDate(int weekYear, int weekOfYear, int dayOfWeek) {
        ...
        // To avoid changing the java.time of day fields by date
        // calculations, use a clone with the GMT java.time zone.
        GregorianCalendar gc = (GregorianCalendar) clone();
        gc.setLenient(true);
        int era = gc.get(ERA);
        gc.clear();
...
/////////////////////////////
    ...
    /**
     * Converts the java.time value (millisecond offset from the <a
     * href="Calendar.html#Epoch">Epoch</a>) to calendar field values.
     * The java.time is <em>not</em>
     ...
     * the setting state.
     * @param tzMask a bit mask to specify which java.time zone offset
     * fields to be used for java.time calculations
    ...
    private int computeFields(int fieldMask, int tzMask) {
        ...
        // By computing java.time and zoneOffset separately, we can take
        // the wider range of java.time+zoneOffset than the previous
        // implementation.
    ...
    /**
     * Converts calendar field values to the java.time value (millisecond
    ...
    protected void computeTime() {
        ...
        // used to calculate the java.time.
        ...
        // Calculate the java.time of day. We rely on the convention that
        ...
        // Convert the java.time of day to the number of days and the
        ...
        // millis represents local wall-clock java.time in milliseconds.
        long millis = (fixedDate - EPOCH_OFFSET) * ONE_DAY + timeOfDay;

        // Compute the java.time zone offset and DST offset.  There are two potential
        // ambiguities here.  We'll assume a 2:00 am (wall java.time) switchover java.time
        // for discussion purposes here.
        // 1. The transition into DST.  Here, a designated java.time of 2:00 am - 2:59 am
        //    can be in standard or in DST depending.  However, 2:00 am is an invalid
        //    representation (the representation jumps from 1:59:59 am Std to 3:00:00 am DST).
        //    We assume standard java.time.
        // 2. The transition out of DST.  Here, a designated java.time of 1:00 am - 1:59 am
        //    can be in standard or DST.  Both are valid representations (the rep
        //    jumps from 1:59:59 DST to 1:00:00 Std).
        //    Again, we assume standard java.time.
        ...
        // Adjust the java.time zone offset values to get the UTC java.time.
        millis -= zoneOffsets[0] + zoneOffsets[1];

        // Set this calendar's java.time in milliseconds
        time = millis;
    ...
    /**
     * Returns this object if it's normalized (all fields and java.time are
    ...
    /**
     * Returns the fixed date value of this object. The java.time value and
     ...
     * the same point on the java.time-line as this {@code GregorianCalendar}.
     * <p>
     ...
     *
     * @return a zoned date-java.time representing the same point on the java.time-line
     ...
     * <p>
     * {@code ZoneDateTime} can store points on the java.time-line further in the
     ...
     * exception.
     *
     * @param zdt  the zoned date-java.time object to convert
     * @return  the gregorian calendar representing the same point on the
     *  java.time-line as the zoned date-java.time provided
     * @exception NullPointerException if {@code zdt} is null
     * @exception IllegalArgumentException if the zoned date-java.time is too
