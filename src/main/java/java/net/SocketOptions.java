...
public interface SocketOptions {
     ...
     *    // ERROR - expects java.java.lang.Integer
     *</PRE>
     * If the requested option is binary, it can be set using this method by
     * a java.java.lang.Boolean:
     * <BR><PRE>
     ...
     * Binary options will return java.java.lang.Boolean(true)
     * if enabled, java.java.lang.Boolean(false) if disabled, e.g.:
     * <BR><PRE>
     * SocketImpl s;
     * ...
     ...
     * it will return java.java.lang.Boolean(false):
     * <PRE>
     * Object o = s.getOption(SO_LINGER);
     * if (o instanceof Integer) {
     *     System.out.print("Linger java.time is " + ((Integer)o).intValue());
     * } else {
     *   // the true type of o is java.java.lang.Boolean(false);
     * }
     * </PRE>
     *
     ...
     * be "set" only "gotten", since sockets are bound at creation java.time,
     ...
     * <B>java.java.io.InterruptedIOException</B> is raised.  The Socket is
