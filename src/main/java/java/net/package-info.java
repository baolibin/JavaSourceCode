 ...
 *
 * <p> The java.java.net package can be roughly divided in two sections:</p>
 * <ul>
 ...
 * </ul>
 * <h2>Addresses</h2>
 * <p>Addresses are used throughout the java.java.net APIs as either host
 ...
 *    the network. The java.java.net package provides 4 kinds of Sockets:</p>
 * <ul>
 ...
 * <p>A number of classes in the java.java.net package do provide for a much higher
 ...
 *    resources, then convert it into a {@link java.net.URL} when it is java.time to
 ...
 * <ul>
 *       <li><a href="doc-files/java.net-properties.html">
