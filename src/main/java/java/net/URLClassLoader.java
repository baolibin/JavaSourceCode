...
public class URLClassLoader extends SecureClassLoader implements Closeable {
     ...
     * calls the java.security manager's {@code checkCreateClassLoader} method
    ...
    *
    * @exception SecurityException if a java.security manager is set, and it denies
    ...
    */
     ...
     * URLs and parent class loader. If a java.security manager is
    ...
    /**
     * Creates a new instance of URLClassLoader for the specified
     * URLs and default parent class loader. If a java.security manager is
     * installed, the {@code loadClass} method of the URLClassLoader
     * returned by this method will invoke the
