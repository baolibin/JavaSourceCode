...
public final class URL implements java.io.Serializable {
    ...
    static final String BUILTIN_HANDLERS_PREFIX = "sun.java.net.www.protocol";
     ...
     * default package prefix, sun.java.net.www.protocol, is used.  The search
     ...
     * for:
     *     java.java.net.URL#URL(java.java.lang.String, java.java.lang.String, int,
     *                      java.java.lang.String)
     *
     * <p>If the handler is not null and there is a java.security manager,
     * the java.security manager's {@code checkPermission}
     ...
     * created every java.time when invoking the
     ...
     * java.java.lang, java.java.io, java.java.util, java.java.net, the connection
     ...
     * @exception  IOException  if an I/O exception occurs.
     * @exception  SecurityException if a java.security manager is present
    ...
    static URLStreamHandler getURLStreamHandler(String protocol) {
        ...
        if (handler == null) {
            ...
            if (handler == null) {
                ...
                // or not.
                packagePrefixList += "sun.java.net.www.protocol";
