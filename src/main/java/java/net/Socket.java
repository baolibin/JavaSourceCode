...
class Socket implements java.io.Closeable {
     ...
     * <P>
     * If there is a java.security manager, its {@code checkConnect} method
     ...
     *          or {@code null}.
     * @throws SecurityException if a java.security manager is present and
    ...
    public Socket(Proxy proxy) {
        // Create a copy of Proxy as a java.security measure
        if (proxy == null) {
     ...
     * <p>
     * If there is a java.security manager, its
            ...
            public Boolean run() {
                ...
                while (true) {
                    try {
                        ...
                        // java.java.net.SocketImpl class will always have this abstract method.
     ...
     * <p>
     * If there is a java.security manager set, its {@code checkConnect} method is
     * called with the local address and {@code -1} as its arguments to see
     * if the operation is allowed. If the operation is not allowed,
     * the {@link InetAddress#getLoopbackAddress loopback} address is returned.
     *
     * @return the local address to which the socket is bound,
     *         the loopback address if denied by the java.security manager, or
     ...
     *         loopback address if denied by the java.security manager, or
     ...
     * specified linger java.time in seconds. The maximum timeout value is platform
     * specific.
     *
     ...
     *  this Socket will block for only this amount of java.time.  If the timeout
     *  expires, a <B>java.java.net.SocketTimeoutException</B> is raised, though the
     ...
     * Generally, the window size can be modified at any java.time when a socket is
     ...
     * in a timeout state for a period of java.time after the connection
     ...
     * whose values indicate the relative importance of short connection java.time,
     * low latency, and high bandwidth.  The absolute values of the integers
     * are irrelevant; in order to choose a protocol the values are simply
     * compared, with larger values indicating stronger preferences. Negative
     * values represent a lower priority than positive values. If the
     * application prefers short connection java.time over both low latency and high
     * bandwidth, for example, then it could invoke this method with the values
     * {@code (1, 0, 0)}.  If the application prefers high bandwidth above low
     * latency, and low latency above short connection java.time, then it could
