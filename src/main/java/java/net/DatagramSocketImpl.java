...
public abstract class DatagramSocketImpl implements SocketOptions {
    ...
    /**
     * Retrieve the TTL (java.time-to-live) option.
     *
     * @exception IOException if an I/O exception occurs
     * while retrieving the java.time-to-live option
    ...
    /**
     * Set the TTL (java.time-to-live) option.
     * @param ttl an {@code int} specifying the java.time-to-live value
     * @exception IOException if an I/O exception occurs
     * while setting the java.time-to-live option.
     * @see #getTimeToLive()
     */
     ...
     * @exception IOException if an I/O exception occurs
     * while retrieving the java.time-to-live option
     * @return an {@code int} representing the java.time-to-live value
