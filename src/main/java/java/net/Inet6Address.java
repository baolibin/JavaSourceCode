 ...
 *         IPv4-mapped address as input, both in byte array and java.text
 ...
 * is determined at the java.time the object is created by querying the relevant
...
class Inet6Address extends InetAddress {
    ...
    private class Inet6AddressHolder {
         ...
         * until the java.time it is needed.
         */
        int scope_id;  // 0
