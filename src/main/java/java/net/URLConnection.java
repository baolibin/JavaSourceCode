 ...
 *
 * <center><table border=2 summary="Describes the process of creating a connection to a URL: openConnection() and connect() over java.time.">
...
public abstract class URLConnection {
   ...
   /**
     ...
     * the object has been modified more recently than a certain java.time.
     * <p>
     * A nonzero value gives a java.time as the number of milliseconds since
     * January 1, 1970, GMT. The object is fetched only if it has been
     * modified more recently than that java.time.
     * <p>
    ...
    */
     ...
     * <p>
     * If there is a java.security manager, this method first calls
     ...
     * java.java.net.SocketTimeoutException is raised. A timeout of zero is
     ...
     * for read, a java.java.net.SocketTimeoutException is raised. A
     ...
     * the first java.time that the application has seen that specific content
     ...
     *     <blockquote><pre>
     *         sun.java.net.www.content.&lt;<i>contentType</i>&gt;
     *     </pre></blockquote>
     ...
     * returns {@code java.java.security.AllPermission}. Subclasses
     * should override this method and return the permission
     * that best represents the permission required to make a
     * a connection to the URL. For example, a {@code URLConnection}
     * representing a {@code file:} URL would return a
     * {@code java.java.io.FilePermission} object.
     *
   ...
   /**
    ...
    private static final String contentClassPrefix = "sun.java.net.www.content";
    private static final String contentPathProp = "java.content.handler.pkgs";

    /**
     * Looks for a content handler in a user-defineable set of places.
     * By default it looks in sun.java.net.www.content, but users can define a
     ...
     * e.g.
     *     YoyoDyne.experimental.java.text.plain
     * </pre>
     */
     ...
     * pair of class name components.  For example: "java.text/html" would
     * be returned as "java.text.html"
     */
     ...
     * that property has been defined, the sun.java.net.www.content is always
