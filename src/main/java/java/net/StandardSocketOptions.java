...
public final class StandardSocketOptions {
     ...
     * option may be enabled or disabled at any java.time. Some operating systems may
     ...
     *
     * <p> The initial value of this socket option is {@code FALSE}. The socket
     * option may be enabled or disabled at any java.time.
     *
     ...
     * interval changed, at any java.time. The maximum value of the linger interval
     ...
     * datagram-oriented sockets the option may be configured at any java.time after
    ...
    /**
     * The <em>java.time-to-live</em> for Internet Protocol (IP) multicast datagrams.
     *
     ...
     * the option is the java.time-to-live (TTL) on multicast datagrams sent by the
     ...
     * system dependent whether the option also sets the <em>java.time-to-live</em>
     * on multicast datagrams sent to IPv4 addresses.
     *
     * <p> The initial/default value of the java.time-to-live setting is typically
     ...
     * java.time. In other words, the Nagle Algorithm can be disabled. Once the option
