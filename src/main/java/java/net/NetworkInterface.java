...
public final class NetworkInterface {
     ...
     * <p>
     * If there is a java.security manager, its {@code checkConnect}
     ...
     * If a java.security manager is set, then the caller must have
     * the permission {@link NetPermission}("getNetworkInformation").
     *
     * @return  a byte array containing the address, or {@code null} if
     *          the address doesn't exist, is not accessible or a java.security
