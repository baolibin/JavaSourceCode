 ...
 * first java.time a protocol name is encountered when constructing a
...
// FIX: should not assume query if opaque
     ...
     * guaranteed by the fact that it is only called by java.java.net.URL class.
