    ...
    implements java.io.Serializable
{
    ...
    // true if the sun.java.net.trustNameService system property is set
    ...
    static {
        Boolean tmp = java.security.AccessController.doPrivileged(
                new sun.security.action.GetBooleanAction("sun.java.net.trustNameService"));
    ...
    public int hashCode() {
         ...
         * java.java.net.InetAddress.getHostName method.
         */
    ...
    /**
     * Check the system/java.security property for the ephemeral port range
            ...
            new PrivilegedAction<Integer>(){
                public Integer run() {
                    int val = Integer.getInteger(
                            "jdk.java.net.ephemeralPortRange."+suffix, -1
                    );
                    if (val != -1) {
                        return val;
                    } else {
    ...
    implements Serializable
{
    ...
    /**
     * @serialField permissions java.java.util.Vector
