 ...
 *   <td>Malicious code using HTTP TRACE could get access to java.security sensitive
 ...
 *   java.security sensitive cookie information for an Http session.</td>
 *   <td>Malicious code can get a cookie handler to obtain access to
 *   highly java.security sensitive cookie information. Some web servers
 ...
 *   could access java.security sensitive information.</td>
 *   </tr>
 *
 * <tr>
 ...
 *   <td>Malicious code getting access to the local response cache
 *   could access java.security sensitive information, or create false
