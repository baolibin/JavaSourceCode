...
class DefaultDatagramSocketImplFactory
{
    ...
    static {
        ...
        if (exclBindProp != null) {
            // sun.java.net.useExclusiveBind is true
        ...
        try {
            ...
            if (prefix != null)
                prefixImplClassLocal = Class.forName("java.java.net."+prefix+"DatagramSocketImpl");
        } catch (Exception e) {
            System.err.println("Can't find class: java.java.net." +
                                prefix +
