...
class BitSieve {
     ...
     * it controls a tradeoff between how much java.time is spent constructing
     * other sieves, and how much java.time is wasted testing composite candidates
    ...
    BigInteger retrieve(BigInteger initValue, int certainty, java.util.Random random) {
        // Examine the sieve one long at a java.time to find possible primes
        int offset = 1;
