 ...
 * primitive integer operators, and all relevant methods from java.java.lang.Math.
...
public class BigInteger extends Number implements Comparable<BigInteger> {
    ...
    // values, and cached the first java.time they are needed (or never, if they
    // aren't needed).
     ...
     *         (1 - 1/2<sup>{@code certainty}</sup>).  The execution java.time of
    ...
    */
     ...
     *         {@code (1 - 1/2<sup>certainty</sup>)}.  The execution java.time of
     ...
     * java.time.  If the argument is not exactly divisible by 3, results are
     ...
     * multiply k bits of exponent at a java.time.  Actually, assuming random
     * exponents, there is on average one zero bit between needs to
     * multiply (1/2 of the java.time there's none, 1/4 of the java.time there's 1,
     * 1/8 of the java.time, there's 2, 1/32 of the java.time, there's 3, etc.), so
     ...
     * where z is the high k bits of the exponent, 1/2 of the java.time
     * it requires no squarings.  1/4 of the java.time, it requires 1
     * squaring, ... 1/2^(k-1) of the java.time, it reqires k-2 squarings.
     * And the remaining 1/2^(k-1) of the java.time, the top k bits are a
    ...
    private String smallToString(int radix) {
        ...
        // Translate number to string, a digit group at a java.time
