 ...
 * of java.java.beans.beancontext.BeanContext, in order to propagate to its nested hierarchy
 * of java.java.beans.beancontext.BeanContextChild instances, the current "designTime" property.
 * <p>
 * The JavaBeans&trade; specification defines the notion of design java.time as is a
 ...
 * as opposed to runtime when the JavaBean is part of an java.applet, application,
...
public interface DesignMode {
     ...
     * <p>
     * If the implementing object is an instance of java.java.beans.beancontext.BeanContext,
     ...
     * parameters:
     * <ul>
     *    <li><code>propertyName</code> - <code>java.java.beans.DesignMode.PROPERTYNAME</code>
    ...
    /**
     * A value of true denotes that JavaBeans should behave in design java.time
