...
/**
 * This is a utility class that can be used by java.beans that support constrained
...
public class VetoableChangeSupport implements Serializable {
     ...
     * source, it will be notified one less java.time after being removed.
     ...
     * If <code>listener</code> was added more than once to the same event
     * source for the specified property, it will be notified one less java.time
     * after being removed.
     ...
     * <p>
     * At serialization java.time we skip non-serializable listeners and
