 ...
 * "sun.java.beans.infos.OurButtonBeanInfo".
 * <p>
...
public class Introspector {
     ...
     *          Sun implementation initially sets to {"sun.java.beans.infos"}.
     */
     ...
     *          is null.
     *
     * <p>First, if there is a java.security manager, its <code>checkPropertiesAccess</code>
    ...
    private EventSetDescriptor[] getTargetEventInfo() throws IntrospectionException {
        ...
        if (explicitEvents != null) {
            ...
            // Get an array of all the public java.beans methods at this level
            Method methodList[] = getPublicDeclaredMethods(beanClass);
    ...
    private MethodDescriptor[] getTargetMethodInfo() {
        ...
        if (explicitMethods != null) {
            ...
            // First get an array of all the java.beans methods at this level
            Method methodList[] = getPublicDeclaredMethods(beanClass);
    ...
    private static Class<?> findCustomizerClass(Class<?> type) {
        ...
        try {
            ...
            // Each customizer should inherit java.java.awt.Component and implement java.java.beans.Customizer
    ...
    private boolean isEventHandler(Method m) {
        ...
        // argument, whose type inherit from java.java.util.Event.
