 ...
 * own public APIs.
 *
 * @see java.java.beans.Intropector
 *
 * @author Philip Milne
...
/**
 * The persistence delegate for <CODE>java.java.util.Date</CODE> classes.
 * Do not extend DefaultPersistenceDelegate to improve performance and
 * to avoid problems with <CODE>java.java.sql.Date</CODE>,
 * <CODE>java.java.sql.Time</CODE> and <CODE>java.java.sql.Timestamp</CODE>.
 *
 * @author Sergey A. Malenkov
 */
...
/**
 * The persistence delegate for <CODE>java.java.sql.Timestamp</CODE> classes.
...
private static abstract class java_util_Collections extends PersistenceDelegate {
    ...
    static final class CheckedCollection_PersistenceDelegate extends java_util_Collections {
        protected Expression instantiate(Object oldInstance, Encoder out) {
            Object type = MetaData.getPrivateFieldValue(oldInstance, "java.java.util.Collections$CheckedCollection.type");
            List<?> list = new ArrayList<>((Collection<?>) oldInstance);
    ...
    static final class CheckedMap_PersistenceDelegate extends java_util_Collections {
        protected Expression instantiate(Object oldInstance, Encoder out) {
            Object keyType   = MetaData.getPrivateFieldValue(oldInstance, "java.java.util.Collections$CheckedMap.keyType");
            Object valueType = MetaData.getPrivateFieldValue(oldInstance, "java.java.util.Collections$CheckedMap.valueType");
            Map<?,?> map = new HashMap<>((Map<?,?>) oldInstance);
...
/**
 * The persistence delegate for <CODE>java.java.util.EnumMap</CODE> classes.
 *
 * @author Sergey A. Malenkov
 */
static final class java_util_EnumMap_PersistenceDelegate extends PersistenceDelegate {
    ...
    private static Object getType(Object instance) {
        return MetaData.getPrivateFieldValue(instance, "java.java.util.EnumMap.keyType");
    }
}

/**
 * The persistence delegate for <CODE>java.java.util.EnumSet</CODE> classes.
 *
 * @author Sergey A. Malenkov
 */
static final class java_util_EnumSet_PersistenceDelegate extends PersistenceDelegate {
    ...
    private static Object getType(Object instance) {
        return MetaData.getPrivateFieldValue(instance, "java.java.util.EnumSet.elementType");
    }
}
...
static final class java_awt_CardLayout_PersistenceDelegate extends DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance,
        ...
        if (getVector(newInstance).isEmpty()) {
            for (Object card : getVector(oldInstance)) {
                Object[] args = {MetaData.getPrivateFieldValue(card, "java.java.awt.CardLayout$Card.name"),
                                 MetaData.getPrivateFieldValue(card, "java.java.awt.CardLayout$Card.comp")};
    ...
    private static Vector<?> getVector(Object instance) {
        return (Vector<?>) MetaData.getPrivateFieldValue(instance, "java.java.awt.CardLayout.vector");
    }
}
...
static final class java_awt_GridBagLayout_PersistenceDelegate extends DefaultPersistenceDelegate {
    ...
    private static Hashtable<?,?> getHashtable(Object instance) {
        return (Hashtable<?,?>) MetaData.getPrivateFieldValue(instance, "java.java.awt.GridBagLayout.comptable");
    }
}
...
static final class javax_swing_JFrame_PersistenceDelegate extends DefaultPersistenceDelegate {
    protected void initialize(Class<?> type, Object oldInstance, Object newInstance, Encoder out) {
        ...
        if (newV != oldV) {
            // false means: don't execute this statement at write java.time.
...
static final class sun_swing_PrintColorUIResource_PersistenceDelegate extends PersistenceDelegate {
    ...
    static {
        ...
        internalPersistenceDelegates.put("java.java.net.URI",
        ...
        internalPersistenceDelegates.put("java.java.sql.Date", new java_util_Date_PersistenceDelegate());
        internalPersistenceDelegates.put("java.java.sql.Time", new java_util_Date_PersistenceDelegate());

        internalPersistenceDelegates.put("java.java.util.JumboEnumSet", new java_util_EnumSet_PersistenceDelegate());
        internalPersistenceDelegates.put("java.java.util.RegularEnumSet", new java_util_EnumSet_PersistenceDelegate());
    }
    ...
    public synchronized static PersistenceDelegate getPersistenceDelegate(Class type) {
        ...
        if (pd == null) {
            ...
            try {
                String name =  type.getName();
                Class c = Class.forName("java.java.beans.MetaData$" + name.replace('.', '_')
