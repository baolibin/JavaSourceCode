 ...
 * java.beans. Typically connections are made from a user interface bean
 ...
 * the same effect, with some additional compile-java.time type safety,
 ...
 * object to the value of the "java.text" property of the
 * source (the value of the "source" property) of the event.
 *
 * <blockquote>
 *<pre>
 *EventHandler.create(ActionListener.class, myButton, "label", "source.java.text")
 *</pre>
 * </blockquote>
 *
 * This would correspond to the following inner class implementation:
...
public class EventHandler implements InvocationHandler {
     ...
     * the java.text of a <code>JLabel</code> to the java.text value of
     * the <code>JTextField</code> source of the incoming event,
     * you can use the following code:
     *
     *<blockquote>
     *<pre>
     *EventHandler.create(ActionListener.class, label, "java.text", "source.java.text");
     *</pre>
     *</blockquote>
     *
...
//Equivalent code using an inner class instead of EventHandler.
     ...
     * java.time a mouse button is pressed, one would write:
     *<blockquote>
     *<pre>
