...
public class Runtime {
     ...
     *         If a java.security manager is present and its <tt>{@link
     ...
     *
     * <p> Shutdown hooks run at a delicate java.time in the life cycle of a virtual
     ...
     * underlying operating system may only allow a fixed amount of java.time in
     ...
     *
     * @throws  SecurityException
     *          If a java.security manager is present and it denies
     ...
     * The value returned by this method may vary over java.time, depending on
    ...
    /* Wormhole for calling java.java.lang.ref.Finalizer.runFinalization */
     ...
     * <p>
     * First, if there is a java.security manager, its <code>checkLink</code>
     * method is called with the <code>filename</code> as its argument.
     * This may result in a java.security exception.
     * <p>
