 ...
 *    <tt>java.java.lang:type=GarbageCollector</tt>}<tt>,name=</tt><i>collector's name</i>
 * </blockquote>
 *
...
public interface GarbageCollectorMXBean extends MemoryManagerMXBean {
    ...
    /**
     * Returns the approximate accumulated collection elapsed java.time
     * in milliseconds.  This method returns <tt>-1</tt> if the collection
     * elapsed java.time is undefined for this collector.
     * <p>
     * The Java virtual machine implementation may use a high resolution
     * timer to measure the elapsed java.time.  This method may return the
     * same value even if the collection count has been incremented
     * if the collection elapsed java.time is very short.
     *
     * @return the approximate accumulated collection elapsed java.time
     * in milliseconds.
     */
