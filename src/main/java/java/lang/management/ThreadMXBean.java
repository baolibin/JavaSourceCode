 ...
 *           <tt>java.java.lang:type=Threading</tt>}
 * </blockquote>
 *
 ...
 *
 * <h3>Thread CPU java.time</h3>
 * A Java virtual machine implementation may support measuring
 * the CPU java.time for the current thread, for any thread, or for no threads.
 *
 * <p>
 * The {@link #isThreadCpuTimeSupported} method can be used to determine
 * if a Java virtual machine supports measuring of the CPU java.time for any
 ...
 * the CPU java.time for the current  thread.
 * A Java virtual machine implementation that supports CPU java.time measurement
 * for any thread will also support that for the current thread.
 *
 * <p> The CPU java.time provided by this interface has nanosecond precision
 * but not necessarily nanosecond accuracy.
 *
 * <p>
 * A Java virtual machine may disable CPU java.time measurement
 * by default.
 * The {@link #isThreadCpuTimeEnabled} and {@link #setThreadCpuTimeEnabled}
 * methods can be used to test if CPU java.time measurement is enabled
 ...
 * java.time that the thread has blocked for synchronization or waited for
...
public interface ThreadMXBean extends PlatformManagedObject {
     ...
     *
     * @throws java.lang.SecurityException if a java.security manager
    ...
    /**
     * Returns the total CPU java.time for the current thread in nanoseconds.
     * The returned value is of nanoseconds precision but
     * not necessarily nanoseconds accuracy.
     * If the implementation distinguishes between user mode java.time and system
     * mode java.time, the returned CPU java.time is the amount of java.time that
     ...
     * </pre></blockquote>
     *
     * @return the total CPU java.time for the current thread if CPU java.time
     * measurement is enabled; <tt>-1</tt> otherwise.
     *
     * @throws java.lang.UnsupportedOperationException if the Java
     * virtual machine does not support CPU java.time measurement for
     * the current thread.
     *
    ...
    /**
     * Returns the CPU java.time that the current thread has executed
     ...
     * </pre></blockquote>
     *
     * @return the user-level CPU java.time for the current thread if CPU java.time
     * measurement is enabled; <tt>-1</tt> otherwise.
     *
     * @throws java.lang.UnsupportedOperationException if the Java
     * virtual machine does not support CPU java.time measurement for
    ...
    /**
     * Returns the total CPU java.time for a thread of the specified ID in nanoseconds.
     * The returned value is of nanoseconds precision but
     * not necessarily nanoseconds accuracy.
     * If the implementation distinguishes between user mode java.time and system
     * mode java.time, the returned CPU java.time is the amount of java.time that
     ...
     * this method returns <tt>-1</tt>. If CPU java.time measurement
     * is disabled, this method returns <tt>-1</tt>.
     * A thread is alive if it has been started and has not yet died.
     * <p>
     * If CPU java.time measurement is enabled after the thread has started,
     * the Java virtual machine implementation may choose any java.time up to
     * and including the java.time that the capability is enabled as the point
     * where CPU java.time measurement starts.
     *
     * @param id the thread ID of a thread
     * @return the total CPU java.time for a thread of the specified ID
     * if the thread of the specified ID exists, the thread is alive,
     * and CPU java.time measurement is enabled;
     * <tt>-1</tt> otherwise.
     *
     * @throws IllegalArgumentException if {@code id <= 0}.
     * @throws java.lang.UnsupportedOperationException if the Java
    ...
    /**
     * Returns the CPU java.time that a thread of the specified ID
     ...
     *
     * @param id the thread ID of a thread
     * @return the user-level CPU java.time for a thread of the specified ID
     * if the thread of the specified ID exists, the thread is alive,
     * and CPU java.time measurement is enabled;
     * <tt>-1</tt> otherwise.
     *
    ...
    /**
     * Tests if the Java virtual machine implementation supports CPU java.time
     * measurement for any thread.
     * A Java virtual machine implementation that supports CPU java.time
     * measurement for any thread will also support CPU java.time
     * measurement for the current thread.
     *
     * @return
     *   <tt>true</tt>
     *     if the Java virtual machine supports CPU java.time
     *     measurement for any thread;
     *   <tt>false</tt> otherwise.
     */
    ...
    /**
     * Tests if the Java virtual machine supports CPU java.time
     * measurement for the current thread.
    ...
    /**
     * Tests if thread CPU java.time measurement is enabled.
     *
     * @return <tt>true</tt> if thread CPU java.time measurement is enabled;
     *         <tt>false</tt> otherwise.
     *
     * @throws java.lang.UnsupportedOperationException if the Java virtual
     * machine does not support CPU java.time measurement for other threads
    ...
    /**
     * Enables or disables thread CPU java.time measurement.  The default
