 ...
 *      may also release memory to the system over java.time.
 ...
 *      The amount of committed memory may change over java.time (increase
 ...
 *      The maximum amount of memory may change over java.time if defined.
