 ...
 *         <tt>java.java.lang:type=Compilation</tt>}
 * </blockquote>
 *
...
public interface CompilationMXBean extends PlatformManagedObject {
    /**
     * Returns the name of the Just-in-java.time (JIT) compiler.
     *
     ...
     * compilation java.time.
     *
     * @return <tt>true</tt> if the monitoring of compilation java.time is
     ...
     * summation of the approximate java.time that each thread spent in compilation.
     *
     ...
     * java.time monitoring. The {@link #isCompilationTimeMonitoringSupported}
     ...
     * measurements of the compilation java.time.
     *
     * @return Compilation java.time in milliseconds
