...
/**
 * The java.security manager is a class that allows
 * applications to implement a java.security policy. It allows an
 * application to determine, before performing a possibly unsafe or
 * sensitive operation, what the operation is and whether
 * it is being attempted in a java.security context that allows the
 ...
 * <blockquote><pre>
 *     SecurityManager java.security = System.getSecurityManager();
 *     if (java.security != null) {
 *         java.security.check<i>XXX</i>(argument, &nbsp;.&nbsp;.&nbsp;.&nbsp;);
 *     }
 * </pre></blockquote>
 * <p>
 * The java.security manager is thereby given an opportunity to prevent
 * completion of the operation by throwing an exception. A java.security
 ...
 * <p>
 * The current java.security manager is set by the
 * <code>setSecurityManager</code> method in class
 * <code>System</code>. The current java.security manager is obtained
 ...
 * just a single permission argument always performs java.security checks
 * within the context of the currently executing thread.
 * Sometimes a java.security check that should be made within a given context
 ...
 * permission categories are <code>java.java.io.FilePermission</code>,
 * <code>java.java.net.SocketPermission</code>,
 * <code>java.java.net.NetPermission</code>,
 * <code>java.java.security.SecurityPermission</code>,
 * <code>java.java.lang.RuntimePermission</code>,
 * <code>java.java.util.PropertyPermission</code>,
 * <code>java.java.awt.AWTPermission</code>,
 * <code>java.java.lang.reflect.ReflectPermission</code>, and
 * <code>java.java.io.SerializablePermission</code>.
 *
 * <p>All but the first two (FilePermission and SocketPermission) are
 * subclasses of <code>java.java.security.BasicPermission</code>, which itself
 * is an abstract subclass of the
 * top-level class for permissions, which is
 * <code>java.java.security.Permission</code>. BasicPermission defines the
 ...
 * (<code>java.java.security.Permission</code>). Classes like these
 * that have a more complicated name syntax than that used by
 * BasicPermission subclass directly from Permission rather than from
 * BasicPermission. For example,
 * for a <code>java.java.io.FilePermission</code> object, the permission name is
 * the path name of a file (or directory).
 *
 * <p>Some of the permission classes have an "actions" list that tells
 * the actions that are permitted for the object.  For example,
 * for a <code>java.java.io.FilePermission</code> object, the actions list
 ...
 *
 * <p>Note: There is also a <code>java.java.security.AllPermission</code>
 * permission that implies all permissions. It exists to simplify the work
 * of system administrators who might need to perform multiple
 * tasks that require all (or numerous) permissions.
 * <p>
 * See <a href ="../../../technotes/guides/java.security/permissions.html">
 ...
 * the JDK and advice regarding porting of 1.1-style java.security managers,
 * see the <a href="../../../technotes/guides/java.security/index.html">java.security documentation</a>.
 *
...
class SecurityManager {
    ...
    /**
     * This field is <code>true</code> if there is a java.security check in
     * progress; <code>false</code> otherwise.
     *
     * @deprecated This type of java.security checking is not recommended.
    ...
    /**
     * Tests if there is a java.security check in progress.
     *
     * @return the value of the <code>inCheck</code> field. This field
     *          should contain <code>true</code> if a java.security check is
     *          in progress,
     ...
     *
     * <p> If there is a java.security manager already installed, this method first
     * calls the java.security manager's <code>checkPermission</code> method
     * with the <code>RuntimePermission("createSecurityManager")</code>
     * permission to ensure the calling thread has permission to create a new
     * java.security manager.
     * This may result in throwing a <code>SecurityException</code>.
     *
     * @exception  java.lang.SecurityException if a java.security manager already
     *             exists and its <code>checkPermission</code> method
     *             doesn't allow creation of a new java.security manager.
    ...
    public SecurityManager() {
        synchronized(SecurityManager.class) {
            SecurityManager sm = System.getSecurityManager();
            if (sm != null) {
                // ask the currently installed java.security manager if we
     ...
     *   <code>java.java.security.AllPermission</code> does not
     ...
     *          to perform some java.security checks later.
     ...
     * on the java.security policy currently in effect.
     * <p>
     ...
     *            the current java.security policy.
     ...
     * specified java.security context is denied access to the resource
     * specified by the given permission.
     * The context must be a java.security
     * context returned by a previous call to
     * <code>getSecurityContext</code> and the access control
     * decision is based upon the configured java.security policy for
     * that java.security context.
     * <p>
     ...
     * @param      context   a system-dependent java.security context.
     * @exception  SecurityException  if the specified java.security context
     ...
     * <p>
     * This method is invoked for the current java.security manager by the
     ...
     * equivalent java.security check should be placed in the overridden method.
     *
     ...
     * <p>
     * This method is invoked for the current java.security manager when a
     ...
     * <p>
     * This method is invoked for the current java.security manager by
    ...
    /**
     * Throws a <code>SecurityException</code> if the
     * specified java.security context is not allowed to read the file
     * specified by the string argument. The context must be a java.security
     * context returned by a previous call to
    ...
    /**
     * Throws a <code>SecurityException</code> if the
     * specified java.security context is not allowed to open a socket
     ...
     * <p>
     * This method calls <code>checkPermission</code> with the
     * <code>java.java.net.SocketPermission(maddr.getHostAddress(),
     ...
     *             <code>null</code>.
     * @since      JDK1.1
     * @deprecated Use #checkPermission(java.java.security.Permission) instead
     * @see        #checkPermission(java.security.Permission) checkPermission
     */
    @Deprecated
     ...
     * {@code java.java.awt} package, {@code checkPermission} is instead called
     * to check the permission {@code java.java.security.AllPermission}.
     * <p>
     * If you override this method, then you should make a call to
     ...
     *             the permission {@code java.java.security.AllPermission}.
     * @see        java.awt.Window
     * @see        #checkPermission(java.security.Permission) checkPermission
     */
    @Deprecated
     ...
     * java.java.security.Security property changes via setProperty(), the
     ...
     * a call to
     * <code>java.java.security.Security.getProperty("package.access")</code>,
     ...
     * <code>java.java.security.Security.getProperty("package.definition")</code>,
     * and checks to see if <code>pkg</code> starts with or equals
     * any of the restricted packages. If it does, then
     * <code>checkPermission</code> gets called with the
    ...
    public void checkMemberAccess(Class<?> clazz, int which) {
        ...
        if (which != Member.PUBLIC) {
             ...
             * methods in java.java.lang.Class that invoke checkMember
             * access. The stack should look like:
             *
             * someCaller                        [3]
             * java.java.lang.Class.someReflectionAPI [2]
             * java.java.lang.Class.checkMemberAccess [1]
     ...
     * thread being created at the java.time this is being called.
     * By default, it returns the thread group of the current
     * thread. This should be overridden by a specific java.security
