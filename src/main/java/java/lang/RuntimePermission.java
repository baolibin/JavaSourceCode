 ...
 *   <td>Setting of the java.security manager (possibly replacing an existing one)
 * </td>
 *   <td>The java.security manager is a class that allows
 * applications to implement a java.security policy. Granting the setSecurityManager
 * permission would allow code to change which java.security manager is used by
 * installing a different, possibly less restrictive java.security manager,
 * thereby bypassing checks that would have been enforced by the original
 * java.security manager.</td>
 * </tr>
 *
 * <tr>
 *   <td>createSecurityManager</td>
 *   <td>Creation of a new java.security manager</td>
 ...
 * does not compromise the java.security of the system, it does give
 ...
 *   <td>It is dangerous to allow an java.applet permission to load native code
 * libraries, because the Java java.security architecture is not designed to and
 ...
 * java.security in the system.</td>
 * </tr>
 *
 * <tr>
 ...
 * trusted packages like <code>java.java.security</code> or <code>java.java.lang</code>,
 * for example.</td>
 * </tr>
 *
 * <tr>
 ...
 *   java.java.util.prefs.Preferences implementations user or system root
 ...
 *   java.security prompting behavior.</td>
 *   <td>For more information, refer to Java Plug-In's guides, <a href=
 *   "../../../technotes/guides/plugin/developer_guide/java.security.html">
