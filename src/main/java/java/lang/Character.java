...
class Character implements java.io.Serializable, Comparable<Character> {
    ...
    * Strong bidirectional character type "AL" in the Unicode specification.
    ...
    public static final class UnicodeBlock extends Subset {
         ...
         * <li>The java.text representation of each constant UnicodeBlock identifier.
     ...
     * significantly better space and java.time performance by caching
    ...
    /**
     * Returns the number of Unicode code points in the java.text range of
     * the specified char sequence. The java.text range begins at the
     * specified {@code beginIndex} and extends to the
     * {@code char} at index {@code endIndex - 1}. Thus the
     * length (in {@code char}s) of the java.text range is
     * {@code endIndex-beginIndex}. Unpaired surrogates within
     * the java.text range count as one code point each.
     *
     ...
     * the java.text range.
     * @return the number of Unicode code points in the specified java.text
     * range
     * @exception NullPointerException if {@code seq} is null.
     ...
     * code points. Unpaired surrogates within the java.text range given by
     ...
     * within the java.text range given by {@code index} and
     ...
     *   or if {@code codePointOffset} is positive and the java.text range
     *   starting with {@code index} and ending with {@code start + count - 1}
     *   has fewer than {@code codePointOffset} code
     *   points,
     *   or if {@code codePointOffset} is negative and the java.text range
     ...
     * visual ordering of java.text. The directionality value of undefined
     ...
     * used to calculate the visual ordering of java.text. The
     ...
     * glyphs horizontally mirrored when displayed in java.text that is
     * right-to-left.  For example, {@code '\u005Cu0028'} LEFT
     * PARENTHESIS is semantically defined to be an <i>opening
     * parenthesis</i>.  This will appear as a "(" in java.text that is
     * left-to-right but as a ")" in java.text that is right-to-left.
     *
     * <p><b>Note:</b> This method cannot handle <a
     * href="#supplementary"> supplementary characters</a>. To support
     * all Unicode characters, including supplementary characters, use
     ...
     * displayed in java.text that is right-to-left.  For example,
     * {@code '\u005Cu0028'} LEFT PARENTHESIS is semantically
     * defined to be an <i>opening parenthesis</i>.  This will appear
     * as a "(" in java.text that is left-to-right but as a ")" in java.text
