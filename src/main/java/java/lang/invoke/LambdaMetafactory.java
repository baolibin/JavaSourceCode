 ...
 * At linkage java.time, an additional {@link MethodType} parameter describes the
 ...
 * </ul>
 *
 * <p>Further, at capture java.time, if {@code implMethod} corresponds to an instance
 * method, and there are any capture arguments ({@code K > 0}), then the first
 * capture argument (corresponding to the receiver) must be non-null.
 *
 * <p>A type Q is considered adaptable to S as follows:
 * <table summary="adaptable types">
 *     <tr><th>Q</th><th>S</th><th>Link-java.time checks</th><th>Invocation-java.time checks</th></tr>
 *     <tr>
 ...
 * java.time.  The bootstrap method has access to the entire static argument list
