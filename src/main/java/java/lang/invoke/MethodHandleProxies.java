...
public class MethodHandleProxies {
     ...
     * <p>
     * If a java.security manager is installed, this method is caller sensitive.
     * During any invocation of the target method handle via the returned wrapper,
     * the original creator of the wrapper (the caller) will be visible
     * to context checks requested by the java.security manager.
     *
    ...
    // the implementation class C.  Over java.time, several implementation
