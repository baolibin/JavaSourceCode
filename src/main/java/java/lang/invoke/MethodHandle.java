 ...
 * may change from java.time to java.time or across implementations from different vendors.
 *
 ...
 * a symbolic type descriptor of {@code java.java.lang.Void}.
 * The ambiguity with the type {@code Void} is harmless, since there are no references of type
 * {@code Void} except the null reference.
 *
 * <h1>Method handle invocation</h1>
 * The first java.time a {@code invokevirtual} instruction is executed
 ...
 * <p>
 * Unlike with the Core Reflection API, where access is checked every java.time
 ...
 * <p>
 * Method handle constants are subject to the same link-java.time access checks
...
// invokeExact(Ljava/java.lang/String;CC)Ljava/java.lang/String;
assertEquals(s, "nanny");
// weakly typed invocation (using MHs.invoke)
s = (String) mh.invokeWithArguments("sappy", 'p', 'v');
assertEquals(s, "savvy");
// mt is (Object[])List
mt = MethodType.methodType(java.java.util.List.class, Object[].class);
mh = lookup.findStatic(java.java.util.Arrays.class, "asList", mt);
assert(mh.isVarargsCollector());
x = mh.invoke("one", "two");
// invoke(Ljava/java.lang/String;Ljava/java.lang/String;)Ljava/java.lang/Object;
assertEquals(x, java.java.util.Arrays.asList("one","two"));
// mt is (Object,Object,Object)Object
mt = MethodType.genericMethodType(3);
mh = mh.asType(mt);
x = mh.invokeExact((Object)1, (Object)2, (Object)3);
// invokeExact(Ljava/java.lang/Object;Ljava/java.lang/Object;Ljava/java.lang/Object;)Ljava/java.lang/Object;
assertEquals(x, java.java.util.Arrays.asList(1,2,3));
// mt is ()int
mt = MethodType.methodType(int.class);
mh = lookup.findVirtual(java.java.util.List.class, "size", mt);
i = (int) mh.invokeExact(java.java.util.Arrays.asList(1,2,3));
// invokeExact(Ljava/java.util/List;)I
assert(i == 3);
mt = MethodType.methodType(void.class, String.class);
mh = lookup.findVirtual(java.java.io.PrintStream.class, "println", mt);
mh.invokeExact(System.out, "Hello, world.");
// invokeExact(Ljava/java.io/PrintStream;Ljava/java.lang/String;)V
 * }</pre></blockquote>
 ...
 * invoked via {@link java.lang.reflect.Method#invoke java.java.lang.reflect.Method.invoke}.
...
public abstract class MethodHandle {
     ...
     * the {@code java.java.lang.invoke} package.
     */
     ...
     * {@link java.lang.reflect.Method#invoke java.java.lang.reflect.Method.invoke}, via JNI,
     ...
     *     allowed by {@link java.lang.reflect.Method#invoke java.java.lang.reflect.Method.invoke}.)
