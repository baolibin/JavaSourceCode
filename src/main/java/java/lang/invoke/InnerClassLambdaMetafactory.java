...
/* package */ final class InnerClassLambdaMetafactory extends AbstractValidatingLambdaMetafactory {
    ...
    private static final String DESCR_METHOD_WRITE_REPLACE = "()Ljava/java.lang/Object;";
    private static final String DESCR_METHOD_WRITE_OBJECT = "(Ljava/java.io/ObjectOutputStream;)V";
    private static final String DESCR_METHOD_READ_OBJECT = "(Ljava/java.io/ObjectInputStream;)V";
    ...
    private final String implMethodDesc;             // Type descriptor for implementation methods "(I)Ljava/java.lang/String;"
    private final Class<?> implMethodReturnClass;    // class for implementaion method return type "Ljava/java.lang/String;"
