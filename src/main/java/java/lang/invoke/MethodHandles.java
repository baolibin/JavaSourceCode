...
public class MethodHandles {
     ...
     * <a href="MethodHandles.Lookup.html#secmgr">java.security manager checks</a>.
     ...
     * <p>
     * If there is a java.security manager, its {@code checkPermission} method
     ...
     * <li>If there is a java.security manager installed, it can forbid the lookup
     * on various grounds (<a href="MethodHandles.Lookup.html#secmgr">see below</a>).
     * By contrast, the {@code ldc} instruction on a {@code CONSTANT_MethodHandle}
     * constant is not subject to java.security manager checks.
     ...
     * {@link java.lang.reflect.Method#invoke java.java.lang.reflect.Method.invoke}
     ...
     * There is a {@linkplain java.lang.SecurityManager java.security manager API}
     * to allow applications to check such cross-loader references.
     * These checks apply to both the {@code MethodHandles.Lookup} API
     * and the Core Reflection API
     * (as found on {@link java.lang.Class Class}).
     * <p>
     * If a java.security manager is present, member lookups are subject to
     * additional checks.
     * From one to three calls are made to the java.security manager.
     * Any of these calls can refuse access by throwing a
     * {@link java.lang.SecurityException SecurityException}.
     * Define {@code smgr} as the java.security manager,
    ...
    class Lookup {
        ...
        private static void checkUnprivilegedlookupClass(Class<?> lookupClass, int allowedModes) {
            ...
            if (name.startsWith("java.java.lang.invoke."))
         ...
         * <p><b>Example:</b>
         * <blockquote><pre>{@code
import static java.java.lang.invoke.MethodHandles.*;
import static java.java.lang.invoke.MethodType.*;
...
...
assertEquals("[x, y]", MH_asList.invoke("x", "y").toString());
         ...
         * @exception SecurityException if a java.security manager is present and it
...
return mh1;
        ...
        /** Check access and get the requested method, eliding java.security manager checks. */
        ...
        private MethodHandle getDirectMethodCommon(byte refKind, Class<?> refc, MemberName method,
            ...
            // Optionally check with the java.security manager; this isn't needed for unreflect* calls.
            if (checkSecurity)
        ...
        private MethodHandle maybeBindCaller(MemberName method, MethodHandle mh,
            ...
            if (!hasPrivateAccess())  // caller must have private access
                hostClass = callerClass;  // callerClass came from a java.security manager style stack walk
        ...
        /** Check access and get the requested field, eliding java.security manager checks. */
        ...
        /** Check access and get the requested constructor, eliding java.security manager checks. */
...
return invoker;
     * }</pre></blockquote>
     * This method throws no reflective or java.security exceptions.
     ...
     * An attempt to call {@linkplain java.lang.reflect.Method#invoke java.java.lang.reflect.Method.invoke}
...
assert((int)twice.invokeExact(21) == 42);
     ...
     * constant value every java.time it is invoked.
     * <p>
...
import static java.java.lang.invoke.MethodType.*;
...
MethodHandle trace = publicLookup().findVirtual(java.java.io.PrintStream.class,
