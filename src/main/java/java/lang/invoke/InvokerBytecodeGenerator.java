...
class InvokerBytecodeGenerator {
    ...
    private static final String OBJARY  = "[Ljava/java.lang/Object;";
     ...
     * @param arg compile-java.time representation of value on stack (Node, constant) or null if none
     */
    ...
    private byte[] generateCustomizedCodeBytes() {
        ...
        mv.visitAnnotation("Ljava/java.lang/invoke/LambdaForm$Hidden;", true);

        // Mark this method as a compiled LambdaForm
        mv.visitAnnotation("Ljava/java.lang/invoke/LambdaForm$Compiled;", true);

        if (lambdaForm.forceInline) {
            // Force inlining of this invoker method.
            mv.visitAnnotation("Ljava/java.lang/invoke/ForceInline;", true);
        } else {
            mv.visitAnnotation("Ljava/java.lang/invoke/DontInline;", true);
        }
        ...
        if (lambdaForm.customized != null) {
            ...
            // are compile-java.time constants for JIT compiler.
            ...
            switch (intr) {
                case SELECT_ALTERNATIVE:
                    ...
                    if (PROFILE_GWT) {
                        ...
                        mv.visitAnnotation("Ljava/java.lang/invoke/InjectedProfile;", true);
                    }
    ...
    static boolean isStaticallyInvocable(MemberName member) {
        ...
        if (!member.isPrivate() && VerifyAccess.isSamePackage(MethodHandle.class, cls))
            return true;   // in java.java.lang.invoke package
    ...
    private Name emitGuardWithCatch(int pos) {
        ...
        mv.visitInsn(Opcodes.SWAP);
        mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/lang/Class", "isInstance", "(Ljava/java.lang/Object;)Z", false);
    ...
    private byte[] generateLambdaFormInterpreterEntryPointBytes() {
        ...
        // invoke
        emitAloadInsn(0);
        mv.visitFieldInsn(Opcodes.GETFIELD, MH, "form", "Ljava/java.lang/invoke/LambdaForm;");
        mv.visitInsn(Opcodes.SWAP);  // swap form and array; avoid local variable
        mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, LF, "interpretWithArguments", "([Ljava/java.lang/Object;)Ljava/java.lang/Object;", false);
