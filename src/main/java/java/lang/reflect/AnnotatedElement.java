 ...
 * annotations may be generated at compile-java.time to wrap multiple
...
public interface AnnotatedElement {
   ...
   /**
     ...
     * #getDeclaredAnnotations()} a single java.time and the returned array
