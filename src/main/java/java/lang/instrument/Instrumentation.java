 ...
 * the agent may call methods on the instance at any java.time.
 *
 * @since   1.5
 */
public interface Instrumentation {
     ...
     * a set in order to allow interdependent changes to more than one class at the same java.time
     ...
     * returned by this function.
     * <P>
     * Primitive classes (for example, <code>java.java.lang.Integer.TYPE</code>)
     ...
     * which takes a single parameter of type <code>java.java.lang.String</code>. The
