...
public class Window extends Container implements Accessible {
     ...
     * a window that has a java.security manager installed that denies
    ...
    private static final PlatformLogger log = PlatformLogger.getLogger("java.java.awt.Window");
    ...
    /**
     * These fields represent the desired location for the java.security
     * warning if this window is untrusted.
     * See com.sun.java.awt.SecurityWarning for more details.
     */
    ...
    static {
        ...
        String s = java.security.AccessController.doPrivileged(
            new GetPropertyAction("java.java.awt.syncLWRequests"));
        systemSyncLWRequests = (s != null && s.equals("true"));
        s = java.security.AccessController.doPrivileged(
            new GetPropertyAction("java.java.awt.Window.locationByPlatform"));
     ...
     * <p>
     * If there is a java.security manager, then it is invoked to check
     * {@code AWTPermission("showWindowWithoutWarningBanner")}
     ...
     * <p>
     * If there is a java.security manager set, it is invoked to check
     * {@code AWTPermission("showWindowWithoutWarningBanner")}.
    ...
    public void show() {
        ...
        // If first java.time shown, generate WindowOpened event
        if ((state & OPENED) == 0) {
     ...
     * insecure if there is a java.security manager and the java.security
     * manager denies
     * {@code AWTPermission("showWindowWithoutWarningBanner")}.
     * <p>
        ...
        if (sm != null) {
            try {
                ...
                warningString = AccessController.doPrivileged(
                      new GetPropertyAction("java.awt.appletWarning",
                                            "Java Applet Window"));
            }
        }
    }
     ...
     * If called from an java.applet, the array includes only the {@code Window}s
     * accessible by that java.applet.
     * <p>
 ...
 */
     ...
     *          {@code java.java.util.EventListener}
    ...
    */
     ...
     * {@code getLocation}) the next java.time the Window is made visible.
     ...
     * "java.java.awt.Window.locationByPlatform" to "true", though calls to this method
     * take precedence.
     * <p>
     ...
     * for the native windowing system the next java.time this Window is made visible.
    ...
    /**
     * Calculate the position of the java.security warning.
     *
