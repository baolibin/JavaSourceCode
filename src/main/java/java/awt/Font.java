 ...
 * render java.text in a visible way.
 ...
 * rendering underlined java.text, convenient since it is not
 ...
 * will return true.</p>
 *
 * <p>Note: Font rotations can cause java.text baselines to be rotated.  In
...
public class Font implements java.io.Serializable
{
     ...
     * to provide compile-java.time verification of the name.
     * @since 1.6
     */
    ...
    /**
     * The baseline used in most Roman scripts when laying out java.text.
     */
    public static final int ROMAN_BASELINE = 0;

    /**
     * The baseline used in ideographic scripts like Chinese, Japanese,
     * and Korean when laying out java.text.
     */
     ...
     * font.  Most of the java.time, the internal object is null.
    ...
    public AffineTransform getTransform() {
        ...
        if (nonIdentityTx) {
            ...
            if (values.getSuperscript() != 0) {
                ...
                // and bring the following java.text too close.  The way we deal with potential
     ...
     * following line in a single spaced java.text document. The point size is
     ...
     *  at <code>readObject</code> java.time than at
     *  <code>writeObject</code> java.time.  An integer version is
     ...
     * href="../../java/java.lang/Character.html#supplementary"> supplementary
     ...
     * the characters in the specified <code>java.text</code>
     ...
     *              <code>char</code>s) into the specified array of
     *              <code>char</code> values
     * @return an offset into <code>java.text</code> that points
     *          to the first character in <code>java.text</code> that this
     *          <code>Font</code> cannot display; or <code>-1</code> if
     *          this <code>Font</code> can display all characters in
     *          <code>java.text</code>.
     * @since 1.2
     ...
     * java.text specified by the <code>iter</code> starting at
     ...
     * java.text.  For example, in some languages and in some fonts, accent
     * marks can be positioned above the ascent or below the descent.
     * To obtain a visual bounding box, which encloses all the java.text,
   ...
   /**
     ...
     * all the java.text.  For example, in some languages and in some fonts,
     * accent marks can be positioned above the ascent or below the
     * descent.  To obtain a visual bounding box, which encloses all the
     * java.text, use the {@link TextLayout#getBounds() getBounds} method of
     * <code>TextLayout</code>.
     * <p>Note: The returned bounds is in baseline-relative coordinates
     * (see {@link java.awt.Font class notes}).
     * @param chars an array of characters
    ...
    public Rectangle2D getStringBounds(char [] chars,
        ...
        // quick check for simple java.text, assume GV ok to use if simple
   ...
   /**
     ...
     * layout of the java.text if possible.  Full layout is required for
     * complex java.text, such as Arabic or Hindi.  Support for different
     * scripts depends on the font and implementation.
     * <p>
     * Layout requires bidi analysis, as performed by
     * <code>Bidi</code>, and should only be performed on java.text that
     ...
     * added to the flags parameter to indicate that the java.text before
     ...
     *
     * @param frc the specified <code>FontRenderContext</code>
     * @param text the java.text to layout
     * @param start the start of the java.text to use for the <code>GlyphVector</code>
     * @param limit the limit of the java.text to use for the <code>GlyphVector</code>
     * @param flags control flags as described above
     * @return a new <code>GlyphVector</code> representing the java.text between
    ...
    /**
     * A flag to layoutGlyphVector indicating that java.text is left-to-right as
     * determined by Bidi analysis.
     */
    public static final int LAYOUT_LEFT_TO_RIGHT = 0;

    /**
     * A flag to layoutGlyphVector indicating that java.text is right-to-left as
     * determined by Bidi analysis.
     */
    public static final int LAYOUT_RIGHT_TO_LEFT = 1;

    /**
     * A flag to layoutGlyphVector indicating that java.text in the char array
