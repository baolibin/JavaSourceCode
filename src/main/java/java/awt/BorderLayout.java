 ...
 * <p>
 * Here is an example of five buttons in an java.applet laid out using
 * the <code>BorderLayout</code> layout manager:
 * <p>
 * <img src="doc-files/BorderLayout-1.gif"
 * alt="Diagram of an java.applet demonstrating BorderLayout.
 *      Each section of the BorderLayout contains a Button corresponding to its position in the layout, one of:
 *      North, West, Center, East, or South."
 * style="float:center; margin: 7px 10px;">
 * <p>
 * The code for this java.applet is as follows:
 *
 * <hr><blockquote><pre>
...
public class BorderLayout implements LayoutManager2,
    ...
    public Object getConstraints(Component comp) {
        //fix for 6242148 : API method java.java.awt.BorderLayout.getConstraints(null) should return null
        if (comp == null){
            return null;
        }
        if (comp == center) {
