...
public class GridBagConstraints implements Cloneable, java.io.Serializable {
     ...
     * lines of java.text would normally begin for the current
    ...
    /**
     * Place the component centered along the edge of its display area where
     * lines of java.text would normally end for the current
     ...
     * the first line of java.text on a page would normally begin for the current
    ...
    /**
     * Place the component in the corner of its display area where
     * the first line of java.text on a page would normally end for the current
    ...
    /**
     * Place the component in the corner of its display area where
     * the last line of java.text on a page would normally start for the current
    ...
    /**
     * Place the component in the corner of its display area where
     * the last line of java.text on a page would normally end for the current
