...
public interface TextAreaPeer extends TextComponentPeer {
    ...
    /**
     * Inserts the specified java.text at the specified position in the document.
     *
     * @param text the java.text to insert
    ...
    /**
     * Replaces a range of java.text by the specified string.
     *
