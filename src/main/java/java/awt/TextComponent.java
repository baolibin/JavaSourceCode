 ...
 * any component that allows the editing of some java.text.
 * <p>
 * A java.text component embodies a string of java.text.  The
 * <code>TextComponent</code> class defines a set of methods
 * that determine whether or not this java.text is editable. If the
 * component is editable, it defines another set of methods
 * that supports a java.text insertion caret.
 * <p>
 * In addition, the class defines methods that are used
 * to maintain a current <em>selection</em> from the java.text.
 * The java.text selection, a substring of the component's java.text,
 * is the target of editing operations. It is also referred
 * to as the <em>selected java.text</em>.
 *
 * @author      Sami Shaio
...
public class TextComponent extends Component implements Accessible {
     ...
     * It will be <code>true</code> if the java.text component
    ...
    /**
     * The selection refers to the selected java.text, and the
     * <code>selectionStart</code> is the start position
     * of the selected java.text.
     *
     * @serial
     ...
     * is the end position of the selected java.text.
     *
     * @serial
     * @see #getSelectionEnd()
    ...
    /**
     * Constructs a new java.text component initialized with the
     * specified java.text. Sets the value of the cursor to
     * <code>Cursor.TEXT_CURSOR</code>.
     * @param      text       the java.text to be displayed; if
     *             <code>java.text</code> is <code>null</code>, the empty
    ...
    /**
     * Enables or disables input method support for this java.text component. If input
     * method support is enabled and the java.text component also processes key events,
     ...
     * does not consume them. Whether and how input method support for this java.text
    ...
    /**
     * Sets the java.text that is presented by this
     * java.text component to be the specified java.text.
     * @param       t   the new java.text;
     *                  if this parameter is <code>null</code> then
     *                  the java.text is set to the empty string ""
    ...
    public synchronized void setText(String t) {
        ...
        // if TextArea.setText() or TextField.setText() replaces an empty java.text
        // by an empty java.text, that is, if component's java.text remains unchanged.
    ...
    /**
     * Returns the java.text that is presented by this java.text component.
    ...
    /**
     * Returns the selected java.text from the java.text that is
     * presented by this java.text component.
     * @return      the selected java.text of this java.text component
    ...
    /**
     * Indicates whether or not this java.text component is editable.
     * @return     <code>true</code> if this java.text component is
     ...
     * java.text component is editable.
     * <p>
     * If the flag is set to <code>true</code>, this java.text component
     * becomes user editable. If the flag is set to <code>false</code>,
     * the user cannot change the java.text of this java.text component.
     * By default, non-editable java.text components have a background color
     * of SystemColor.control.  This default can be overridden by
     * calling setBackground.
     *
     * @param     b   a flag indicating whether this java.text component
     *                      is user editable.
    ...
    /**
     * Gets the background color of this java.text component.
     *
     * By default, non-editable java.text components have a background color
     * of SystemColor.control.  This default can be overridden by
     * calling setBackground.
     *
     * @return This java.text component's background color.
     *         If this java.text component does not have a background color,
    ...
    /**
     * Sets the background color of this java.text component.
     *
     * @param c The color to become this java.text component's color.
     *        If this parameter is null then this java.text component
    ...
    /**
     * Gets the start position of the selected java.text in
     * this java.text component.
     * @return      the start position of the selected java.text
    ...
    /**
     * Sets the selection start for this java.text component to
    ...
    /**
     * Gets the end position of the selected java.text in
     * this java.text component.
     * @return      the end position of the selected java.text
     * @see         java.awt.TextComponent#setSelectionEnd
     * @see         java.awt.TextComponent#getSelectionStart
     */
    ...
    /**
     * Sets the selection end for this java.text component to
     * the specified position. The new end point is constrained
     * to be at or after the current selection start. It also
     * cannot be set beyond the end of the component's java.text.
    ...
    /**
     * Selects the java.text between the specified start and end positions.
     * <p>
     * This method sets the start and end positions of the
     * selected java.text, enforcing the restriction that the start position
     * must be greater than or equal to zero.  The end position must be
     * greater than or equal to the start position, and less than or
     * equal to the length of the java.text component's java.text.  The
     ...
     * If the start and end positions of the selected java.text are equal,
     * all java.text is deselected.
     * <p>
     * If the caller supplies values that are inconsistent or out of
     * bounds, the method enforces these constraints silently, and
     * without failure. Specifically, if the start position or end
     * position is greater than the length of the java.text, it is reset to
     * equal the java.text length. If the start position is less than zero,
     ...
     * @param        selectionEnd the zero-based end position of the
                       java.text to be selected; the character (<code>char</code> value) at
    ...
    /**
     * Selects all the java.text in this java.text component.
     * @see        java.awt.TextComponent#select
     */
    ...
    /**
     * Returns the position of the java.text insertion caret.
     * The caret position is constrained to be between 0
     * and the last character of the java.text, inclusive.
     * If the java.text or caret have not been set, the default
     * caret position is 0.
     *
     * @return       the position of the java.text insertion caret
    ...
    /**
     * Adds the specified java.text event listener to receive java.text events
     * from this java.text component.
     * If <code>l</code> is <code>null</code>, no exception is
     * thrown and no action is performed.
     * <p>Refer to <a href="doc-files/AWTThreadIssues.html#ListenersThreads"
     * >AWT Threading Issues</a> for details on AWT's threading model.
     *
     * @param l the java.text event listener
    ...
    /**
     * Removes the specified java.text event listener so that it no longer
     * receives java.text events from this java.text component
     * If <code>l</code> is <code>null</code>, no exception is
     * thrown and no action is performed.
     * <p>Refer to <a href="doc-files/AWTThreadIssues.html#ListenersThreads"
     * >AWT Threading Issues</a> for details on AWT's threading model.
     *
     * @param           l     the java.text listener
     * @see             #addTextListener
     * @see             #getTextListeners
     * @see             java.awt.event.TextListener
     * @since           JDK1.1
    ...
    /**
     * Returns an array of all the java.text listeners
     * registered on this java.text component.
     *
     * @return all of this java.text component's <code>TextListener</code>s
     *         or an empty array if no java.text
     ...
     * for its java.text listeners with the following code:
     *
     ...
     *          <code>java.java.util.EventListener</code>
     * @return an array of all objects registered as
     *          <code><em>Foo</em>Listener</code>s on this java.text component,
    ...
    /**
     * Processes events on this java.text component. If the event is a
    ...
    /**
     * Processes java.text events occurring on this java.text component by
     * dispatching them to any registered <code>TextListener</code> objects.
     * <p>
     * NOTE: This method will not be called unless java.text events
     ...
     * <code>null</code>.
     *
     * @return      the parameter string of this java.text component
     */
    protected String paramString() {
        String str = super.paramString() + ",java.text=" + getText();
        if (editable) {
            str += ",editable";
        }
      ...
      throws IOException
    {
        ...
        // selectionStart, selectionEnd, and java.text aren't necessarily
     ...
     * add a listener to receive java.text events fired by the
        ...
        throws ClassNotFoundException, IOException, HeadlessException
    {
        ...
        // Make sure the state we just read in for java.text,
...
////////////////
     ...
     * For java.text components, the AccessibleContext takes the form of an
     ...
     * Java Accessibility API appropriate to java.text component user-interface
     * elements.
     * @since 1.3
     */
        ...
        implements AccessibleText, TextListener
    {
        ...
        /**
         * TextListener notification of a java.text value change.
         */
         ...
         *
         * @param i the zero-based index into the java.text
        ...
        /**
         * Returns the start offset within the selected java.text.
         * If there is no selection, but there is
         * a caret, the start and end offsets will be the same.
         * Return 0 if the java.text is empty, or the caret position
         * if no selection.
         *
         * @return the index into the java.text of the start of the selection &gt;= 0
         */
        ...
        /**
         * Returns the end offset within the selected java.text.
         * If there is no selection, but there is
         * a caret, the start and end offsets will be the same.
         * Return 0 if the java.text is empty, or the caret position
         * if no selection.
         *
         * @return the index into the java.text of the end of the selection &gt;= 0
         */
        ...
        /**
         * Returns the portion of the java.text that is selected.
         *
         * @return the java.text, null if no selection
         */
         ...
         * @param index an index within the java.text &gt;= 0
         ...
         * The method assumes that s is the java.text assigned to words.
         */
        private int findWordLimit(int index, BreakIterator words, boolean direction,
            ...
            // Please see java.java.text.BreakIterator JavaDoc. The code below is
