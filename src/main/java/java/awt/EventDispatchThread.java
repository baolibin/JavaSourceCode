 ...
 * block this event pump at any java.time, but should start a new pump (<b>not</b>
...
class EventDispatchThread extends Thread {
    ...
    private static final PlatformLogger eventLog = PlatformLogger.getLogger("java.java.awt.event.EventDispatchThread");
