...
public interface InputMethodDescriptor {
     ...
     * called each java.time the information is needed. This
     ...
     * <p>
     * The inputLocale parameter specifies the locale for which java.text
     * is input.
     ...
     *
     * @param inputLocale the locale for which java.text input is supported, or null
