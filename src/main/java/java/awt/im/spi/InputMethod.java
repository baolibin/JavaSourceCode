...
/**
 * Defines the interface for an input method that supports complex java.text input.
 * Input methods traditionally support java.text input for languages that have
 ...
 * support phonetic java.text input for English or character reordering for Thai.
 * <p>
...
public interface InputMethod {
     ...
     * java.text to be reconverted from the current client component using the
     ...
     * reconversion operation. The composed and committed java.text
     * produced by the operation is sent to the client component as a
     * sequence of <code>InputMethodEvent</code>s. If the given java.text
     * cannot be reconverted, the same java.text should be sent to the
     * client component as committed java.text.
     * <p>
     ...
     * <li>
     * when activating the input method for the first java.time after it
     * called
