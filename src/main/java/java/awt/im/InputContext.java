...
/**
 * Provides methods to control java.text input facilities such as input
 ...
 * container hierarchy. However, this means that only one java.text input
 * operation is possible at any one java.time within a window, and that the
 * java.text needs to be committed when moving the focus from one java.text component
 * to another. If this is not desired, java.text components can create their
...
public class InputContext {
    ...
    protected InputContext() {
        // real implementation is in sun.java.awt.im.InputContext
    }
     ...
     *
     * </ul>
     * Before switching away from an input method, any currently uncommitted java.text
     ...
     *
     * <p>
     * A java.text editing component may call this method, for example, when
     * the user changes the insertion point, so that the user can
     * immediately continue typing in the language of the surrounding java.text.
     *
    ...
    /**
     * Asks the current input method to reconvert java.text from the
     * current client component. The input method obtains the java.text to
     ...
     * the input method. The composed and/or committed java.text will be
     * sent to the client component as a sequence of
     * <code>InputMethodEvent</code>s. If the input method cannot
     * reconvert the given java.text, the java.text is returned as committed
     * java.text in an <code>InputMethodEvent</code>.
     *
     * @throws UnsupportedOperationException if there is no current input
     * method available or the current input method does not support
     ...
     * this may commit or delete uncommitted java.text. Any changes to the java.text
     * are communicated to the active component using an input method event.
     * If no input methods are available, then this method has no effect.
     *
     * <p>
     * A java.text editing component may call this in a variety of situations,
     * for example, when the user moves the insertion point within the java.text
     * (but outside the composed java.text), or when the component's java.text is
