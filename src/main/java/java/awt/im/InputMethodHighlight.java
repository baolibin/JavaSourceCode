...
* attributes of java.text being composed.
* The description can be at two levels:
* at the abstract level it specifies the conversion state and whether the
* java.text is selected; at the concrete level it specifies style attributes used
...
* <code>selected</code> indicates whether the java.text range is the one that the
...
* main conversion step of java.text composition, say, before and after kana-&gt;kanji
...
* instances to indicate separate java.text segments.
*
...
public class InputMethodHighlight {
    ...
    /**
     * Constant for the default highlight for selected converted java.text.
     */
     ...
     * @param selected Whether the java.text range is selected
     * @param state The conversion state for the java.text range - RAW_TEXT or CONVERTED_TEXT
     ...
     * @param selected Whether the java.text range is selected
     * @param state The conversion state for the java.text range - RAW_TEXT or CONVERTED_TEXT
     * @param variation The style variation for the java.text range
     * @see InputMethodHighlight#RAW_TEXT
     * @see InputMethodHighlight#CONVERTED_TEXT
     * @exception IllegalArgumentException if a state other than RAW_TEXT or CONVERTED_TEXT is given
     */
     ...
     * @param selected whether the java.text range is selected
     * @param state the conversion state for the java.text range - RAW_TEXT or CONVERTED_TEXT
     * @param variation the variation for the java.text range
     * @param style the rendering style attributes for the java.text range, or null
     * @see InputMethodHighlight#RAW_TEXT
     * @see InputMethodHighlight#CONVERTED_TEXT
     * @exception IllegalArgumentException if a state other than RAW_TEXT or CONVERTED_TEXT is given
     * @since 1.3
    ...
    /**
     * Returns whether the java.text range is selected.
     */
    ...
    /**
     * Returns the conversion state of the java.text range.
     * @return The conversion state for the java.text range - RAW_TEXT or CONVERTED_TEXT.
     * @see InputMethodHighlight#RAW_TEXT
     * @see InputMethodHighlight#CONVERTED_TEXT
     */
    public int getState() {
    ...
    /**
     * Returns the variation of the java.text range.
     */
    ...
    /**
     * Returns the rendering style attributes for the java.text range, or null.
     * @since 1.3
     */
