 ...
 * cause the application or java.applet to misbehave in an insecure manner.</td>
 * </tr>
 *
 * <tr>
 ...
 * <tr>
 *   <td>createRobot</td>
 *   <td>Create java.java.awt.Robot objects</td>
 *   <td>The java.java.awt.Robot object allows code to generate native-level
 ...
 * the implementation, the java.security warning may not be shown for the windows
 ...
 * non-full-screen windows will continue to be shown with the java.security
 * warning.</td>
 * </tr>
 *
 * <tr>
 ...
 * or java.applet to misbehave in an insecure manner.</td>
 * </tr>
 *
 * <tr>
 *   <td>readDisplayPixels</td>
 *   <td>Readback of pixels from the display screen</td>
 *   <td>Interfaces such as the java.java.awt.Composite interface or the
 * java.java.awt.Robot class allow arbitrary code to examine pixels on the
 ...
 *   <td>Malicious code could set an java.applet's stub and result in unexpected
 * behavior or denial of service to an java.applet.</td>
 * </tr>
 *
 * <tr>
 ...
 * that the window was created by an java.applet</td>
 *   <td>Without this warning,
 * an java.applet may pop up windows without the user knowing that they
 * belong to an java.applet.  Since users may make java.security-sensitive
 * decisions based on whether or not the window belongs to an java.applet
 ...
 *   <td>When a toolkit-modal dialog is shown from an java.applet, it blocks all other
 * applets in the browser. When launching applications from Java Web Start,
 * its windows (such as the java.security dialog) may also be blocked by toolkit-modal
 ...
 * an java.applet can make guesses about what the user is doing, i.e. moving
 ...
 * so that keyboard is emulated using the mouse, an java.applet may guess what
 * is being typed.</td>
 * </tr>
 * </table>
 *
