 ...
 * method on <code>java.java.awt.Toolkit</code>.
 *
...
public final class SystemColor extends Color implements java.io.Serializable {
   ...
   /**
    ...
    private static int[] systemColors = {
        ...
        0xFFC0C0C0,  // java.text = Color.lightGray;
   ...
   /**
    ...
    /**
     * The color rendered for the window-title java.text of the currently active window.
     */
    ...
    /**
     * The color rendered for the window-title java.text of inactive windows.
     */
    ...
    /**
     * The color rendered for java.text of interior regions inside windows.
     */
    ...
    /**
     * The color rendered for the java.text of menus.
     */
    public final static SystemColor menuText = new SystemColor((byte)MENU_TEXT);

    /**
     * The color rendered for the background of java.text control objects, such as
     * textfields and comboboxes.
     */
    public final static SystemColor text = new SystemColor((byte)TEXT);

    /**
     * The color rendered for the java.text of java.text control objects, such as textfields
     * and comboboxes.
     */
     ...
     * comboboxes, and java.text.
     */
    public final static SystemColor textHighlight = new SystemColor((byte)TEXT_HIGHLIGHT);

    /**
     * The color rendered for the java.text of selected items, such as in menus, comboboxes,
     * and java.text.
     */
    public final static SystemColor textHighlightText = new SystemColor((byte)TEXT_HIGHLIGHT_TEXT);

    /**
     * The color rendered for the java.text of inactive items, such as in menus.
     */
    ...
    /**
     * The color rendered for the java.text of control panels and control objects,
     * such as pushbuttons.
     */
    ...
    /**
     * The color rendered for the java.text of tooltips or spot help.
     */
