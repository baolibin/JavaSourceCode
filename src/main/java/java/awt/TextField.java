...
/**
 * A <code>TextField</code> object is a java.text component
 * that allows for the editing of a single line of java.text.
 * <p>
 * For example, the following image depicts a frame with four
 * java.text fields of varying widths. Two of these java.text fields
 * display the predefined java.text <code>"Hello"</code>.
 * <p>
 * <img src="doc-files/TextField-1.gif" alt="The preceding java.text describes this image."
 * style="float:center; margin: 7px 10px;">
 * <p>
 * Here is the code that produces these four java.text fields:
 *
 * <hr><blockquote><pre>
 * TextField tf1, tf2, tf3, tf4;
 * // a blank java.text field
 * tf1 = new TextField();
 * // blank field of 20 columns
 * tf2 = new TextField("", 20);
 * // predefined java.text displayed
 * tf3 = new TextField("Hello!");
 * // predefined java.text in 30 columns
 * tf4 = new TextField("Hello", 30);
 * </pre></blockquote><hr>
 * <p>
 * Every java.time the user types a key in the java.text field, one or
 * more key events are sent to the java.text field.  A <code>KeyEvent</code>
 ...
 * java.time at which the event occurred.
 * <p>
 ...
 * If action events are enabled for the java.text field, they may
...
public class TextField extends TextComponent {
    ...
    /**
     * The number of columns in the java.text field.
     ...
     * typed into the java.text field.
    ...
    /**
     * Constructs a new java.text field.
    ...
    /**
     * Constructs a new java.text field initialized with the specified java.text.
    ...
    /**
     * Constructs a new empty java.text field with the specified number
     ...
     * <p>
     * An echo character is useful for java.text fields where
     * user input should not be echoed to the screen, as in
     * the case of a java.text field for entering a password.
     ...
     * different.
     * @return      the echo character for this java.text field.
    ...
    /**
     * Sets the echo character for this java.text field.
     * <p>
     * An echo character is useful for java.text fields where
     * user input should not be echoed to the screen, as in
     * the case of a java.text field for entering a password.
     ...
     * @param       c   the echo character for this java.text field.
     * @see         java.awt.TextField#echoCharIsSet
    ...
    /**
     * Indicates whether or not this java.text field has a
     * character set for echoing.
     * <p>
     * An echo character is useful for java.text fields where
     * user input should not be echoed to the screen, as in
     * the case of a java.text field for entering a password.
     * @return     <code>true</code> if this java.text field has
    ...
    /**
     * Gets the number of columns in this java.text field. A column is an
    ...
    /**
     * Sets the number of columns in this java.text field. A column is an
     * approximate average character width that is platform-dependent.
    ...
    /**
     * Gets the preferred size of this java.text field
     * with the specified number of columns.
     * @param     columns the number of columns
     *                 in this java.text field.
     * @return    the preferred dimensions for
     *                 displaying this java.text field.
     * @since     JDK1.1
     */
    ...
    /**
     * Gets the minimum dimensions for a java.text field with
     * the specified number of columns.
     * @param    columns   the number of columns in
     *                          this java.text field.
     * @since    JDK1.1
     */
    ...
    /**
     * Gets the minimum dimensions for this java.text field.
     ...
     * action events from this java.text field.
     ...
     * receives action events from this java.text field.
     * If l is null, no exception is thrown and no action is performed.
     * <p>Refer to <a href="doc-files/AWTThreadIssues.html#ListenersThreads"
     * >AWT Threading Issues</a> for details on AWT's threading model.
     *
    ...
    /**
     * Processes events on this java.text field. If the event
    ...
    /**
     * Processes action events occurring on this java.text field by
     ...
     * <code>null</code>.
     *
     * @return      the parameter string of this java.text field
     */
...
////////////////
     ...
     * For java.text fields, the AccessibleContext takes the form of an
     ...
     * Java Accessibility API appropriate to java.text field user-interface elements.
     * @since 1.3
     */
