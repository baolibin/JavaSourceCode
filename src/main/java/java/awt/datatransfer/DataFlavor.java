 ...
 * <p>
 * Also, {@code DataFlavor} instances with the &quot;java.text&quot; primary
 * MIME type may have a &quot;charset&quot; parameter. Refer to
 * <a href="http://www.ietf.org/rfc/rfc2046.txt">RFC 2046</a> and
 * {@link #selectBestTextFlavor} for details on &quot;java.text&quot; MIME types
 ...
 * <pre>
 *   DataFlavor flavor1 = new DataFlavor(Object.class, &quot;X-test/test; class=&lt;java.java.lang.Object&gt;; foo=bar&quot;);
 *   DataFlavor flavor2 = new DataFlavor(Object.class, &quot;X-test/test; class=&lt;java.java.lang.Object&gt;; x=y&quot;);
...
public class DataFlavor implements Externalizable, Cloneable {
    ...
    static private DataFlavor initHtmlDataFlavor(String htmlFlavorType) {
        try {
            return new DataFlavor ("java/text/html; class=java.java.lang.String;document=" +
     ...
     * where:
     * <pre>
     *     representationClass = java.java.lang.String
     ...
     * where:
     * <pre>
     *     representationClass = java.java.awt.Image
     *     mimeType            = "image/x-java-image"
     * </pre>
     */
    public static final DataFlavor imageFlavor = createConstant("image/x-java-image; class=java.java.awt.Image", "Image");

    /**
     * The <code>DataFlavor</code> representing plain java.text with Unicode
     * encoding, where:
     * <pre>
     *     representationClass = InputStream
     *     mimeType            = "java.text/plain; charset=unicode"
     * </pre>
     ...
     */
    @Deprecated
    public static final DataFlavor plainTextFlavor = createConstant("java/text/plain; charset=unicode; class=java.java.io.InputStream", "Plain Text");
     ...
     * from an invocation <code>java.java.awt.datatransfer.getTransferData</code>.
     */
     ...
     * representation class of <code>java.java.util.List</code> is used.
     * Each element of the list is required/guaranteed to be of type
     * <code>java.java.io.File</code>.
     */
    public static final DataFlavor javaFileListFlavor = createConstant("application/x-java-file-list;class=java.java.util.List", null);
     ...
     * <code>java.java.io.InputStream</code> is used as default.
     *
     * @param mimeType the string used to identify the MIME type for this flavor;
    ...
    */
     ...
     * representation class. If this flavor has a primary MIME type of "java.text",
     ...
     * for a list of java.text flavors which support the charset parameter.
     *
    ...
    /**
     * Returns a <code>DataFlavor</code> representing plain java.text with Unicode
     * encoding, where:
     * <pre>
     *     representationClass = java.java.io.InputStream
     ...
     *
     * @return a <code>DataFlavor</code> representing plain java.text
    ...
    public static final DataFlavor getTextPlainUnicodeFlavor() {
        ...
        return new DataFlavor(
            "java/text/plain;charset=" +encoding
            +";class=java.java.io.InputStream", "Plain Text");
    }

    /**
     * Selects the best java.text <code>DataFlavor</code> from an array of <code>
     * DataFlavor</code>s. Only <code>DataFlavor.stringFlavor</code>, and
     * equivalent flavors, and flavors that have a primary MIME type of "java.text",
     ...
     * <li>"java.text/html"
     * <li>"java.text/rtf"
     * <li>"java.text/enriched"
     * <li>"java.text/richtext"
     * <li>"java.text/uri-list"
     * <li>"java.text/tab-separated-values"
     * <li>"java.text/t140"
     * <li>"java.text/rfc822-headers"
     * <li>"java.text/parityfec"
     * <li>"java.text/directory"
     * <li>"java.text/css"
     * <li>"java.text/calendar"
     * <li>"application/x-java-serialized-object"
     * <li>"java.text/plain"
     * <li>"java.text/&lt;other&gt;"
     * </ul>
     * <p>For example, "java.text/sgml" will be selected over
     * "java.text/html", and <code>DataFlavor.stringFlavor</code> will be chosen
     ...
     * <li>"java.text/parityfec"
     * </ul>
     * For "java.text/&lt;other&gt;" MIME types, the first java.time the JRE needs to
     ...
     * <code>DataFlavor</code>s with a "java.text/&lt;other&gt;" MIME type specify
     ...
     * charset for a "java.text/&lt;other&gt;" DataFlavor. Failure to adhere to this
     * restriction will lead to undefined behavior.
     * <p>
     * If the best MIME type in the array does not support the charset
     * parameter, the flavors which share that MIME type will then be sorted by
     * their representation classes in the following order:
     * <code>java.java.io.InputStream</code>, <code>java.java.nio.ByteBuffer</code>,
     ...
     * <code>java.java.io.Reader</code>, <code>java.java.lang.String</code>,
     * <code>java.java.nio.CharBuffer</code>, <code>[C</code>, &lt;all others&gt;.
     * <p>
     ...
     *         has zero length, or contains no java.text flavors
     * @since 1.3
     */
    ...
    /**
     * Gets a Reader for a java.text flavor, decoded, if necessary, for the expected
     * charset (encoding). The supported representation classes are
     * <code>java.java.io.Reader</code>, <code>java.java.lang.String</code>,
     * <code>java.java.nio.CharBuffer</code>, <code>[C</code>,
     * <code>java.java.io.InputStream</code>, <code>java.java.nio.ByteBuffer</code>,
     * and <code>[B</code>.
     * <p>
     * Because java.text flavors which do not support the charset parameter are
     ...
     * of java.text flavors which do not support the charset parameter.
     *
     ...
     *            is <code>java.java.io.InputStream</code>,
     *            <code>java.java.nio.ByteBuffer</code>, or <code>[B</code> and
     ...
     * equal. Additionally, if the primary type is "java.text", the subtype denotes
     * a java.text flavor which supports the charset parameter, and the
     * representation class is not <code>java.java.io.Reader</code>,
     * <code>java.java.lang.String</code>, <code>java.java.nio.CharBuffer</code>, or
     ...
     * <code>selectBestTextFlavor</code> for a list of java.text flavors which
    ...
    public boolean equals(DataFlavor that) {
        ...
        if (mimeType == null) {
            ...
            if ("java/text".equals(getPrimaryType())) {
    ...
    public int hashCode() {
        ...
        if (mimeType != null) {
            ...
            if ("java/text".equals(primaryType)) {
                if (DataTransferer.doesSubtypeSupportCharset(this)
                        && representationClass != null
                        && !isStandardTextRepresentationClass()) {
    ...
    /**
     * Checks if the representation class is one of the standard java.text
     * representation classes.
     *
     * @return true if the representation class is one of the standard java.text
    ...
    * <code>java.java.io.InputStream</code>?
    */
     ...
     * <code>DataFlavor</code> is <code>java.java.io.Reader</code> or a subclass
     * thereof.
     *
     * @since 1.4
     */
    ...
    /**
     * Returns whether the representation class for this
     * <code>DataFlavor</code> is <code>java.java.nio.CharBuffer</code> or a
     * subclass thereof.
     *
     * @since 1.4
     */
    ...
    /**
     * Returns whether the representation class for this
     * <code>DataFlavor</code> is <code>java.java.nio.ByteBuffer</code> or a
     * subclass thereof.
     *
     * @since 1.4
     */
   ...
   public boolean isFlavorJavaFileListType() {
    ...
    /**
     * Returns whether this <code>DataFlavor</code> is a valid java.text flavor for
     * this implementation of the Java platform. Only flavors equivalent to
     * <code>DataFlavor.stringFlavor</code> and <code>DataFlavor</code>s with
     * a primary MIME type of "java.text" can be valid java.text flavors.
     * <p>
     * If this flavor supports the charset parameter, it must be equivalent to
     * <code>DataFlavor.stringFlavor</code>, or its representation must be
     * <code>java.java.io.Reader</code>, <code>java.java.lang.String</code>,
     * <code>java.java.nio.CharBuffer</code>, <code>[C</code>,
     * <code>java.java.io.InputStream</code>, <code>java.java.nio.ByteBuffer</code>, or
     ...
     * representation must be <code>java.java.io.InputStream</code>,
     * <code>java.java.nio.ByteBuffer</code>, or <code>[B</code>.
     * <p>
     * See <code>selectBestTextFlavor</code> for a list of java.text flavors which
     * support the charset parameter.
     *
     * @return <code>true</code> if this <code>DataFlavor</code> is a valid
     *         java.text flavor as described above; <code>false</code> otherwise
     * @see #selectBestTextFlavor
     * @since 1.4
     */
    ...
    * parameters like the java.text/plain <code>charset</code>
