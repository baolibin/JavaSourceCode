    ...
    implements KeyEventDispatcher, KeyEventPostProcessor
{
    ...
    private static final PlatformLogger focusLog = PlatformLogger.getLogger("java.java.awt.focus.KeyboardFocusManager");
    ...
    private static final PlatformLogger log = PlatformLogger.getLogger("java.java.awt.KeyboardFocusManager");
     ...
     *        for this application or java.applet's browser context
     *        ("managingFocus")</li>
     ...
     * timestamps later than the specified java.time stamp until the specified
     ...
     */
    void dumpRequests() {
        System.err.println(">>> Requests dump, java.time: " + System.currentTimeMillis());
         ...
         boolean focusedWindowChangeAllowed, long time, CausedFocusEvent.Cause cause)
    {
        if (log.isLoggable(PlatformLogger.Level.FINE)) {
            ...
            if (time == 0) {
                log.fine("Assertion (java.time != 0) failed");
            }
        }
    ...
    // the java.security concepts. In this case the trusted client code is responsible
