 ...
 * <code>java.java.awt</code> package with their counterparts in
 * <code>java.java.awt.peer</code>. Some methods defined by
...
public abstract class Toolkit {
     ...
     * the specified peer interface.
     * @param     target the java.text field to be implemented.
     ...
     * the specified peer interface.
     * @param     target the java.text area to be implemented.
     ...
     * @deprecated  see java.java.awt.GraphicsEnvironment#getAllFonts
     */
    @Deprecated
     ...
     * queried using getDesktopProperty("java.awt.dynamicLayoutSupported") method.
     *
     ...
     * be queried using getDesktopProperty("java.awt.dynamicLayoutSupported").
     *
     ...
     * the {@code validate()} method will be invoked each java.time.
     * The OS/WM support can be queried using
     * the getDesktopProperty("java.awt.dynamicLayoutSupported") method.
     *
     ...
     * init java.time and used at load java.time
     */
     ...
     * <p>
     * If a system property named <code>"java.java.awt.headless"</code> is set
     * to <code>true</code> then the headless implementation
     * of <code>Toolkit</code> is used.
     * <p>
     * If there is no <code>"java.java.awt.headless"</code> or it is set to
    ...
    public static synchronized Toolkit getDefaultToolkit() {
        if (toolkit == null) {
            java.security.AccessController.doPrivileged(
                ...
                public Void run() {
                    Class<?> cls = null;
                    String nm = System.getProperty("java.awt.toolkit");
                    try {
     ...
     * that are no longer in use for an indefinite period of java.time,
     ...
     * <p>
     * This method first checks if there is a java.security manager installed.
     * If so, the method calls the java.security manager's
     ...
     *                         the specified file.
     * @throws SecurityException  if a java.security manager exists and its
     ...
     * with pre-1.2 java.security managers, if the access is denied with
     ...
     * is a java.security manager installed. If there is, the method should call
     * the java.security manager's <code>checkPrintJobAccess</code> method to
     * ensure initiation of a print operation is allowed. If the default
     * implementation of <code>checkPrintJobAccess</code> is used (that is,
     * that method is not overriden), then this results in a call to the
     * java.security manager's <code>checkPermission</code> method with a <code>
     ...
     * </code> Toolkit property, java.text returned by the system Clipboard's <code>
     ...
     * </ul>
     * As with <code>java.java.awt.datatransfer.StringSelection</code>, if the
     ...
     * Each actual implementation of this method should first check if there
     * is a java.security manager installed. If there is, the method should call
     * the java.security manager's {@link SecurityManager#checkPermission
     ...
     * the user selects java.text, using either the mouse or the keyboard.
     * Typically, this is implemented by installing a
     * <code>FocusListener</code> on all <code>Component</code>s which support
     * java.text selection, and, between <code>FOCUS_GAINED</code> and
     ...
     * on the system. Note that <code>java.java.awt.TextComponent</code> and
     * <code>javax.swing.java.text.JTextComponent</code> already adhere to this
     ...
     * the same java.time the Toolkit object will be unable to apply the
     ...
     * sun.java.awt.resources.java.awt.properties.  The ResourceBundle is stored
     ...
     * would be to provide a separate library which defines java.java.awt.*
     * initIDs, and exports the relevant symbols out to the
     * implementation libraries.
     *
     * For now, we know it's done by the implementation, and we assume
     * that the name of the library is "java.awt".  -br.
     *
     * If you change loadLibraries(), please add the change to
     * java.java.awt.image.ColorModel.loadLibraries(). Unfortunately,
     * classes can be loaded in java.java.awt.image that depend on
    ...
    static {
        ...
        java.security.AccessController.doPrivileged(
            ...
            public Void run() {
                try {
                    resources =
                        ResourceBundle.getBundle("sun.java.awt.resources.java.awt",
    ...
    /**
     * Get the application's or java.applet's EventQueue instance.
     * Depending on the Toolkit implementation, different EventQueues
     * may be returned for different applets.  Applets should
     * therefore not assume that the EventQueue instance returned
     * by this method will be shared by other applets or the system.
     *
     * <p> If there is a java.security manager then its
     * {@link SecurityManager#checkPermission checkPermission} method
     * is called to check {@code AWTPermission("accessEventQueue")}.
     *
     * @return    the <code>EventQueue</code> object
     * @throws  SecurityException
     *          if a java.security manager is set and it denies access to
     *          the {@code EventQueue}
     * @see     java.awt.AWTPermission
    */
    ...
    /**
     * Gets the application's or java.applet's <code>EventQueue</code>
     * instance, without checking access.  For java.security reasons,
    ...
    public final synchronized Object getDesktopProperty(String propertyName) {
        ...
        if (propertyName.equals("java.awt.dynamicLayoutSupported")) {
        ...
        /* for property "java.awt.font.desktophints" */
     ...
     *         objects wrapped in {@code java.java.beans.PropertyChangeListenerProxy} objects
     ...
     * <p>
     * First, if there is a java.security manager, its <code>checkPermission</code>
     ...
     * @throws SecurityException
     *        if a java.security manager exists and its
     ...
     * If there is a java.security manager, its {@code checkPermission}
     * method is called with an
    ...
    private static class DesktopPropertyChangeSupport extends PropertyChangeSupport {
        ...
        /*
         * we do expect that all other fireXXX() methods of java.java.beans.PropertyChangeSupport
    ...
    * {@code EventQueue}.
    * <br>
    * To change the returned value it is necessary to set the {@code sun.java.awt.enableExtraMouseButtons}
    ...
    * <pre>
    * java -Dsun.java.awt.enableExtraMouseButtons=false Application
    * </pre>
    * Alternatively, the property could be set in the application by using the following code:
    * <pre>
    * System.setProperty("sun.java.awt.enableExtraMouseButtons", "true");
    * </pre>
    * before the {@code Toolkit} class initialization.
    * If not set by the java.time of the {@code Toolkit} class initialization, this property will be
