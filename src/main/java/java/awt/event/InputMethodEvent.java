...
/**
 * Input method events contain information about java.text that is being
 * composed using an input method. Whenever the java.text changes, the
 * input method sends an event. If the java.text component that's currently
 ...
 *
 * <p>
 * The java.text included with the input method event consists of two parts:
 * committed java.text and composed java.text. Either part may be empty. The two
 * parts together replace any uncommitted composed java.text sent in previous events,
 * or the currently selected committed java.text.
 * Committed java.text should be integrated into the java.text component's persistent
 * data, it will not be sent again. Composed java.text may be sent repeatedly,
 * with changes to reflect the user's editing operations. Committed java.text
 * always precedes composed java.text.
 *
...
public class InputMethodEvent extends AWTEvent {
    ...
    /**
     * The event type indicating changed input method java.text. This event is
    ...
    /**
     * The event type indicating a changed insertion point in input method java.text.
     * This event is
    ...
    /**
     * The java.time stamp that indicates when the event was created.
     *
     * @serial
     * @see #getWhen
     * @since 1.4
     ...
     * source component, type, java.time, java.text, caret, and visiblePosition.
     * <p>
     * The offsets of caret and visiblePosition are relative to the current
     * composed java.text; that is, the composed java.text within <code>java.text</code>
     * if this is an <code>INPUT_METHOD_TEXT_CHANGED</code> event,
     * the composed java.text within the <code>java.text</code> of the
     ...
     * @param when a long integer that specifies the java.time the event occurred
     * @param text the combined committed and composed java.text,
     *      committed java.text first; must be <code>null</code>
     ...
     *      committed or composed java.text
     * @param committedCharacterCount the number of committed
     *      characters in the java.text
     ...
     *      <code>java.text</code> is not <code>null</code>;
     *      or if <code>committedCharacterCount</code> is not in the range
     *      <code>0</code>..<code>(java.text.getEndIndex() - java.text.getBeginIndex())</code>
    ...
    public InputMethodEvent(Component source, int id, long when,
        ...
        if (id == CARET_POSITION_CHANGED && text != null) {
            throw new IllegalArgumentException("java.text must be null for CARET_POSITION_CHANGED");
        }
    ...
    /**
     * Constructs an <code>InputMethodEvent</code> with the specified
     * source component, type, java.text, caret, and visiblePosition.
     * <p>
     * The offsets of caret and visiblePosition are relative to the current
     * composed java.text; that is, the composed java.text within <code>java.text</code>
     * if this is an <code>INPUT_METHOD_TEXT_CHANGED</code> event,
     * the composed java.text within the <code>java.text</code> of the
     * preceding <code>INPUT_METHOD_TEXT_CHANGED</code> event otherwise.
     * The java.time stamp for this event is initialized by invoking
     ...
     * For an <code>INPUT_METHOD_TEXT_CHANGED</code> event without java.text,
    ...
    /**
     * Gets the combined committed and composed java.text.
     * Characters from index 0 to index <code>getCommittedCharacterCount() - 1</code> are committed
     * java.text, the remaining characters are composed java.text.
     *
     * @return the java.text.
     * Always null for CARET_POSITION_CHANGED;
     * may be null for INPUT_METHOD_TEXT_CHANGED if there's no composed or committed java.text.
     */
    ...
    /**
     * Gets the number of committed characters in the java.text.
     */
     ...
     * composed java.text; that is, the composed java.text within getText()
     * if this is an <code>INPUT_METHOD_TEXT_CHANGED</code> event,
     * the composed java.text within getText() of the
     * preceding <code>INPUT_METHOD_TEXT_CHANGED</code> event otherwise.
     *
     * @return the caret (a.k.a. insertion point).
     * Null if there's no caret within current composed java.text.
     */
     ...
     * Null if there's no recommendation for a visible position within current composed java.text.
     */
    ...
    /**
     * Returns the java.time stamp of when this event occurred.
     *
     ...
     * It contains the event ID in java.text form, the characters of the
     * committed and composed java.text
    ...
    /**
     * Get the most recent event java.time in the {@code EventQueue} which the {@code source}
     * belongs to.
     *
     * @param source the source of the event
     * @exception  IllegalArgumentException  if source is null.
     * @return most recent event java.time in the {@code EventQueue}
     */
