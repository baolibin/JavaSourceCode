...
public abstract class InputEvent extends ComponentEvent {
    ...
    private static final PlatformLogger logger = PlatformLogger.getLogger("java.java.awt.event.InputEvent");
    ...
    /**
     * The input event's Time stamp in UTC format.  The java.time stamp
    ...
    /**
     * The state of the modifier mask at the java.time the input
     * event was fired.
     *
     * @serial
     * @see #getModifiers()
     ...
     * @param when         a long int that gives the java.time the event occurred.
     ...
     * <code>java.awt.properties</code> file.
     * <p>
     ...
     * @return a java.text description of the combination of extended
