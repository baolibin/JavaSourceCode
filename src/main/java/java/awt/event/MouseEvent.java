...
public class MouseEvent extends InputEvent {
   ...
   */
     ...
     * type, java.time, modifiers, coordinates, click count, popupTrigger flag,
     * and button number.
     * <p>
     ...
     * @param when         A long integer that gives the java.time the event occurred.
     ...
     * Constructs a <code>MouseEvent</code> object with the
     * specified source component,
     * type, java.time, modifiers, coordinates, absolute coordinates, click count, popupTrigger flag,
     * and button number.
     * <p>
     * Creating an invalid event (such
     * as by using more than one of the old _MASKs, or modifier/button
     ...
     * the <code>java.awt.properties</code> file.
     * <p>
     ...
     * @return string   string java.text description of the combination of modifier
