 ...
 * (commonly lines of java.text in a java.text-based component) or an entire "block"
 * (similar to page-up/page-down).  The MouseWheelEvent offers
 * methods for conforming to the underlying platform settings.  These
 * platform settings can be changed at any java.time by the user.  MouseWheelEvents
...
public class MouseWheelEvent extends MouseEvent {
     ...
     * @param when           a long that gives the java.time the event occurred
     ...
     * @param when           a long value that gives the java.time when the event occurred
     * @param modifiers      the modifier keys down during event
     *                       (shift, ctrl, alt, meta)
