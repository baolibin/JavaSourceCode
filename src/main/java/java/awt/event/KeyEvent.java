 ...
 * <p>
 * This low-level event is generated by a component object (such as a java.text
...
public class KeyEvent extends InputEvent {
     ...
     * @param when      A long integer that specifies the java.time the event
     *                  occurred.
     ...
     * These strings can be localized by changing the java.awt.properties file.
     *
     * @return a string containing a java.text description for a physical key,
     ...
     * localized by changing the <code>java.awt.properties</code> file.
     * <p>
     ...
     *
     * @return string a java.text description of the combination of modifier
