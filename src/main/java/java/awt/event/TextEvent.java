...
/**
 * A semantic event which indicates that an object's java.text changed.
 * This high-level event is generated by an object (such as a TextComponent)
 * when its java.text changes. The event is passed to
 ...
 * Instead, it can process a "meaningful" (semantic) event like "java.text changed".
 * <p>
...
public class TextEvent extends AWTEvent {
    ...
    /**
     * The first number in the range of ids used for java.text events.
     */
    public static final int TEXT_FIRST  = 900;

    /**
     * The last number in the range of ids used for java.text events.
     */
    public static final int TEXT_LAST   = 900;

    /**
     * This event id indicates that object's java.text changed.
     */
    ...
    /**
     * Returns a parameter string identifying this java.text event.
