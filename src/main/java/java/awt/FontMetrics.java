 ...
 * For example, in Arabic java.text, the shape of a character can change
...
public abstract class FontMetrics implements java.io.Serializable {
     ...
     * <code>FontMetrics</code> object to measure java.text.
     * <p>
     * Note that methods in this class which take a <code>Graphics</code>
     * parameter measure java.text using the <code>FontRenderContext</code>
     ...
     * between the descent of one line of java.text and the ascent of the next
    ...
    /**
     * Gets the standard height of a line of java.text in this font.  This
     * is the distance between the baseline of adjacent lines of java.text.
     * It is the sum of the leading + ascent + descent. Due to rounding
     * this may not be the same as getAscent() + getDescent() + getLeading().
     * There is no guarantee that lines of java.text spaced at this distance are
