 ...
 * import java.java.awt.Graphics;
 * import java.java.awt.MediaTracker;
 *
 ...
 *      // don't need to clear the java.applet on repaints.
...
public class MediaTracker implements java.io.Serializable {
     ...
     * Starts loading all images tracked by this media tracker. This
     * method waits until all the images being tracked have finished
     * loading, or until the length of java.time specified in milliseconds
     ...
     * length of java.time specified in milliseconds by the <code>ms</code>
     * argument has passed.
     * <p>
     * If there is an error while loading or scaling an image, then that
     * image is considered to have finished loading. Use the
     ...
     * @param         id   the identifier of the images to check
     * @param         ms   the length of java.time, in milliseconds, to wait
     *                           for the loading to complete
     * @see           java.awt.MediaTracker#waitForAll
     * @see           java.awt.MediaTracker#waitForID(int)
     * @see           java.awt.MediaTracker#statusID
