 ...
 * java.java.awt.Event class.
 * Subclasses of this root AWTEvent class defined outside of the
 * java.java.awt.event package should define event ID values greater than
...
public abstract class AWTEvent extends EventObject {
    private static final PlatformLogger log = PlatformLogger.getLogger("java.java.awt.AWTEvent");
    private byte bdata[];
    ...
    */
    ...
    /**
     * The event mask for selecting java.text events.
     */
     ...
     * event class in java.java.awt.event because we don't want to make
     * it public and it needs to be called from java.java.awt.
     */
    Event convertToOld() {
