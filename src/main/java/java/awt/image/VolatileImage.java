 ...
 * contents at any java.time due to circumstances beyond the control of the
 ...
 * memory).
 * The flush method may be called at any java.time to proactively release
...
public abstract class VolatileImage extends Image implements Transparency
{
     ...
     * the <code>VolatileImage</code> at the java.time of the request
     ...
     * with those in the image only at the java.time that they are
     * retrieved. This method takes a snapshot
     * of the image at the java.time the request is made and the
