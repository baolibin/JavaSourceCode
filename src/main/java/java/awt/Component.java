 ...
 * <code>writeObject</code> java.time.  Developers will need, as always,
 * to consider the implications of making an object serializable.
 * One situation to watch out for is this:
 * <pre>
 *    import java.java.awt.*;
 *    import java.java.awt.event.*;
 ...
 *    import java.java.io.Serializable;
 *
 *    class MyApp implements java.java.io.Serializable
 *    {
 *         BigObjectThatShouldNotBeSerializedWithAButton bigOne;
 *         Button aButton = new Button();
 *
 ...
 * <a href="../../java/java.awt/doc-files/FocusSpec.html">Focus Specification</a>
                                           ...
                                           Serializable
{
    ...
    private static final PlatformLogger log = PlatformLogger.getLogger("java.java.awt.Component");
    private static final PlatformLogger eventLog = PlatformLogger.getLogger("java.java.awt.event.Component");
    private static final PlatformLogger focusLog = PlatformLogger.getLogger("java.java.awt.focus.Component");
    private static final PlatformLogger mixingLog = PlatformLogger.getLogger("java.java.awt.mixing.Component");
    ...
    static {
        ...
        String s = java.security.AccessController.doPrivileged(
                                                               new GetPropertyAction("java.awt.image.incrementaldraw"));
        isInc = (s == null || s.equals("true"));

        s = java.security.AccessController.doPrivileged(
                                                        new GetPropertyAction("java.awt.image.redrawrate"));
    ...
    public enum BaselineResizeBehavior {
         ...
         * <code>JLabel</code> containing non-empty java.text with a
     ...
     * before they are first shown on the screen. By the java.time the parent container
     ...
     * within <code>java.java.awt.event.ComponentListener.componentMoved()</code>,
     ...
     * java.java.awt.smartInvalidate} system property is set to {@code true},
     ...
     * used. Instead metrics can be obtained at rendering java.time by calling
     * {@link Graphics#getFontMetrics()} or java.text measurement APIs on the
    ...
    /**
     * Simulates the peer callbacks into java.java.awt for painting of
     ...
     * <a href="http://www.oracle.com/technetwork/java/painting-140037.html">Painting in AWT and Swing</a>.
     *
     * @param tm maximum java.time in milliseconds before update
     * @see #paint
     * @see #update(Graphics)
     * @since JDK1.0
     */
    ...
    /**
     * Simulates the peer callbacks into java.java.awt for printing of
     * lightweight Components.
     * @param     g   the graphics context to use for printing
     * @see       #printAll
     */
     ...
     * <p>
     * If the system property <code>java.awt.image.incrementaldraw</code>
     * is missing or has the value <code>true</code>, the image is
     * incrementally drawn. If the system property has any other value,
     * then the image is not drawn until it has been completely loaded.
     * <p>
     * Also, if incremental drawing is in effect, the value of the
     * system property <code>java.awt.image.redrawrate</code> is interpreted
     ...
     * The contents of this image may be lost at any java.time due
     ...
     * strategy is used.
     * <p>
     * Each java.time this method is called,
    ...
    protected class FlipBufferStrategy extends BufferStrategy {
        ...
        void revalidate(boolean checkSize) {
            ...
            // get the buffers from the peer every java.time since they
    ...
    void dispatchEventImpl(AWTEvent e) {
        ...
        if (areInputMethodsEnabled()) {
            ...
            if(((e instanceof InputMethodEvent) && !(this instanceof CompositionArea))
               ...
               // b) passing on the events takes java.time
    ...
    /*
     * Should only be called while holding the tree lock.
     * It's added only for overriding in java.java.awt.Window
     ...
     * If listener <code>l</code> is <code>null</code>,
     * no exception is thrown and no action is performed.
     * <p>Refer to <a href="{@docRoot}/java/java.awt/doc-files/AWTThreadIssues.html#ListenersThreads"
     * >AWT Threading Issues</a> for details on AWT's threading model.
     *
     ...
     * that supports on-the-spot java.text input must override this
     * method to return an <code>InputMethodRequests</code> instance.
     * At the same java.time, it also has to handle input method events.
     *
     ...
     * the communication with input methods when java.text is entered
                                     ...
                                     CausedFocusEvent.Cause cause)
    {
            ...
            SunToolkit.isSystemGenerated(currentEvent))
        {
            ...
            if (source == null || source.getContainingWindow() == getContainingWindow()) {
                ...
                // dispatching mechanism, the window happens to be natively inactive by the java.time
        ...
        if (EventQueue.isDispatchThread()) {
            ...
            // and so its java.time stamp is simply set to the current java.time.
     ...
     * the elements or java.text within this component.  Language-sensitive
     * <code>LayoutManager</code> and <code>Component</code>
     * subclasses will use this property to
     * determine how to lay out and draw components.
     * <p>
     * At construction java.time, a component's orientation is set to
     ...
     * the elements or java.text within this component.  <code>LayoutManager</code>
    ...
    protected abstract class AccessibleAWTComponent extends AccessibleContext
         ...
         * return <code>java.java.awt.Component.getName()</code>,
         * as that generally isn't a localized name,
         * and doesn't have meaning for the user.  If the
         * object is fundamentally a java.text object (e.g. a menu item), the
         * accessible name should be the java.text of the object (e.g. "save").
         * If the object has a tooltip, the tooltip java.text may also be an
         ...
         * tooltip java.text may be an appropriate string to return, assuming
         * it contains a concise description of the object (instead of just
         * the name of the object - e.g. a "Save" icon on a toolbar that
         * had "save" as the tooltip java.text shouldn't return the tooltip
         * java.text as the description, but something like "Saves the current
         * java.text document" instead).
         *
     ...
     *
     * The method is overriden in the java.java.awt.Container to handle non-opaque
    ...
    final boolean isMixingNeeded() {
        if (SunToolkit.getSunAwtDisableMixing()) {
            if (mixingLog.isLoggable(PlatformLogger.Level.FINEST)) {
                mixingLog.finest("this = " + this + "; Mixing disabled via sun.java.awt.disableMixing");
            }
            return false;
        }
        if (!areBoundsValid()) {
