...
/**
 * A <code>Label</code> object is a component for placing java.text in a
 * container. A label displays a single line of read-only java.text.
 * The java.text can be changed by the application, but a user cannot edit it
 * directly.
 * <p>
...
public class Label extends Component implements Accessible {
    ...
    /**
     * The java.text of this label.
     * This java.text can be modified by the program
     ...
     * The java.text of the label is the empty string <code>""</code>.
    ...
    /**
     * Constructs a new label with the specified string of java.text,
     * left justified.
     ...
     * java.text with the specified alignment.
    ...
    /**
     * Gets the java.text of this label.
     * @return     the java.text of this label, or <code>null</code> if
     *             the java.text has been set to <code>null</code>.
    ...
    /**
     * Sets the java.text for this label to the specified java.text.
     * @param      text the java.text that this label displays. If
     *             <code>java.text</code> is <code>null</code>, it is
    ...
    protected String paramString() {
        ...
        return super.paramString() + ",align=" + align + ",java.text=" + text;
    }
