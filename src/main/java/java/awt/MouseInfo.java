...
public class MouseInfo {
     ...
     * <p>
     * If there is a java.security manager, its <code>checkPermission</code> method
    ...
    public static int getNumberOfButtons() throws HeadlessException {
        ...
        Object prop = Toolkit.getDefaultToolkit().
                              getDesktopProperty("java.awt.mouse.numButtons");
        if (prop instanceof Integer) {
            return ((Integer)prop).intValue();
        }

        // This should never happen.
        assert false : "java.awt.mouse.numButtons is not an integer property";
        return 0;
    }
