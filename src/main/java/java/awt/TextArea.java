 ...
 * that displays java.text. It can be set to allow editing or
 * to be read-only.
 * <p>
 * The following image shows the appearance of a java.text area:
 * <p>
 * <img src="doc-files/TextArea-1.gif" alt="A TextArea showing the word 'Hello!'"
 * style="float:center; margin: 7px 10px;">
 * <p>
 * This java.text area could be created by the following line of code:
 *
 * <hr><blockquote><pre>
...
public class TextArea extends TextComponent {
     ...
     * This parameter will determine the java.text area's height.
     ...
     * This parameter will determine the java.text area's width.
     * Guaranteed to be non-negative.
     *
     * @serial
     * @see  #setColumns(int)
    ...
    private static final String base = "java/text";
    ...
    /**
     * Do not create or display any scrollbars for the java.text area.
     * @since JDK1.1
     */
     ...
     * java.text area. It can be one of four values :
    ...
    /**
     * Constructs a new java.text area with the empty string as java.text.
     * This java.text area is created with scrollbar visibility equal to
     * {@link #SCROLLBARS_BOTH}, so both vertical and horizontal
     * scrollbars will be visible for this java.text area.
    ...
    /**
     * Constructs a new java.text area with the specified java.text.
     * This java.text area is created with scrollbar visibility equal to
     * {@link #SCROLLBARS_BOTH}, so both vertical and horizontal
     * scrollbars will be visible for this java.text area.
    ...
    /**
     * Constructs a new java.text area with the specified number of
     * rows and columns and the empty string as java.text.
     * A column is an approximate average character
     * width that is platform-dependent.  The java.text area is created with
     ...
     * this java.text area being created with scrollbar visibility equal to
     ...
     *             scrollbars are created to view the java.text area
     * @since      JDK1.1
     * @exception HeadlessException if
     *    <code>GraphicsEnvironment.isHeadless</code> returns true
     * @see java.awt.GraphicsEnvironment#isHeadless()
    ...
    /**
     * Inserts the specified java.text at the specified position
     * in this java.text area.
     * <p>Note that passing <code>null</code> or inconsistent
     * parameters is invalid and will result in unspecified
     * behavior.
     *
     * @param      str the non-<code>null</code> java.text to insert
    ...
    /**
     * Appends the given java.text to the java.text area's current java.text.
     * <p>Note that passing <code>null</code> or inconsistent
     * parameters is invalid and will result in unspecified
     * behavior.
     *
     * @param     str the non-<code>null</code> java.text to append
    ...
    /**
     * Replaces java.text between the indicated start and end positions
     * with the specified replacement java.text.  The java.text at the end
     * position will not be replaced.  The java.text at the start
     * position will be replaced (unless the start position is the
     * same as the end position).
     * The java.text position is zero-based.  The inserted substring may be
     * of a different length than the java.text it replaces.
     * <p>Note that passing <code>null</code> or inconsistent
     * parameters is invalid and will result in unspecified
     * behavior.
     *
     * @param     str      the non-<code>null</code> java.text to use as
     *                     the replacement
    ...
    /**
     * Returns the number of rows in the java.text area.
     * @return    the number of rows in the java.text area
     * @see       #setRows(int)
     * @see       #getColumns()
     * @since     JDK1
     */
    ...
    /**
     * Sets the number of rows for this java.text area.
     * @param       rows   the number of rows
     * @see         #getRows()
     * @see         #setColumns(int)
    ...
    /**
     * Returns the number of columns in this java.text area.
     * @return    the number of columns in the java.text area
     * @see       #setColumns(int)
     * @see       #getRows()
     */
    ...
    /**
     * Sets the number of columns for this java.text area.
     * @param       columns   the number of columns
     * @see         #getColumns()
     * @see         #setRows(int)
     * @exception   IllegalArgumentException   if the value
    ...
    /**
     * Determines the preferred size of a java.text area with the specified
     * number of rows and columns.
     * @param     rows   the number of rows
     * @param     columns   the number of columns
     * @return    the preferred dimensions required to display
     *                       the java.text area with the specified
     *                       number of rows and columns
    ...
    /**
     * Determines the preferred size of this java.text area.
     * @return    the preferred dimensions needed for this java.text area
     * @see       java.awt.Component#getPreferredSize
     * @since     JDK1.1
     */
    ...
    /**
     * Determines the minimum size of a java.text area with the specified
     * number of rows and columns.
     * @param     rows   the number of rows
     * @param     columns   the number of columns
    ...
    /**
     * Determines the minimum size of this java.text area.
     * @return    the preferred dimensions needed for this java.text area
     * @see       java.awt.Component#getPreferredSize
     * @since     JDK1.1
     */
     ...
     * <code>null</code>.
     *
     * @return      the parameter string of this java.text area
     */
...
////////////////
     ...
     * this <code>TextArea</code>. For java.text areas, the
     ...
     * Java Accessibility API appropriate to java.text area user-interface elements.
     * @since 1.3
     */
