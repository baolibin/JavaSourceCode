 ...
 * Operations that render horizontal java.text render the ascending
 ...
 * the baseline of a line of java.text, that line is drawn entirely below
 * the java.text, except for any descenders.
 * </ul><p>
...
public abstract class Graphics {
     ...
     * All subsequent java.text operations using this graphics context
    ...
    */
    ...
    /**
     * Draws the java.text given by the specified string, using this
     ...
     * @param       iterator the iterator whose java.text is to be drawn
     * @param       x        the <i>x</i> coordinate.
     * @param       y        the <i>y</i> coordinate.
   ...
   public abstract void drawString(AttributedCharacterIterator iterator,
    ...
    /**
     * Draws the java.text given by the specified character array, using this
     * graphics context's current font and color. The baseline of the
     ...
     * @param x the <i>x</i> coordinate of the baseline of the java.text
     * @param y the <i>y</i> coordinate of the baseline of the java.text
    ...
    /**
     * Draws the java.text given by the specified byte array, using this
     * graphics context's current font and color. The baseline of the
     * first character is at position (<i>x</i>,&nbsp;<i>y</i>) in this
     * graphics context's coordinate system.
     * <p>
     ...
     * or it is java.time to draw another frame of animation,
     ...
     * objects can be created within a short java.time frame.
     * Although the finalization process of the garbage collector
     * also disposes of the same system resources, it is preferable
     * to manually free the associated resources by calling this
     * method rather than to rely on a finalization process which
     * may not run to completion for a long period of java.time.
     * <p>
