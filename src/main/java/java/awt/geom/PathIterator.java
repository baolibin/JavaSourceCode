 ...
 * java.time.  This interface allows these objects to retrieve the path of
 * their boundary a segment at a java.time by using 1st through 3rd order
...
public interface PathIterator {
     ...
     *               = C(n,m) * t^(m) * (1 - t)^(n-m)
     *        C(n,m) = Combinations of n things, taken m at a java.time
     *               = n! / (m! * (n-m)!)
     * </pre>
     */
