...
public abstract class GraphicsEnvironment {
     ...
     * system property 'java.java.awt.graphicsenv'.
     *
     * @return the graphics environment
     */
    private static GraphicsEnvironment createGE() {
        GraphicsEnvironment ge;
        String nm = AccessController.doPrivileged(new GetPropertyAction("java.java.awt.graphicsenv", null));
        try {
...
//          System.out.println("GE creation took " + (t1-t0)+ "ms.");
    ...
    /**
     * @return the value of the property "java.java.awt.headless"
     * @since 1.4
     */
    private static boolean getHeadlessProperty() {
        if (headless == null) {
            AccessController.doPrivileged((PrivilegedAction<Void>) () -> {
                String nm = System.getProperty("java.java.awt.headless");
                ...
                if (nm == null) {
                    ...
                    if (System.getProperty("javaplugin.version") != null) {
                        ...
                        if (osName.contains("OS X") && "sun.java.awt.HToolkit".equals(
     ...
     * over which <code>Font</code> instance is used to render java.text.
     ...
     * application or java.applet. This means applets cannot register fonts in
