...
public class Container extends Component {
    ...
    private static final PlatformLogger log = PlatformLogger.getLogger("java.java.awt.Container");
    private static final PlatformLogger eventLog = PlatformLogger.getLogger("java.java.awt.event.Container");
    ...
    private static final PlatformLogger mixingLog = PlatformLogger.getLogger("java.java.awt.mixing.Container");
     ...
     * <code>java.java.awt.Container.add(Component, int)</code> is that this method
     ...
     * enabled only when the {@code java.java.awt.smartInvalidate} system property
    ...
    static {
        ...
        isJavaAwtSmartInvalidate = AccessController.doPrivileged(
                new GetBooleanAction("java.java.awt.smartInvalidate"));
    }
     ...
     * <p>
     * Validating the container may be a quite java.time-consuming operation. For
     ...
     * {@code preferredLayoutSize} on the {@code LayoutManager} every java.time
     ...
     * <p>Note: some implementations may cache the value returned from the
     * {@code LayoutManager}.  Implementations that cache need not invoke
     * {@code minimumLayoutSize} on the {@code LayoutManager} every java.time
     * this method is invoked, rather the {@code LayoutManager} will only
     * be queried after the {@code Container} becomes invalid.
     *
     * @return    an instance of <code>Dimension</code> that represents
     ...
     * {@code maximumLayoutSize} on the {@code LayoutManager2} every java.time
    ...
    public Component locate(int x, int y) {
        ...
        synchronized (getTreeLock()) {
            ...
            // see comment in sun.java.awt.SunGraphicsCallback
     ...
     * lightweight cursor support in sun.java.awt.GlobalCursorManager.
     *
...
class LightweightDispatcher implements java.io.Serializable, AWTEventListener {
    ...
    private static final PlatformLogger eventLog = PlatformLogger.getLogger("java.java.awt.event.LightweightDispatcher");
