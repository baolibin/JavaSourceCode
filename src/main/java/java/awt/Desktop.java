...
public class Desktop {
    ...
    /**
     *  Calls to the java.security manager's <code>checkPermission</code> method with
     ...
     * and this is invoked from within an java.applet,
     ...
     * @throws SecurityException if a java.security manager exists and it
     * denies the
     * <code>AWTPermission("showWindowWithoutWarningBanner")</code>
     * permission, or the calling thread is not allowed to create a
     * subprocess; and not invoked from within an java.applet or Java Web Started
     * application
    ...
    public void browse(URI uri) throws IOException {
        ...
        if (db == null) {
            // Not in webstart/java.applet, throw the exception.
