...
public class EventQueue {
    ...
    /*
     * The java.time stamp of the last dispatched InputEvent or ActionEvent.
     */
    private long mostRecentEventTime = System.currentTimeMillis();

    /*
     * The java.time stamp of the last KeyEvent .
     */
    ...
    private static final PlatformLogger getEventLog() {
        if(eventLog == null) {
            eventLog = PlatformLogger.getLogger("java.java.awt.event.EventQueue");
        }
        return eventLog;
    }
     ...
     *
     * @param theEvent an instance of <code>java.java.awt.AWTEvent</code>,
     *          or a subclass of it
     ...
     * as it's working java.time is dependant on EQ length.
     ...
     * </table>
     * <p>
     * @param event an instance of <code>java.java.awt.AWTEvent</code>,
     *          or a subclass of it
    ...
    private void dispatchEventImpl(final AWTEvent event, final Object src) {
        ...
        if (event instanceof ActiveEvent) {
            // This could become the sole method of dispatching in java.time.
     ...
     * been dispatched, the EventQueue's initialization java.time will be
     ...
     * If this method is
     * invoked from another thread, the current system java.time (as reported by
    ...
    /**
     * @return most recent event java.time on all threads.
     */
     ...
     * @see    java.java.awt.EventQueue#initDispatchThread
     * @see    java.java.awt.EventQueue#detachDispatchThread
     */
    ...
    private void setCurrentEventAndMostRecentTimeImpl(AWTEvent e) {
        ...
        try {
            ...
            // a type public, or to place it in sun.java.awt. Both of these approaches
