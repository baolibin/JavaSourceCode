 ...
 * <code>TrayIcon</code> can have a tooltip (java.text), an image, a popup
...
public class TrayIcon {
     ...
     *
     * @param image the <code>Image</code> to be used
     * @param tooltip the string to be used as tooltip java.text; if the
     ...
     * disappear after a java.time or if the user clicks on it.  Clicking
     * on the message may trigger an {@code ActionEvent}.
     *
     * <p>Either the caption or the java.text may be <code>null</code>, but an
     * <code>NullPointerException</code> is thrown if both are
     * <code>null</code>.
     *
     * When displayed, the caption or java.text strings may be truncated on
     ...
     * showing a message.
     *
     * @param caption the caption displayed above the java.text, usually in
     * bold; may be <code>null</code>
     * @param text the java.text displayed for the particular message; may be
     * <code>null</code>
     * @param messageType an enum indicating the message type
     * @throws NullPointerException if both <code>caption</code>
     * and <code>java.text</code> are <code>null</code>
     */
    public void displayMessage(String caption, String text, MessageType messageType) {
        if (caption == null && text == null) {
            throw new NullPointerException("displaying the message with both caption and java.text being null");
        }
