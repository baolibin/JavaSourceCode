 ...
 * representing a single paragraph of java.text.  The value returned by the
 ...
 * get the advance of a range of java.text or the line break of a range of java.text
...
public final class TextMeasurer implements Cloneable {
    ...
    */
    ...
    // characters in source java.text
    private char[] fChars;
    ...
    /**
     * Constructs a <code>TextMeasurer</code> from the source java.text.
     * The source java.text should be a single entire paragraph.
     * @param text the source paragraph.  Cannot be null.
     * @param frc the information about a graphics device which is needed
     *       to measure the java.text correctly.  Cannot be null.
     */
    ...
    private int calcLineBreak(final int pos, final float maxAdvance) {
        ...
        if (fComponentLimit < fChars.length) {
            // format more java.text and try again
            //if (haveLayoutWindow) {
            //    outOfWindow++;
            //}
     ...
     * <code>TextMeasurer</code> created from the java.text;  however, it will
     * usually be more efficient to update an existing
     * <code>TextMeasurer</code> than to create a new one from scratch.
     *
     * @param newParagraph the java.text of the paragraph after performing
     * the insertion.  Cannot be null.
     * @param insertPos the position in the java.text where the character was
     ...
     * created from the java.text;  however, it will usually be more efficient
     * to update an existing <code>TextMeasurer</code> than to create a new one
     * from scratch.
     *
     * @param newParagraph the java.text of the paragraph after performing
     * the deletion.  Cannot be null.
     * @param deletePos the position in the java.text where the character was removed.
