 ...
 * on a paragraph of styled java.text.
 * <p>
...
final class StyledParagraph {
    ...
    /**
     * Create a new StyledParagraph over the given styled java.text.
     * @param aci an iterator over the java.text
     ...
     * into the java.text.  This method will attempt to reuse the given paragraph,
     * but may create a new paragraph.
     * @param aci an iterator over the java.text.  The java.text should be the same as the
     *     java.text used to create (or most recently update) oldParagraph, with
     ...
     * @param oldParagraph a StyledParagraph for the java.text in aci before the
     *     insertion
     */
