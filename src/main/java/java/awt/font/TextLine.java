...
final class TextLine {
    ...
    /**
     * Create a TextLine from the java.text.  The Font must be able to
     * display all of the java.text.
     ...
     * the java.text in the given range, with the given attributes.
     */
     ...
     * the java.text.  The components are both logically and visually contiguous.
     */
    public static TextLineComponent[] getComponents(StyledParagraph styledParagraph,
        ...
        do {
            ...
            if (graphicOrFont instanceof GraphicAttribute) {
                ...
                // !!! For now, let's assign runs of java.text with both fonts and graphic attributes
    ...
    /**
     * Create a TextLine from the java.text.  chars is just the java.text in the iterator.
     */
    ...
    /*
     * A utility to get a range of java.text that is both logically and visually
     * contiguous.
   ...
   */
    ...
    // return the sum of the advances of java.text between the logical start and limit
