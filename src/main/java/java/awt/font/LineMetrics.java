...
public abstract class LineMetrics {
    ...
    /**
     * Returns the number of characters (<code>char</code> values) in the java.text whose
     * metrics are encapsulated by this <code>LineMetrics</code>
     * object.
     * @return the number of characters (<code>char</code> values) in the java.text with which
     *         this <code>LineMetrics</code> was created.
     */
    public abstract int getNumChars();

    /**
     * Returns the ascent of the java.text.  The ascent
     * is the distance from the baseline
     * to the ascender line.  The ascent usually represents the
     * the height of the capital letters of the java.text.  Some characters
     * can extend above the ascender line.
     * @return the ascent of the java.text.
     */
    public abstract float getAscent();

    /**
     * Returns the descent of the java.text.  The descent
     * is the distance from the baseline
     ...
     * line.
     * @return the descent of the java.text.
     */
    public abstract float getDescent();

    /**
     * Returns the leading of the java.text. The
     * leading is the recommended
     * distance from the bottom of the descender line to the
     * top of the next line.
     * @return the leading of the java.text.
     */
    public abstract float getLeading();

    /**
     * Returns the height of the java.text.  The
     * height is equal to the sum of the ascent, the
     * descent and the leading.
     * @return the height of the java.text.
     */
    public abstract float getHeight();

    /**
     * Returns the baseline index of the java.text.
     * The index is one of
     ...
     * @return the baseline of the java.text.
     */
    public abstract int getBaselineIndex();

    /**
     * Returns the baseline offsets of the java.text,
     * relative to the baseline of the java.text.  The
     ...
     * is usually positive.
     * @return the baseline offsets of the java.text.
     */
