...
*   information needed to correctly measure java.text.  The measurement of java.text
...
public class FontRenderContext {
     ...
     * to pixels in this <code>FontRenderContext</code>.  If null, an
     * identity transform is used.
     * @param aaHint - one of the java.text antialiasing rendering hint values
     * defined in {@link java.awt.RenderingHints java.java.awt.RenderingHints}.
     ...
     * dependent.
     * @param fmHint - one of the java.text fractional rendering hint values defined
     * in {@link java.awt.RenderingHints java.java.awt.RenderingHints}.
     ...
     * measures java.text in a transformed render context.
    ...
    *   @return    <code>true</code>, if java.text is anti-aliased in this
    ...
    */
    ...
    /**
    * Returns a boolean which whether java.text fractional metrics mode
    ...
    */
    ...
    /**
     * Return the java.text anti-aliasing rendering mode hint used in this
     * <code>FontRenderContext</code>.
     * This will be one of the java.text antialiasing rendering hint values
     * defined in {@link java.awt.RenderingHints java.java.awt.RenderingHints}.
     * @return  java.text anti-aliasing rendering mode hint used in this
     * <code>FontRenderContext</code>.
     * @since 1.6
     */
    ...
    /**
     * Return the java.text fractional metrics rendering mode hint used in this
     * <code>FontRenderContext</code>.
     * This will be one of the java.text fractional metrics rendering hint values
     * defined in {@link java.awt.RenderingHints java.java.awt.RenderingHints}.
     * @return the java.text fractional metrics rendering mode hint used in this
     * <code>FontRenderContext</code>.
     * @since 1.6
