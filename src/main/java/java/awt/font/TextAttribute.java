 ...
 * attribute values used for java.text rendering.
 * <p>
 ...
 * and other classes handling java.text attributes. Other constants defined
 * in this class can be used as attribute values.
 * <p>
 * For each java.text attribute, the documentation provides:
 * <UL>
 ...
 * <td valign="TOP">none</td>
 * <td valign="TOP">null (draw java.text using font glyphs)</td>
 * </tr>
 * <tr style="background-color:#eeeeff">
...
public final class TextAttribute extends Attribute {
     ...
     * and the rendering system might not render java.text at these sizes.
     ...
     * shifted.  The java.text and the baseline are transformed together so
     * that the java.text follows the new baseline.  For example, with java.text
     ...
     * So, for example, with other things being equal, java.text rendered
     * with a rotated TRANSFORM and an unrotated TRANSFORM will measure as
     * having the same ascent, descent, and advance.</p>
     *
     * <p>In styled java.text, the baselines for each such run are aligned
     * one after the other to potentially create a non-linear baseline
     * for the entire run of java.text. For more information, see {@link
    ...
    /**
     * Attribute key used to provide the font to use to render java.text.
     ...
     * other component embedded in a line of java.text.  It is required for
     ...
     * bounds of the java.text; the actual Font values are ignored.
     *
    ...
    //
    // Adornments added to java.text.
    //

    /**
     * Attribute key for the paint used to render the java.text.  Values are
     * instances of <b><code>Paint</code></b>.  The default value is
     * null, indicating that the <code>Paint</code> set on the
     * <code>Graphics2D</code> at the java.time of rendering is used.
     *
     ...
     * the java.text.  Values are instances of <b><code>Paint</code></b>.
     * The default value is null, indicating that the background
     * should not be rendered.
     *
     * <p>The logical bounds of the java.text will be filled using this
     * <code>Paint</code>, and then the java.text will be rendered on top
     * of it (but see {@link #SWAP_COLORS}).
     *
     * <p>The visual bounds of the java.text is extended to include the
    ...
    //
    // Attributes use to control layout of java.text on a line.
    //
     ...
     * the java.text in the paragraph.
     *
     * <p><em>Note:</em> This attribute should have the same value for
     * all the java.text in a paragraph, otherwise the behavior is
     * undetermined.
     *
     * @see java.text.Bidi
     */
    ...
    /**
     * Attribute key for the embedding level of the java.text.  Values are
     * instances of <b><code>Integer</code></b>.  The default value is
     ...
     * disregarded, and runs of java.text where this attribute is not
     ...
     * java.text in a paragraph, otherwise the behavior is undetermined.
     *
     ...
     * before rendering.
     *
     * <p>If adjacent runs of java.text with the same
     ...
     *
     * <p>Input method highlights are used while java.text is being
     * composed by an input method. Text editing components should
     * retain them even if they generally only deal with unstyled
     * java.text, and make them available to the drawing routines.
     *
     * @see java.awt.Font
     ...
     * (resolved) background so that the java.text will be visible.
     *
     * @see #FOREGROUND
     * @see #BACKGROUND
     */
     ...
     * numeric shaping.
     *
     * <p>When a numeric shaper is defined, the java.text is first
     * processed by the shaper before any other analysis of the java.text
     * is performed.
     *
     * <p><em>Note:</em> This should have the same value for all the
     * java.text in the paragraph, otherwise the behavior is undetermined.
     *
     * @see NumericShaper
     * @since 1.4
     */
