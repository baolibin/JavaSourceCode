...
/**
 * The <code>LineBreakMeasurer</code> class allows styled java.text to be
 * broken into lines (or segments) that fit within a particular visual
 * advance.  This is useful for clients who wish to display a paragraph of
 * java.text that fits within a specific width, called the <b>wrapping
 * width</b>.
 * <p>
 * <code>LineBreakMeasurer</code> is constructed with an iterator over
 * styled java.text.  The iterator's range should be a single paragraph in the
 * java.text.
 * <code>LineBreakMeasurer</code> maintains a position in the java.text for the
 * start of the next java.text segment.  Initially, this position is the
 * start of java.text.  Paragraphs are assigned an overall direction (either
 ...
 * <p>
 * Segments of java.text are obtained by calling the method
 * <code>nextLayout</code>, which returns a {@link TextLayout}
 * representing the java.text that fits within the wrapping width.
 ...
 * at the limit provided (or before, if the java.text between the current
 * position and the limit won't fit entirely within the  wrapping
 * width).
 * <p>
 * Clients who are laying out tab-delimited java.text need a slightly
 ...
 * <p>
 * In general, if the java.text used to construct the
 ...
 * function properly, but it won't be aware of the java.text change.)
 * Nevertheless, if the java.text change is the insertion or deletion of a
 ...
 * Clients who modify java.text based on user typing should take advantage
 * of these methods.
 * <p>
 ...
 * </blockquote>
 * <p>
 * Rendering java.text with tabs.  For simplicity, the overall java.text
 ...
 *     // the java.text.  For convenience, the last entry is tabLocations
 *     // is the offset of the last character in the java.text.
 *
...
public final class LineBreakMeasurer {
    ...
    /**
     * Constructs a <code>LineBreakMeasurer</code> for the specified java.text.
     *
     * @param text the java.text for which this <code>LineBreakMeasurer</code>
     *       produces <code>TextLayout</code> objects; the java.text must contain
     *       at least one character; if the java.text available through
     ...
     *       needed to measure the java.text correctly;
     *       java.text measurements can vary slightly depending on the
     ...
     *       parameter does not specify a translation between the
     *       <code>LineBreakMeasurer</code> and user space
     * @throws IllegalArgumentException if the java.text has less than one character
     * @see LineBreakMeasurer#insertChar
     * @see LineBreakMeasurer#deleteChar
     */
     ...
     *    the java.text in the next layout
     * @return an offset in the java.text representing the limit of the
     ...
     *    in the next layout, even if the java.text after the limit would fit
     ...
     *    for the java.text in the next layout
     * @param offsetLimit the first character that can not be
     *    included in the next layout, even if the java.text after the limit
     ...
     *    of the java.text used by this <code>LineBreakMeasurer</code>,
     ...
     *    java.text used to construct this <code>LineBreakMeasurer</code> (or in
     *    the java.text most recently passed to <code>insertChar</code>
     ...
     * character is inserted into the java.text, and sets the current
     * position to the beginning of the paragraph.
     *
     * @param newParagraph the java.text after the insertion
     * @param insertPos the position in the java.text at which the character
     *    is inserted
    ...
    /**
     * Updates this <code>LineBreakMeasurer</code> after a single
     * character is deleted from the java.text, and sets the current
     * position to the beginning of the paragraph.
     * @param newParagraph the java.text after the deletion
     * @param deletePos the position in the java.text at which the character
     *    is deleted
