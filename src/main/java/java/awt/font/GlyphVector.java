 ...
 * <p>
 * In a java.text processing application that can cache intermediate
 * representations of java.text, creation and subsequent caching of a
...
public abstract class GlyphVector implements Cloneable {
    ...
    //
    // methods associated with creation-java.time state
    //
