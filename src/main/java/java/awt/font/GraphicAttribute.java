 ...
 * in java.text. Clients subclass this class to implement their own char
 * replacement graphics.  Clients wishing to embed shapes and images in
 * java.text need not subclass this class.  Instead, clients can use the
...
public abstract class GraphicAttribute {
     ...
     * {@link TextLayout} is requested to return the outline of the java.text.
