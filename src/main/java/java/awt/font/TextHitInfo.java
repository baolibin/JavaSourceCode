 ...
 * java.text model, and a <b>bias</b>, or "side," of the character.  Biases are
 ...
 * insertion positions within java.text.
 * <p>
 * For example, consider the java.text "abc".  TextHitInfo.trailing(1)
 * corresponds to the right side of the 'b' in the java.text.
 * <p>
 ...
 * new java.text is inserted into the java.text model.  The insertion offset is equal
 ...
 * Converting a graphical point to an insertion point within a java.text
 * model
 * <blockquote><pre>
 * TextLayout layout = ...;
