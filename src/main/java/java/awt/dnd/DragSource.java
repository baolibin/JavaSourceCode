 ...
 * current at any one java.time, and shall
 * reject any further startDrag() requests
 * by throwing an <code>IllegalDnDOperationException</code>
 * until such java.time as the extant operation is complete.
 * <P>
 ...
 * a <code>java.java.awt.dnd.InvalidDnDOperationException</code>
...
public class DragSource implements Serializable {
     ...
     * <p>
     * If the system property <code>java.awt.dnd.drag.threshold</code> is set to
     ...
     * <code>java.java.awt.Toolkit.getDesktopProperty("DnD.gestureMotionThreshold")</code>.
     *
    ...
    public static int getDragThreshold() {
        int ts = AccessController.doPrivileged(
                new GetIntegerAction("java.awt.dnd.drag.threshold", 0)).intValue();
        if (ts > 0) {
            return ts;
        } else {
