...
public class Frame extends Window implements MenuContainer {
    ...
    */
     ...
     * at any java.time.  <code>title</code> can be null and if
     ...
     * This property can be changed at any java.time.
     ...
     *
     * @serial
     * @see java.java.awt.Window#ownedWindowList
     */
     ...
     * If called from an java.applet, the array includes only the {@code Frame}s
