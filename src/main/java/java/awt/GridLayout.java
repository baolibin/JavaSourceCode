 ...
 * For example, the following is an java.applet that lays out six buttons
...
public class GridLayout implements LayoutManager, java.io.Serializable {
     ...
     * between columns.  They can be changed at any java.time.
     ...
     * between rows.  They can be changed at any java.time.
     * This should be a non negative integer.
     *
     * @serial
     * @see #getVgap()
     ...
     * of rows can be changed at any java.time.
     ...
     * of columns can be changed at any java.time.
     * This should be a non negative integer, where '0' means
