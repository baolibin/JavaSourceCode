 ...
 * and java.text layout.  This is the fundamental class for rendering
 * 2-dimensional shapes, java.text and images on the  Java(tm) platform.
 * <p>
 ...
 * concrete device of unknown physical resolution at a later java.time.  Since
 ...
 * transformations might need to be applied at playback java.time if the
...
public abstract class Graphics2D extends Graphics {
    ...
    /**
     * Renders the java.text of the specified <code>String</code>, using the
     * current java.text attribute state in the <code>Graphics2D</code> context.
     * The baseline of the
    ...
    /**
     * Renders the java.text specified by the specified <code>String</code>,
     * using the current java.text attribute state in the <code>Graphics2D</code> context.
    ...
    /**
     * Renders the java.text of the specified iterator applying its attributes
     ...
     * on the baseline.
     * @param iterator the iterator whose java.text is to be rendered
     * @param x the x coordinate where the iterator's java.text is to be
     * rendered
     * @param y the y coordinate where the iterator's java.text is to be
     * rendered
    ...
    /**
     * Renders the java.text of the specified
     ...
     *         used to render to the screen and a java.security manager
     ...
     * java.time/quality trade-off in the rendering process.  Refer to the
     ...
     * overall java.time/quality trade-off in the rendering process.
     ...
     * include controls for rendering quality and overall java.time/quality
