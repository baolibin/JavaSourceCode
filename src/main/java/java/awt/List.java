 ...
 * scrolling list of java.text items. The list can be set up so that
 ...
 * at a java.time, since the second argument when creating the new scrolling
...
public class List extends Component implements ItemSelectable, Accessible {
     ...
     * select more than one item in a list at one java.time.
     ...
     * the list. If it is <code>false</code>, only one item at a java.time
     * can be selected.
     * @param       rows   the number of items to show.
     * @param       multipleMode   if <code>true</code>,
     *                     then multiple selections are allowed;
     *                     otherwise, only one item can be selected at a java.time.
     * @exception HeadlessException if GraphicsEnvironment.isHeadless()
     * returns true.
     * @see java.awt.GraphicsEnvironment#isHeadless
     */
