...
public interface SQLXML
{
   ...
   * when the designated column of the ResultSet has a type java.java.sql.Types of SQLXML.
   * <p>
  ...
  /**
   * Retrieves the XML value designated by this SQLXML instance as a java.java.io.Reader object.
