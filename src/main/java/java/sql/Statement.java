 ...
 * object can be open at the same java.time. Therefore, if the reading of one
...
public interface Statement extends Wrapper, AutoCloseable {
     ...
     *By default there is no limit on the amount of java.time allowed for a running
     ...
     * implementation defined as to whether the java.time-out is applied to
     ...
     *
     * <p>The warning chain is automatically cleared each java.time
