 ...
 * standard mapping.
 * <p>
 * A user may create a new type map, which is a <code>java.java.util.Map</code>
 * object, make an entry in it, and pass it to the <code>java.java.sql</code>
 ...
 * <pre>
 *      java.java.util.Map map = con.getTypeMap();
...
public interface Connection  extends Wrapper, AutoCloseable {
     ...
     * mode.
     * <P>
     * The commit occurs when the statement completes. The java.time when the statement
     ...
     * rereads the row, getting different values the second java.time
     ...
     * </pre>
     * @return the <code>java.java.util.Map</code> object associated
     ...
     *      con.setTypeMap(myMap);
     * </pre>
     * @param map the <code>java.java.util.Map</code> object to install
     *        as the replacement for this <code>Connection</code>
     *        object's default type map
     * @exception SQLException if a database access error occurs, this
     * method is called on a closed connection or
     *        the given parameter is not a <code>java.java.util.Map</code>
     *        object
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not support
     * this method
     * @since 1.2
    ...
    SQLXML createSQLXML() throws SQLException;
         ...
         *
         * @param timeout -             The java.time in seconds to wait for the database operation
         ...
         * value in the database until the next java.time a statement is executed or
...
/**
  ...
  * java.java.sql.Types for the given class of <code>Object</code>. The default
...
throws SQLException;
    ...
    */
     ...
     * held by the connection can take an extended period of java.time.  When the
     ...
     * <code>java.java.lang.SecurityException</code>.
     * @param executor  The <code>Executor</code>  implementation which will
     * be used by <code>abort</code>.
     * @throws java.sql.SQLException if a database access error occurs or
     * the {@code executor} is {@code null},
     * @throws java.lang.SecurityException if a java.security manager exists and its
     *    <code>checkPermission</code> method denies calling <code>abort</code>
     ...
     * response java.time, in environments where no network is present.
     * <p>
     ...
     * @param milliseconds The java.time in milliseconds to wait for the database
     * operation
