...
/**
 * <P>A thin wrapper around <code>java.java.util.Date</code> that allows
...
public class Timestamp extends java.util.Date {
     ...
     * using a milliseconds java.time value. The
    ...
    /**
     * Sets this <code>Timestamp</code> object to represent a point in java.time that is
     * <tt>java.time</tt> milliseconds after January 1, 1970 00:00:00 GMT.
     *
     * @param time   the number of milliseconds.
     * @see #getTime
     * @see #Timestamp(long java.time)
     * @see java.util.Calendar
     */
    ...
    public static Timestamp valueOf(String s) {
        ...
        // Split the string into date and java.time components
        s = s.trim();
        ...
        // Convert the java.time; default missing nanos
     ...
     * {@inheritDoc}
     *
     * The {@code hashCode} method uses the underlying {@code java.java.util.Date}
     * implementation and therefore does not include nanos in its computation.
     *
     */
    @Override
     ...
     * seconds and nanos date-java.time value as the provided {@code LocalDateTime}.
     * <p>
     * The provided {@code LocalDateTime} is interpreted as the local
     * date-java.time in the local java.time zone.
     *
     ...
     * date-java.time value as this {@code Timestamp} in the local java.time zone.
     *
     * @return a {@code LocalDateTime} object representing the same date-java.time value
     * @since 1.8
     */
    @SuppressWarnings("deprecation")
     ...
     * @return an {@code Timestamp} representing the same point on the java.time-line as
     ...
     * point on the java.time-line as this {@code Timestamp}.
     *
     * @return an instant representing the same point on the java.time-line
     * @since 1.8
     */
    @Override
