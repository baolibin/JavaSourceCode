 ...
 * millisecond values wrapped by a <code>java.java.sql.Date</code> instance
 * must be 'normalized' by setting the
 * hours, minutes, seconds, and milliseconds to zero in the particular
 * java.time zone with which the instance is associated.
 */
public class Date extends java.util.Date {
     ...
     * java.time value.  If the given milliseconds value contains java.time
     * information, the driver will set the java.time components to the
     * java.time in the default java.time zone (the java.time zone of the Java virtual
    ...
    public Date(long date) {
        // If the millisecond date value contains java.time info, mask it out.
        super(date);
     ...
     * using the given milliseconds java.time value.
     * If the given milliseconds value contains java.time information,
     * the driver will set the java.time components to the
     * java.time in the default java.time zone (the java.time zone of the Java virtual
     * machine running the application) that corresponds to zero GMT.
     *
     * @param date milliseconds since January 1, 1970, 00:00:00 GMT not
     ...
     * @return a <code>java.java.sql.Date</code> object representing the
     *         given date
    ...
    // Override all the java.time operations inherited from java.java.util.Date;

   /**
    * This method is deprecated and should not be used because SQL Date
    * values do not have a java.time component.
    *
    * @deprecated
    ...
    */
     ...
     * date value as this {@code Date} in local java.time zone
     *
    ...
    * not be used because SQL {@code Date} values do not have a java.time
    * component.
    *
