...
public interface CallableStatement extends PreparedStatement {
     ...
     * should be <code>java.java.sql.Types.OTHER</code>.  The method
     * {@link #getObject} retrieves the value.
     *
     * @param parameterIndex the first parameter is 1, the second is 2,
     *        and so on
     * @param sqlType the JDBC type code defined by <code>java.java.sql.Types</code>.
     ...
     * @param parameterIndex the first parameter is 1, the second is 2,
     * and so on
     * @param sqlType the SQL type code defined by <code>java.java.sql.Types</code>.
     ...
     * <code>java.java.math.BigDecimal</code> object with <i>scale</i> digits to
     ...
     * <code>java.java.sql.Date</code> object.
     * @param parameterIndex the first parameter is 1, the second is 2,
     *        and so on
     * @return the parameter value.  If the value is SQL <code>NULL</code>, the result
     *         is <code>null</code>.
     ...
     * <code>java.java.sql.Time</code> object.
     *
     * @param parameterIndex the first parameter is 1, the second is 2,
     *        and so on
     * @return the parameter value.  If the value is SQL <code>NULL</code>, the result
     ...
     * <code>java.java.sql.Timestamp</code> object.
     *
     * @param parameterIndex the first parameter is 1, the second is 2,
     *        and so on
     * @return the parameter value.  If the value is SQL <code>NULL</code>, the result
     ...
     * type as <code>java.java.sql.Types.OTHER</code>, this method can be used
     * to read database-specific abstract data types.
     *
     * @param parameterIndex the first parameter is 1, the second is 2,
     *        and so on
     * @return A <code>java.java.lang.Object</code> holding the OUT parameter value
     * @exception SQLException if the parameterIndex is not valid;
     * if a database access error occurs or
     * this method is called on a closed <code>CallableStatement</code>
     * @see Types
    ...
    /**
     * Retrieves the value of the designated JDBC <code>NUMERIC</code> parameter as a
     * <code>java.java.math.BigDecimal</code> object with as many digits to the
     ...
     * JDBC type as <code>java.java.sql.Types.OTHER</code>, this method can
     ...
     * <code>java.java.sql.Clob</code> object in the Java programming language.
    ...
    /**
     * Retrieves the value of the designated JDBC <code>DATE</code> parameter as a
     * <code>java.java.sql.Date</code> object, using
    ...
    /**
     * Retrieves the value of the designated JDBC <code>TIME</code> parameter as a
     * <code>java.java.sql.Time</code> object, using
     * the given <code>Calendar</code> object
     * to construct the java.time.
     * With a <code>Calendar</code> object, the driver
     * can calculate the java.time taking into account a custom timezone and locale.
     * If no <code>Calendar</code> object is specified, the driver uses the
     * default timezone and locale.
     *
     * @param parameterIndex the first parameter is 1, the second is 2,
    ...
    /**
     * Retrieves the value of the designated JDBC <code>TIMESTAMP</code> parameter as a
     * <code>java.java.sql.Timestamp</code> object, using
  ...
  //--------------------------JDBC 3.0-----------------------------
     ...
     *
     * @param parameterName the name of the parameter
     * @param sqlType SQL type code defined by <code>java.java.sql.Types</code>.
     * @param scale the desired number of digits to the right of the
     * decimal point.  It must be greater than or equal to zero.
     * @exception SQLException if parameterName does not correspond to a named
     * parameter; if a database access error occurs or
     ...
     * <code>java.java.net.URL</code> object.
     *
     * @param parameterIndex the first parameter is 1, the second is 2,...
     * @return a <code>java.java.net.URL</code> object that represents the
    ...
    /**
     * Sets the designated parameter to the given <code>java.java.net.URL</code> object.
     ...
     *
     * @param parameterName the name of the parameter
     * @param sqlType the SQL type code defined in <code>java.java.sql.Types</code>
     * @exception SQLException if parameterName does not correspond to a named
     * parameter; if a database access error occurs or
     * this method is called on a closed <code>CallableStatement</code>
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not support
     ...
     * <code>java.java.math.BigDecimal</code> value.
    ...
    /**
     * Sets the designated parameter to the given <code>java.java.sql.Date</code> value
     * using the default java.time zone of the virtual machine that is running
     * the application.
     * The driver converts this
    ...
    /**
     * Sets the designated parameter to the given <code>java.java.sql.Time</code> value.
     * The driver converts this
    ...
    /**
     * Sets the designated parameter to the given <code>java.java.sql.Timestamp</code> value.
     * The driver
     ...
     * <code>java.java.io.InputStream</code>. Data will be read from the stream
     ...
     * parameter, it may be more practical to send it via a
     * <code>java.java.io.InputStream</code> object. The data will be read from the stream
     ...
     *  <code>Struct</code>, <code>java.java.net.URL</code>,
     ...
     * @param targetSqlType the SQL type (as defined in java.java.sql.Types) to be
     * sent to the database. The scale argument may further qualify this type.
     * @param scale for java.java.sql.Types.DECIMAL or java.java.sql.Types.NUMERIC types,
     ...
     * parameter, it may be more practical to send it via a
     * <code>java.java.io.Reader</code> object. The data will be read from the stream
     * as needed until end-of-file is reached.  The JDBC driver will
     ...
     *
     * @param parameterName the name of the parameter
     * @param reader the <code>java.java.io.Reader</code> object that
     ...
     * which the driver then sends to the database.  With a
     * a <code>Calendar</code> object, the driver can calculate the java.time
     * taking into account a custom timezone.  If no
     * <code>Calendar</code> object is specified, the driver uses the default
     * timezone, which is that of the virtual machine running the application.
     *
     ...
     *
     * @param parameterName the name of the parameter
     * @param sqlType a value from <code>java.java.sql.Types</code>
     ...
     *
     * @param parameterName the name of the parameter
     * @return the parameter value as a <code>java.java.net.URL</code> object in the
     * Java programming language.  If the value was SQL <code>NULL</code>, the
     * value <code>null</code> is returned.
     * @exception SQLException if parameterName does not correspond to a named
     * parameter; if a database access error occurs,
     ...
     * <code>java.java.sql.RowId</code> object.
     *
     * @param parameterIndex the first parameter is 1, the second is 2,...
    ...
    RowId getRowId(String parameterName) throws SQLException;
     ...
     /**
     * Sets the designated parameter to the given <code>java.java.sql.RowId</code> object. The
    ...
    void setNCharacterStream(String parameterName, Reader value, long length)
     ...
     /**
     * Sets the designated parameter to a <code>java.java.sql.NClob</code> object. The object
     * implements the <code>java.java.sql.NClob</code> interface. This <code>NClob</code>
     ...
     * <code>java.java.sql.NClob</code> object in the Java programming language.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, and
     * so on
    ...
    /**
     * Sets the designated parameter to the given <code>java.java.sql.SQLXML</code> object. The driver converts this to an
   ...
   *  <code>Writer</code> or <code>OutputStream</code> has not been closed for the <code>SQLXML</code> object
     ...
     * <code>java.java.sql.SQLXML</code> object in the Java programming language.
     ...
     * <code>java.java.io.Reader</code> object in the Java programming language.
     * It is intended for use when
     * accessing  <code>NCHAR</code>,<code>NVARCHAR</code>
     * and <code>LONGNVARCHAR</code> parameters.
     *
     * @return a <code>java.java.io.Reader</code> object that contains the parameter
    ...
    /**
     * Sets the designated parameter to the given <code>java.java.sql.Blob</code> object.
    ...
    /**
     * Sets the designated parameter to the given <code>java.java.sql.Clob</code> object.
    ...
    */
     ...
     * When a very large binary value is input to a <code>LONGVARBINARY</code>
     * parameter, it may be more practical to send it via a
     * <code>java.java.io.InputStream</code> object. The data will be read from the
     ...
     *
     * @param parameterName the name of the parameter
     * @param reader the <code>java.java.io.Reader</code> object that contains the
     *        Unicode data
     * @exception SQLException if parameterName does not correspond to a named
     * parameter; if a database access error occurs or
     * this method is called on a closed <code>CallableStatement</code>
  ...
  /**
     ...
     *  {@code Struct}, {@code java.java.net.URL},
     ...
     * sent to the database. The scale argument may further qualify this type.
     * @param scaleOrLength for {@code java.java.sql.JDBCType.DECIMAL}
     *          or {@code java.java.sql.JDBCType.NUMERIC types},
