...
public interface DatabaseMetaData extends Wrapper {
    ...
    /**
     * Retrieves a comma-separated list of java.math functions available with
     * this database.  These are the Open /Open CLI java.math function names used in
     * the JDBC function escape clause.
     *
     * @return the list of java.math functions supported by this database
     * @exception SQLException if a database access error occurs
     */
    ...
    /**
     * Retrieves a comma-separated list of the java.time and date functions available
     * with this database.
     *
     * @return the list of java.time and date functions supported by this database
     * @exception SQLException if a database access error occurs
     */
     ...
     * in <code>java.java.sql.Types</code>.
     *
     * @return <code>true</code> if so; <code>false</code> otherwise
     * @exception SQLException if a database access error occurs
     */
     ...
     *        the class <code>java.java.sql.Types</code>
     ...
     *
     * @return the maximum number of active connections possible at one java.time;
     *      a result of zero means that there is no limit or the limit
     *      is not known
     * @exception SQLException if a database access error occurs
     */
     ...
     * that can be open at the same java.time.
     *
     * @return the maximum number of statements that can be open at one java.time;
     *      a result of zero means that there is no limit or the limit
     *      is not known
     * @exception SQLException if a database access error occurs
     */
     ...
     * possible values are defined in <code>java.java.sql.Connection</code>.
     *
     ...
     *         <code>java.java.sql.Connection</code>
     * @return <code>true</code> if so; <code>false</code> otherwise
     * @exception SQLException if a database access error occurs
     * @see Connection
     */
     ...
     *      </UL>
     *  <LI><B>DATA_TYPE</B> int {@code =>} SQL type from java.java.sql.Types
    ...
    * returned by the method <code>getProcedureColumns</code>.
     ...
     *      Ref type, SQL type from java.java.sql.Types (<code>null</code> if DATA_TYPE
     ...
     *      </UL>
     *  <LI><B>COLUMN_NAME</B> String {@code =>} column name
     *  <LI><B>DATA_TYPE</B> int {@code =>} SQL data type from java.java.sql.Types
     *  <LI><B>TYPE_NAME</B> String {@code =>} Data source dependent type name,
     *  for a UDT the type name is fully qualified
     ...
     *  <LI><B>COLUMN_NAME</B> String {@code =>} column name
     *  <LI><B>DATA_TYPE</B> int {@code =>} SQL data type from <code>java.java.sql.Types</code>
     *  <LI><B>TYPE_NAME</B> String {@code =>} Data source-dependent type name
     *  <LI><B>COLUMN_SIZE</B> int {@code =>} precision
     ...
     *
     * @param type defined in <code>java.java.sql.ResultSet</code>
     * @return <code>true</code> if so; <code>false</code> otherwise
     * @exception SQLException if a database access error occurs
     * @see Connection
     * @since 1.2
     ...
     *
     * @param type defined in <code>java.java.sql.ResultSet</code>
     * @param concurrency type defined in <code>java.java.sql.ResultSet</code>
     * @return <code>true</code> if so; <code>false</code> otherwise
     * @exception SQLException if a database access error occurs
     * @see Connection
     * @since 1.2
     ...
     *  <LI><B>DATA_TYPE</B> int {@code =>} type value defined in java.java.sql.Types.
     ...
     *     type as defined in java.java.sql.Types (<code>null</code> if DATA_TYPE is not
     ...
     *  <LI><B>DATA_TYPE</B> int {@code =>} attribute type SQL type from java.java.sql.Types
