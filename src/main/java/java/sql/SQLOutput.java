 ...
 */
 ...
 public interface SQLOutput {
  ...
  /**
   * Writes the next attribute to the stream as a java.java.math.BigDecimal object.
   * Writes the next attribute to the stream as a <code>String</code>
   * in the Java programming language.
   *
   * @param x the value to pass to the database
  ...
  /**
   * Writes the next attribute to the stream as a java.java.sql.Date object.
   * Writes the next attribute to the stream as a <code>java.java.sql.Date</code> object
   * in the Java programming language.
   *
   * @param x the value to pass to the database
   * @exception SQLException if a database access error occurs
  ...
  /**
   * Writes the next attribute to the stream as a java.java.sql.Time object.
   * Writes the next attribute to the stream as a <code>java.java.sql.Date</code> object
   * in the Java programming language.
   *
   * @param x the value to pass to the database
  ...
  /**
   * Writes the next attribute to the stream as a java.java.sql.Timestamp object.
   * Writes the next attribute to the stream as a <code>java.java.sql.Date</code> object
   * in the Java programming language.
   *
   * @param x the value to pass to the database
  ...
  void writeArray(Array x) throws SQLException;
      ...
      *
      * @param x a <code>java.java.net.URL</code> object representing the data
