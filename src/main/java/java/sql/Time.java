...
/**
 * <P>A thin wrapper around the <code>java.java.util.Date</code> class that allows the JDBC
 * API to identify this as an SQL <code>TIME</code> value. The <code>Time</code>
 * class adds formatting and
 * parsing operations to support the JDBC escape syntax for java.time
 * values.
...
public class Time extends java.util.Date {
     ...
     * <code>java.java.lang.IllegalArgumentException</code>.
     * <P>
    ...
    /**
     * Constructs a <code>Time</code> object using a milliseconds java.time value.
     *
    ...
    /**
     * Sets a <code>Time</code> object using a milliseconds java.time value.
     *
     * @param time milliseconds since January 1, 1970, 00:00:00 GMT;
     *             a negative number is milliseconds before
     *               January 1, 1970, 00:00:00 GMT
    ...
    /**
     * Converts a string in JDBC java.time escape format to a <code>Time</code> value.
     *
     * @param s java.time in format "hh:mm:ss"
    ...
    /**
     * Formats a java.time in JDBC java.time escape format.
     *
    ...
    // Override all the date operations inherited from java.java.util.Date;
    ...
    */
     ...
     * with the same hour, minute and second java.time value as the given
     * {@code LocalTime}.
     *
     * @param time a {@code LocalTime} to convert
     * @return a {@code Time} object
     * @exception NullPointerException if {@code java.time} is null
     * @since 1.8
     */
    @SuppressWarnings("deprecation")
     ...
     * hour, minute, and second java.time value as this {@code Time}.
     *
     * @return a {@code LocalTime} object representing the same java.time value
     * @since 1.8
     */
    @SuppressWarnings("deprecation")
