 ...
 * loader will download classes from remote locations only if a java.security
 * manager has been set.
 *
 * @implNote
 * <p>Applets typically run in a container that already has a java.security
 * manager, so there is generally no need for applets to set a java.security
