 ...
 *      <code>java.java.rmi.MarshalledObject</code>)</ul><p>
 *
 ...
 * java.security manager.  If your application requires specific properties
 ...
 * requires the use of a java.security manager other than
 * {@link SecurityManager}, in the
 * ActivativationGroupDescriptor properties list you can set
 * <code>java.java.security.manager</code> property to the name of the java.security
        ...
        implements ActivationInstantiator
{
     ...
     * <code>java.java.rmi.server.UnicastRemoteObject</code>.
     *
     ...
     * activation group, a java.security manager must be set for that
     * group.  Otherwise objects cannot be activated in the group.
     * {@link SecurityManager} is set by default.
     *
     * <p>If a java.security manager is already set in the group VM, this
     * method first calls the java.security manager's
     * <code>checkSetFactory</code> method.  This could result in a
     * <code>SecurityException</code>. If your application needs to
     * set a different java.security manager, you must ensure that the
     * policy file specified by the group's
     * <code>ActivationGroupDesc</code> grants the group the necessary
     * permissions to set a new java.security manager.  (Note: This will be
     * necessary if your group downloads and sets a java.security manager).
     *
     ...
     * (Note: The default implementation of the java.security manager
     ...
     * creation, if java.security manager is not set, or if the group
     ...
     * "java.java.rmi.activation.ActivationSystem" in the Activator's
     ...
     * by setting the property <code>java.java.rmi.activation.port</code>.
     *
     * <p>If there is a java.security manager, this method first
     * calls the java.security manager's <code>checkSetFactory</code> method.
     ...
     * looking up the name "java.java.rmi.activation.ActivationSystem" in
     ...
     * <code>java.java.rmi.activation.port</code>.
     *
        ...
        if (currSystem == null) {
            try {
                int port = AccessController.doPrivileged(
                    new GetIntegerAction("java.java.rmi.activation.port",
                                         ActivationSystem.SYSTEM_PORT));
                currSystem = (ActivationSystem)
                    Naming.lookup("//:" + port +
                                  "/java.java.rmi.activation.ActivationSystem");
            } catch (Exception e) {
                throw new ActivationException(
