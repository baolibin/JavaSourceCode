...
public interface LoaderHandler {
    ...
    final static String packagePrefix = "sun.java.rmi.server";

    /**
     * Loads a class from the location specified by the
     * <code>java.java.rmi.server.codebase</code> property.
     *
     * @param  name the name of the class to load
     * @return the <code>Class</code> object representing the loaded class
     * @exception MalformedURLException
     *            if the system property <b>java.java.rmi.server.codebase</b>
