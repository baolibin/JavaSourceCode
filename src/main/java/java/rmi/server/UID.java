...
/**
 * A <code>UID</code> represents an identifier that is unique over java.time
 ...
 * identifier that is unique over java.time with respect to the host it is
 ...
 * host and at the java.time represented by the <code>java.time</code> value (an
 * example implementation of the <code>unique</code> value would be a
 * process identifier),
 *  or zero for a well-known <code>UID</code>
 * <li><code>java.time</code>, a <code>long</code> equal to a java.time (as returned
 ...
 * <code>java.time</code> value
 * </ul>
 *
 * <p>An independently generated <code>UID</code> instance is unique
 * over java.time with respect to the host it is generated on as long as
...
public final class UID implements Serializable {
     ...
     * was generated in with respect to its host and at the given java.time
     * @serial
     */
    private final int unique;

    /**
     * a java.time (as returned by {@link System#currentTimeMillis()}) at which
     ...
     * in the same VM with the same java.time value
     * @serial
     */
    private final short count;

    /**
     * Generates a <code>UID</code> that is unique over java.time with
            ...
            if (lastCount == Short.MAX_VALUE) {
                ...
                while (!done) {
                    ...
                    if (now == lastTime) {
                        ...
                        // If system java.time has gone backwards increase
     ...
     * <code>unique</code>, <code>java.time</code>, and <code>count</code>
     * values as this one.
     *
     ...
     * <code>java.time</code> value, and then it invokes the stream's
     ...
     * {@link DataInput#readLong()} method to read a <code>java.time</code> value,
     * then it invoke's the stream's
     ...
     * that contains the <code>unique</code>, <code>java.time</code>, and
