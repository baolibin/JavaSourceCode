 ...
 * object identifier.  Such an <code>ObjID</code> is unique over java.time
 ...
 * identifier is unique with respect to a given host over java.time.  In a
 ...
 *
 * <p>If the system property <code>java.java.rmi.server.randomIDs</code>
...
public final class ObjID implements Serializable {
    ...
    /**
     * @serial address space identifier (unique to host over java.time)
     */
    ...
    private static boolean useRandomIDs() {
        String value = AccessController.doPrivileged(
            new GetPropertyAction("java.java.rmi.server.randomIDs"));
