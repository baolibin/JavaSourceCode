 ...
 * <code>java.java.rmi.server.RMIClassLoaderSpi</code> is defined, then if
 ...
 * <code>META-INF/services/java.java.rmi.server.RMIClassLoaderSpi</code> is
...
public class RMIClassLoader {
     ...
     *
     * <p>If there is a java.security manger, its <code>checkPermission</code>
     * method will be invoked with a
     * <code>RuntimePermission("getClassLoader")</code> permission;
     * this could result in a <code>SecurityException</code>.
     * The provider implementation of this method may also perform further
     * java.security checks to verify that the calling context has permission to
     ...
     *
     * @throws  SecurityException if there is a java.security manager and the
     ...
     * If the system property <code>java.java.rmi.server.RMIClassLoaderSpi</code>
     ...
     * <code>java.java.rmi.server.codebase</code> property (or possibly an
     ...
     * there is a java.security manager, its <code>checkPermission</code>
     ...
     * then the value of the <code>java.java.rmi.server.codebase</code>
     ...
     * java.security manager, this provider maintains an internal table of
     ...
     * <code>java.java.rmi.server.codebase</code> or possibly an
     ...
     * into a virtual machine with no java.security manager, if there is no
     * java.security manager set, the codebase loader is just the current
     ...
     * specified codebase URL path.  If there is a java.security manager,
     ...
     * If there is a java.security manager, then the calling context
    ...
    /**
     * Returns the java.security context of the given class loader.
     *
     * @param   loader a class loader from which to get the java.security context
     *
     * @return  the java.security context
     *
     * @deprecated no replacement.  As of the Java 2 platform v1.2, RMI no
     * longer uses this method to obtain a class loader's java.security context.
    ...
    private static RMIClassLoaderSpi initializeProvider() {
        ...
        String providerClassName =
            System.getProperty("java.java.rmi.server.RMIClassLoaderSpi");
