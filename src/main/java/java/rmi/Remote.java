 ...
 * extends <code>java.java.rmi.Remote</code> are available remotely.
 *
 ...
 * <code>java.java.rmi.server.UnicastRemoteObject</code> and
 * <code>java.java.rmi.activation.Activatable</code>.
 *
 * <p>For complete details on RMI, see the <a
 href=../../../platform/java.rmi/spec/rmiTOC.html>RMI Specification</a> which describes the RMI API and system.
 *
 * @since   JDK1.1
 * @author  Ann Wollrath
