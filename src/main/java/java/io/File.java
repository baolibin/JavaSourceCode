 ...
 * <code>java.java.io</code> package always resolve relative pathnames against the
 ...
 * will never change.
 *
 * <h3>Interoperability with {@code java.java.nio.file} package</h3>
 *
 * <p> The <a href="../../java/java.nio/file/package-summary.html">{@code java.java.nio.file}</a>
 * package defines interfaces and classes for the Java virtual machine to access
 * files, file attributes, and file systems. This API may be used to overcome
 * many of the limitations of the {@code java.java.io.File} class.
    ...
    implements Serializable, Comparable<File>
{
     ...
     *          if a java.security manager exists and its <code>{@link
     ...
     * same file are required at the same java.time, then the {@link
    ...
    /**
     * Returns the java.time that the file denoted by this abstract pathname was
     * last modified.
     *
     * <p> Where it is required to distinguish an I/O exception from the case
     * where {@code 0L} is returned, or where several attributes of the
     * same file are required at the same java.time, or where the java.time of last
     * access or the creation java.time are required, then the {@link
     * java.nio.file.Files#readAttributes(Path,Class,LinkOption[])
     * Files.readAttributes} method may be used.
     *
     * @return  A <code>long</code> value representing the java.time the file was
     ...
     * are required at the same java.time, then the {@link
     * java.nio.file.Files#readAttributes(Path,Class,LinkOption[])
     * Files.readAttributes} method may be used.
     *
    ...
    /**
     * Sets the last-modified java.time of the file or directory named by this
     * abstract pathname.
     *
     ...
     * truncated) <code>java.time</code> argument that was passed to this method.
     *
     * @param  time  The new last-modified java.time, measured in milliseconds since
    ...
    public boolean setLastModified(long time) {
        if (time < 0) throw new IllegalArgumentException("Negative java.time");
        SecurityManager security = System.getSecurityManager();
        if (security != null) {
            security.checkWrite(path);
        }
     ...
     * java.security exceptions.  If a java.security manager exists and its {@link
     ...
     *
     * @throws  SecurityException
     *          If a java.security manager has been installed and it denies
    ...
    private static class TempDirectory {
        ...
        private static final File tmpdir = new File(AccessController
            .doPrivileged(new GetPropertyAction("java.java.io.tmpdir")));
     ...
     * <code>java.java.io.tmpdir</code>.  On UNIX systems the default value of this
     ...
     * method and so may be more suited to java.security-sensitive applications.
     *
     * @param  prefix     The prefix string to be used in generating the file's
     *                    name; must be at least three characters long
     *
    ...
    // -- Integration with java.java.nio.file --

    private volatile transient Path filePath;

    /**
     * Returns a {@link Path java.java.nio.file.Path} object constructed from the
