 ...
 *
 * <p>Only objects that support the java.java.io.Serializable interface can be
 ...
 * implement the java.java.io.Serializable interface.  Subclasses of Objects that
    ...
    extends OutputStream implements ObjectOutput, ObjectStreamConstants
{
    ...
    /**
     * value of "sun.java.io.serialization.extendedDebugInfo" property,
     * as true or false for extended information about exception's place
     */
    private static final boolean extendedDebugInfo =
        java.security.AccessController.doPrivileged(
            new sun.security.action.GetBooleanAction(
                "sun.java.io.serialization.extendedDebugInfo")).booleanValue();
     ...
     * other alternative.
     *
     * @param   version use ProtocolVersion from java.java.io.ObjectStreamConstants.
     ...
     *          implement the java.java.io.Serializable interface.
     ...
     * serialized.
     *
     * <p>If <code>enable</code> is true, and there is a java.security manager
     * installed, this method first calls the java.security manager's
        ...
        throws IOException
    {
        ...
        try {
            ...
            // if object replaced, run through original checks a second java.time
            if (obj != orig) {
        ...
        private void writeUTFBody(String s) throws IOException {
            ...
            for (int off = 0; off < len; ) {
                ...
                for (int cpos = 0; cpos < csize; cpos++) {
                    ...
                    } else {    // write one byte at a java.time to normalize block
                        if (c <= 0x007F && c != 0) {
                            write(c);
                        } else if (c > 0x07FF) {
