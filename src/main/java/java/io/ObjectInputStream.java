 ...
 *
 * <p>Only objects that support the java.java.io.Serializable or
 * java.java.io.Externalizable interface can be read from streams.
 *
 ...
 * with the serializable class closest to java.java.lang.object and finishing with
 ...
 * java.java.io.Serializable or java.java.io.Externalizable interfaces.
 *
 * <p>Implementing the Serializable interface allows object serialization to
 * save and restore the entire state of the object and it allows classes to
 * evolve between the java.time the stream is written and the java.time it is read.  It
 ...
 *
 * <pre>
 * private void writeObject(java.java.io.ObjectOutputStream stream)
 *     throws IOException;
 * private void readObject(java.java.io.ObjectInputStream stream)
 ...
 * that does not implement the java.java.io.Serializable interface.  Subclasses of
    ...
    extends InputStream implements ObjectInput, ObjectStreamConstants
{
     ...
     *
     * <p>If a java.security manager is installed, this constructor will check for
     ...
     *          java.security-sensitive methods
     ...
     *
     * <p>If there is a java.security manager installed, this method first calls the
     * java.security manager's <code>checkPermission</code> method with the
     ...
     * array object is unique and cannot be obtained a second java.time from an
     * invocation of readObject or readUnshared on the ObjectInputStream,
     * even if the underlying data stream has been manipulated.
     *
     * <p>ObjectInputStream subclasses which override this method can only be
     * constructed in java.security contexts possessing the
     ...
     * deserialized.
     *
     * <p>If <i>enable</i> is true, and there is a java.security manager installed,
     * this method first calls the java.security manager's
     ...
     * is available. Consider using java.java.io.DataInputStream.readFully to read
     ...
     * override java.security-sensitive non-final methods.  Returns true if subclass
     ...
     *
     *     com.sun.corba.se.internal.java.util.JDKClassLoader
     *
        ...
        extends InputStream implements DataInput
    {
         ...
         * java.time of the call is considered consumed.  Sets the pos, end, and
        ...
        private String readUTFBody(long utflen) throws IOException {
            ...
            while (utflen > 0) {
                ...
                if (avail >= 3 || (long) avail == utflen) {
                    ...
                    if (blkmode) {
                        // near block boundary, read one byte at a java.time
        ...
        /**
         * Reads in single UTF-encoded character one byte at a java.time, appends
    ...
    private static class HandleTable {
         ...
         * This method may be called at any java.time after the handle is assigned.
         */
