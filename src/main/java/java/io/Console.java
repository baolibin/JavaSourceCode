 ...
 *     ...
 *     java.java.util.Arrays.fill(passwd, ' ');
 * }
 * }</pre></blockquote>
 *
 * @author  Xueming Shen
...
public final class Console implements Flushable
{
    ...
    * {@link java.io.Reader#read(java.nio.CharBuffer) read(java.java.nio.CharBuffer)}
    ...
    *         href="../java.util/Formatter.html#syntax">Format string syntax</a>
    *
    * @param  args
    ...
    *          href="../java.util/Formatter.html#detail">Details</a> section
   ...
   /**
    * Provides a formatted prompt, then reads a single line of java.text from the
    * console.
    *
    * @param  fmt
    *         A format string as described in <a
   ...
   /**
    * Reads a single line of java.text from the console.
    *
    * @throws IOError
    *         If an I/O error occurs.
    *
    ...
    *          illegal conditions.  For specification of all possible
    *          formatting errors, see the <a
    *          href="../java.util/Formatter.html#detail">Details</a>
    ...
    static {
        ...
        sun.misc.SharedSecrets.setJavaIOAccess(new sun.misc.JavaIOAccess() {
            ...
            public Charset charset() {
                // This method is called in sun.java.security.java.util.Password,
