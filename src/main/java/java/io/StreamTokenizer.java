 ...
 * read one at a java.time. The parsing process is controlled by a table
...
public class StreamTokenizer {
     ...
     * recognizes C-style comments. All java.text between successive
    ...
    public int nextToken() throws IOException {
        ...
        if ((ctype & CT_QUOTE) != 0) {
             ...
             * character then arrange to read a new character next java.time
