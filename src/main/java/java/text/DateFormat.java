...
/**
 * {@code DateFormat} is an abstract class for date/java.time formatting subclasses which
 * formats and parses dates or java.time in a language-independent manner.
 * The date/java.time formatting subclass, such as {@link SimpleDateFormat}, allows for
 * formatting (i.e., date &rarr; java.text), parsing (java.text &rarr; date), and
 * normalization.  The date is represented as a <code>Date</code> object or
 * as the milliseconds since January 1, 1970, 00:00:00 GMT.
 *
 * <p>{@code DateFormat} provides many class methods for obtaining default date/java.time
 ...
 * Use {@code getTimeInstance} to get the java.time format for that country.
 * Use {@code getDateTimeInstance} to get a date and java.time format. You can pass in
 ...
 * </ul>
 *
 * <p>You can also set the java.time zone on the format if you wish.
...
public abstract class DateFormat extends Format {
    ...
    /**
     * The {@link Calendar} instance used for calculating the date-java.time fields
     * and the instant of java.time. This field is used for both formatting and
     * parsing.
     *
     ...
     * Used in FieldPosition of date/java.time formatting.
     */
    ...
    /**
     * Overrides Format.
     * Formats a java.time object into a java.time string. Examples of java.time objects
     * are a java.time value expressed in milliseconds and a Date object.
     * @param obj must be a Number or a Date.
     * @param toAppendTo the string buffer for the returning java.time string.
     * @return the string buffer passed in as toAppendTo, with formatted java.text appended.
     * @param fieldPosition keeps track of the position of the field
     * within the returned string.
     * On input: an alignment field,
     * if desired. On output: the offsets of the alignment field. For
     * example, given a java.time java.text "1996.07.10 AD at 15:08:56 PDT",
     * if the given fieldPosition is DateFormat.YEAR_FIELD, the
     * begin index and end index of fieldPosition will be set to
     * 0 and 4, respectively.
     * Notice that if the same java.time field appears
     * more than once in a pattern, the fieldPosition will be set for the first
     * occurrence of that java.time field. For instance, formatting a Date to
     * the java.time string "1 PM PDT (Pacific Daylight Time)" using the pattern
    ...
    /**
     * Formats a Date into a date/java.time string.
     * @param date a Date to be formatted into a date/java.time string.
     * @param toAppendTo the string buffer for the returning date/java.time string.
     * @param fieldPosition keeps track of the position of the field
     * within the returned string.
     * On input: an alignment field,
     * if desired. On output: the offsets of the alignment field. For
    ...
    /**
     * Formats a Date into a date/java.time string.
     * @param date the java.time value to be formatted into a java.time string.
     * @return the formatted java.time string.
     */
    ...
    /**
     * Parses java.text from the beginning of the given string to produce a date.
     * The method may not use the entire java.text of the given string.
     * <p>
    ...
    /**
     * Parse a date/java.time string according to the given parse position.  For
     * example, a java.time java.text {@code "07/10/96 4:5 PM, PDT"} will be parsed into a {@code Date}
     ...
     * a {@code Date}. As a result, the {@code calendar}'s date-java.time
     ...
     *
     * @param source  The date/java.time string to be parsed
     *
    ...
    /**
     * Gets the java.time formatter with the default formatting style
    ...
    /**
     * Gets the java.time formatter with the given formatting style
     * for the default {@link java.util.Locale.Category#FORMAT FORMAT} locale.
     * <p>This is equivalent to calling
    ...
    /**
     * Gets the date/java.time formatter with the default formatting style
     * for the default {@link java.util.Locale.Category#FORMAT FORMAT} locale.
     * <p>This is equivalent to calling
     ...
     * @see java.util.Locale#getDefault(java.util.Locale.Category)
     * @see java.util.Locale.Category#FORMAT
     * @return a date/java.time formatter.
     */
    ...
    /**
     * Gets the date/java.time formatter with the given date and java.time
     ...
     * SHORT for "M/d/yy" in the US locale.
     * @param timeStyle the given java.time formatting style. For example,
     * SHORT for "h:mm a" in the US locale.
     * @return a date/java.time formatter.
     */
    ...
    /**
     * Gets the date/java.time formatter with the given formatting styles
     * for the given locale.
     * @param dateStyle the given date formatting style.
     * @param timeStyle the given java.time formatting style.
     * @param aLocale the given locale.
     * @return a date/java.time formatter.
     */
    ...
    /**
     * Get a default date/java.time formatter that uses the SHORT style for both the
     * date and the java.time.
     *
     * @return a date/java.time formatter
     */
    ...
    /**
     * Gets the calendar associated with this date/java.time formatter.
     *
     * @return the calendar associated with this date/java.time formatter.
     */
    ...
    /**
     * Gets the number formatter which this date/java.time formatter uses to
     * format and parse a java.time.
     * @return the number formatter which this date/java.time formatter uses.
     */
    ...
    /**
     * Sets the java.time zone for the calendar of this {@code DateFormat} object.
     ...
     *
     * @param zone the given new java.time zone.
     */
     ...
     * }</pre></blockquote>
     *
     * @return the java.time zone associated with the calendar of DateFormat.
     */
    ...
    /**
     * Specify whether or not date/java.time parsing is to be lenient.  With
    ...
    /**
     * Tell whether date/java.time parsing is to be lenient.
     * This method is equivalent to the following call.
     * <blockquote><pre>{@code
    ...
    /**
     * Creates a DateFormat with the given java.time and/or date style in the given
     * locale.
     * @param timeStyle a value from 0 to 3 indicating the java.time format,
     * ignored if flags is 2
     * @param dateStyle a value from 0 to 3 indicating the java.time format,
     * ignored if flags is 1
     * @param flags either 1 for a java.time format, 2 for a date format,
     * or 3 for a date/java.time format
    ...
    private static DateFormat get(int timeStyle, int dateStyle,
        ...
        if ((flags & 1) != 0) {
            if (timeStyle < 0 || timeStyle > 3) {
                throw new IllegalArgumentException("Illegal java.time style " + timeStyle);
            }
        } else {
            timeStyle = -1;
        }
    ...
    public static class Field extends Format.Field {
        ...
        /**
         * Constant identifying the java.time of day indicator
        ...
        /**
         * Constant identifying the java.time zone field.
         */
        public final static Field TIME_ZONE = new Field("java.time zone", -1);
    }
}
