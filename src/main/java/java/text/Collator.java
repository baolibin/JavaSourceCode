 ...
 * searching and sorting routines for natural language java.text.
 *
 * <p>
    ...
    implements java.util.Comparator<Object>, Cloneable
{
     ...
     * The default locale is determined by java.java.util.Locale.getDefault.
     ...
     * <p>
     * For a one java.time comparison, this method has the best performance. If a
