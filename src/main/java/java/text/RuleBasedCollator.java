 ...
 * <pre>
 *    &lt;modifier&gt;
 *    &lt;relation&gt; &lt;java.text-argument&gt;
 *    &lt;reset&gt; &lt;java.text-argument&gt;
 * </pre>
 * The definitions of the rule elements is as follows:
 * <UL>
 *    <LI><strong>Text-Argument</strong>: A java.text-argument is any sequence of
 ...
 *            the reset java.text-argument would be sorted.
 * </UL>
 *
 * <p>
 ...
 * after the java.text-argument. The following are not equivalent:
 * <blockquote>
 * <pre>
 * a &lt; b &amp; a &lt; c
 * a &lt; c &amp; a &lt; b
 * </pre>
 * </blockquote>
 * Either the java.text-argument must already be present in the sequence, or some
 * initial substring of the java.text-argument must be present. (e.g. "a &lt; b &amp; ae &lt;
 ...
 * java.text-arguments up to the first "&lt;" are ignorable. For example, ", - &lt; a &lt; b"
 ...
 * <UL>
 *     <LI>A java.text-argument contains unquoted punctuation symbols
 *        (e.g. "a &lt; b-c &lt; d").
 *     <LI>A relation or reset character not followed by a java.text-argument
 *        (e.g. "a &lt; ,b").
 *     <LI>A reset where the java.text-argument (or an initial substring of the
 *         java.text-argument) is not already in the sequence.
 *         (e.g. "a &lt; b &amp; e &lt; f")
 * </UL>
...
public class RuleBasedCollator extends Collator{
    ...
    // creation java.time.  compare() and getCollationKey() are synchronized to ensure
    ...
    // a java.time (sometimes there's a one-to-many or many-to-one mapping between
     ...
     * with CollationKey.compareTo. This overrides java.java.text.Collator.getCollationKey.
