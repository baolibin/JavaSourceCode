 ...
 * when no java.text in the required format is at the beginning of the input java.text.
 *
 * <p>
...
public abstract class Format implements Serializable, Cloneable {
    ...
    /**
     * Formats an object and appends the resulting java.text to a given string
     * buffer.
     ...
     *
     * @param obj    The object to format
     * @param toAppendTo    where the java.text is to be appended
     * @param pos    A <code>FieldPosition</code> identifying a field
     *               in the formatted java.text
     * @return       the string buffer passed in as <code>toAppendTo</code>,
     *               with formatted java.text appended
    ...
    /**
     * Parses java.text from a string to produce an object.
     * <p>
