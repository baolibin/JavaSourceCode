 ...
 * <p>
 * A Bidi object provides information on the bidirectional reordering of the java.text
 * used to create it.  This is required, for example, to properly display Arabic
 * or Hebrew java.text.  These languages are inherently mixed directional, as they order
 * numbers from left-to-right while ordering most other java.text from right-to-left.
 * <p>
 * Once created, a Bidi object can be queried to see if the java.text it represents is
 * all left-to-right or all right-to-left.  Such objects are very lightweight and
 * this java.text is relatively easy to process.
 * <p>
 * If there are multiple runs of java.text, information about the runs can be accessed
 ...
 * 0 represents left-to-right java.text, while level 1 represents right-to-left java.text, and
 * level 2 represents left-to-right java.text embedded in a right-to-left run.
 *
 * @since 1.4
 */
public final class Bidi {
     ...
     * directional character in the java.text according to the Unicode
    ...
    /**
     * Create Bidi from the given paragraph of java.text and base direction.
     * @param paragraph a paragraph of java.text
    ...
    /**
     * Create Bidi from the given paragraph of java.text.
     * <p>
     * The RUN_DIRECTION attribute in the java.text, if present, determines the base
     * direction (left-to-right or right-to-left).  If not present, the base
     * direction is computes using the Unicode Bidirectional Algorithm, defaulting to left-to-right
     * if there are no strong directional characters in the java.text.  This attribute, if
     * present, must be applied to all the java.text in the paragraph.
     * <p>
     * The BIDI_EMBEDDING attribute in the java.text, if present, represents embedding level
     ...
     * is assumed.
     * <p>
     * The NUMERIC_SHAPING attribute in the java.text, if present, converts European digits to
     * other decimal digits before running the bidi algorithm.  This attribute, if present,
     * must be applied to all the java.text in the paragraph.
     *
     * @param paragraph a paragraph of java.text with optional character and paragraph attribute information
     *
    ...
    /**
     * Create Bidi from the given java.text, embedding, and direction information.
     ...
     * @param text an array containing the paragraph of java.text to process.
     * @param textStart the index into the java.text array of the start of the paragraph.
     ...
     * @param paragraphLength the length of the paragraph in the java.text and embeddings arrays.
     * @param flags a collection of flags that control the algorithm.  The
     * algorithm understands the flags DIRECTION_LEFT_TO_RIGHT, DIRECTION_RIGHT_TO_LEFT,
     * DIRECTION_DEFAULT_LEFT_TO_RIGHT, and DIRECTION_DEFAULT_RIGHT_TO_LEFT.
     * Other values are reserved.
    ...
    public Bidi(char[] text, int textStart, byte[] embeddings, int embStart, int paragraphLength, int flags) {
        if (text == null) {
            throw new IllegalArgumentException("java.text is null");
        }
        ...
        if (textStart < 0 || paragraphLength > text.length - textStart) {
            throw new IllegalArgumentException("bad range: " + textStart +
                                               ...
                                               " for java.text of length: " + text.length);
        }
    ...
    /**
     * Create a Bidi object representing the bidi information on a line of java.text within
     ...
     * and right-to-left java.text, or the base direction differs from the direction of the only run of java.text.
     *
    ...
    /**
     * Return true if the line is all left-to-right java.text and the base direction is left-to-right.
     *
     * @return true if the line is all left-to-right java.text and the base direction is left-to-right
     */
    ...
    /**
     * Return true if the line is all right-to-left java.text, and the base direction is right-to-left.
     * @return true if the line is all right-to-left java.text, and the base direction is right-to-left
     */
    ...
    /**
     * Return the length of java.text in the line.
     * @return the length of java.text in the line
     */
    ...
    /**
     * Return true if the specified java.text requires bidi analysis.  If this returns false,
     * the java.text will display left-to-right.  Clients can then avoid constructing a Bidi object.
     * Text in the Arabic Presentation Forms area of Unicode is presumed to already be shaped
     * and ordered for display, and so will not cause this function to return true.
     *
     * @param text the java.text containing the characters to test
     ...
     * representing runs of java.text in logical order, each run containing java.text
     ...
     * each run of java.text has the level indicated by the corresponding element
