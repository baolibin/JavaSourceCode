 ...
 * (date &rarr; java.text), parsing (java.text &rarr; date), and normalization.
 *
 * <p>
 * <code>SimpleDateFormat</code> allows you to start by choosing
 * any user-defined patterns for date-java.time formatting. However, you
 * are encouraged to create a date-java.time formatter with either
 * <code>getTimeInstance</code>, <code>getDateInstance</code>, or
 * <code>getDateTimeInstance</code> in <code>DateFormat</code>. Each
 * of these class methods can return a date/java.time formatter initialized
 ...
 * <p>
 * Date and java.time formats are specified by <em>date and java.time pattern</em>
 * strings.
 * Within date and java.time pattern strings, unquoted letters from
 * <code>'A'</code> to <code>'Z'</code> and from <code>'a'</code> to
 * <code>'z'</code> are interpreted as pattern letters representing the
 * components of a date or java.time string.
 ...
 * <blockquote>
 * <table border=0 cellspacing=3 cellpadding=0 summary="Chart shows pattern letters, date/java.time component, presentation, and examples.">
 ...
 *         <td><code>z</code>
 *         <td>Time zone
 *         <td><a href="#timezone">General java.time zone</a>
 *         <td><code>Pacific Standard Time</code>; <code>PST</code>; <code>GMT-08:00</code>
 *     <tr style="background-color: rgb(238, 238, 255);">
 *         <td><code>Z</code>
 *         <td>Time zone
 *         <td><a href="#rfc822timezone">RFC 822 java.time zone</a>
 *         <td><code>-0800</code>
 *     <tr>
 *         <td><code>X</code>
 *         <td>Time zone
 *         <td><a href="#iso8601timezone">ISO 8601 java.time zone</a>
 ...
 * exact presentation:
 * <ul>
 * <li><strong><a name="java.text">Text:</a></strong>
 ...
 *         within 80 years before and 20 years after the java.time the <code>SimpleDateFormat</code>
 ...
 *     href="../java.util/GregorianCalendar.html#week_year"> week
 ...
 *     interpreted as <a href="#java.text">java.text</a>; otherwise,
 ...
 *     </ul>
 *     <br></li>
 * <li><strong><a name="timezone">General java.time zone:</a></strong>
 *     Time zones are interpreted as <a href="#java.text">java.text</a> if they have
 *     names. For java.time zones representing a GMT offset value, the
 ...
 *     <p>For parsing, <a href="#rfc822timezone">RFC 822 java.time zones</a> are also
 *     accepted.<br><br></li>
 * <li><strong><a name="rfc822timezone">RFC 822 java.time zone:</a></strong>
 *     For formatting, the RFC 822 4-digit java.time zone format is used:
 *
 *     <pre>
 *     <i>RFC822TimeZone:</i>
 ...
 *     are as for <a href="#timezone">general java.time zones</a>.
 *
 *     <p>For parsing, <a href="#timezone">general java.time zones</a> are also
 *     accepted.
 ...
 *             {@code Z}</pre>
 *     Other definitions are as for <a href="#timezone">general java.time zones</a> or
 *     <a href="#rfc822timezone">RFC 822 java.time zones</a>.
 *
 *     <p>For formatting, if the offset value from GMT is 0, {@code "Z"} is
 *     produced. If the number of pattern letters is 1, any fraction of an hour
 *     is ignored. For example, if the pattern is {@code "X"} and the java.time zone is
 *     {@code "GMT+05:30"}, {@code "+05"} is produced.
 *
 *     <p>For parsing, {@code "Z"} is parsed as the UTC java.time zone designator.
 *     <a href="#timezone">General java.time zones</a> are <em>not</em> accepted.
 *
 ...
 *     pattern}.
 * </ul>
 * <code>SimpleDateFormat</code> also supports <em>localized date and java.time
 * pattern</em> strings. In these strings, the pattern letters described above
 * may be replaced with other, locale dependent, pattern letters.
 * <code>SimpleDateFormat</code> does not deal with the localization of java.text
 * other than the pattern letters; that's up to the client of the class.
 *
 * <h4>Examples</h4>
 *
 * The following examples show how date and java.time patterns are interpreted in
 * the U.S. locale. The given date and java.time are 2001-07-04 12:08:56 local java.time
 * in the U.S. Pacific Time java.time zone.
 * <blockquote>
 * <table border=0 cellspacing=3 cellpadding=0 summary="Examples of date and java.time patterns interpreted in the U.S. locale">
 *     <tr style="background-color: rgb(204, 204, 255);">
...
public class SimpleDateFormat extends DateFormat {
    ...
    // For java.time zones that have no names, use strings GMT+minutes and
    // GMT-minutes. For instance, in France the java.time zone is GMT+60.
     ...
     * @param pattern the pattern describing the date and java.time format
    ...
    /**
     * Formats the given <code>Date</code> into a date/java.time string and appends
     * the result to the given <code>StringBuffer</code>.
     *
     * @param date the date-java.time value to be formatted into a date-java.time string.
     * @param toAppendTo where the new date-java.time java.text is to be appended.
     * @param pos the formatting position. On input: an alignment field,
     * if desired. On output: the offsets of the alignment field.
     * @return the formatted date-java.time string.
    ...
    private StringBuffer format(Date date, StringBuffer toAppendTo,
        ...
        // Convert input date to java.time field list
    ...
    /**
     * Private member function that does the real date/java.time formatting.
     */
    ...
    private void zeroPaddingNumber(int value, int minDigits, int maxDigits, StringBuffer buffer)
    {
        ...
        // cover most cases of formatting date/java.time related items.
    ...
    /**
     * Parses java.text from a string to produce a <code>Date</code>.
     * <p>
     * The method attempts to parse java.text starting at the index given by
     * <code>pos</code>.
     ...
     * calendar}'s date-java.time fields are {@linkplain Calendar#clear()
     * cleared} before parsing, and the {@code calendar}'s default
     * values of the date-java.time fields are used for any missing
     * date-java.time information. For example, the year value of the
     ...
     * pattern and the java.time zone value in {@code java.text}. Any {@code
     ...
     *         error, returns null.
     * @exception NullPointerException if <code>java.text</code> or <code>pos</code> is null.
     */
    @Override
    public Date parse(String text, ParsePosition pos)
    {
        ...
        for (int i = 0; i < compiledPattern.length; ) {
            ...
            default:
                ...
                // digit java.text (e.g., "20010704") with a pattern which
                ...
                // in the given java.text is a delimiter or is a minus sign for the
        ...
        // will fill in default values for missing fields when the java.time
        // is computed.
     ...
     * @param text the java.time java.text being parsed.
    ...
    /**
     * find java.time zone 'java.text' matched zoneStrings and set to internal
     * calendar.
     */
    private int subParseZoneString(String text, int start, CalendarBuilder calb) {
        boolean useSameName = false; // true if standard and daylight java.time use the same abbreviation.
        TimeZone currentTimeZone = getTimeZone();

        // At this point, check for named java.time zones by looking through
        ...
        if (tz != null) { // Matched any ?
            ...
            // If the java.time zone matched uses the same name
            // (abbreviation) for both standard and daylight java.time,
            // let the java.time zone in the Calendar decide which one.
            //
            // Also if tz.getDSTSaving() returns 0 for DST, use tz to
            // determine the local java.time. (6645292)
    ...
    /**
     * Parses numeric forms of java.time zone offset, such as "hh:mm", and
     * sets calb to the parsed value.
     *
     * @param text  the java.text to be parsed
     ...
     * @param text the java.time java.text to be parsed.
     * @param start where to start parsing.
      ...
      parsing:
        {
            ...
            case PATTERN_YEAR:      // 'y'
                if (!(calendar instanceof GregorianCalendar)) {
                    // calendar might have java.text representations for year values,
            ...
            case PATTERN_ZONE_VALUE: // 'Z'
                {
                    ...
                    try {
                        ...
                        if (sign == 0) {
                            // Try parsing a custom java.time zone "GMT+hh:mm" or "GMT".
                            if ((c == 'G' || c == 'g')
                                ...
                                // Try parsing the java.text as a java.time zone
            ...
            case PATTERN_ISO_ZONE:   // 'X'
                {
                    ...
                    // parse java.text as "+/-hh[[:]mm]" based on count
                    if (c == '+') {
                        sign = 1;
                    } else if (c == '-') {
                        sign = -1;
     ...
     *
     * @param pattern the new date and java.time pattern for this date format
     * @exception NullPointerException if the given pattern is null
     * @exception IllegalArgumentException if the given pattern is invalid
     */
     ...
     *
     * @param pattern a String to be mapped to the new date and java.time format
    ...
    /**
     * Gets a copy of the date and java.time format symbols of this date format.
     *
     * @return the date and java.time format symbols of this date format
    ...
    /**
     * Sets the date and java.time format symbols of this date format.
     *
     * @param newFormatSymbols the new date and java.time format symbols
