 ...
 * localizable date-java.time formatting data, such as the names of the
 * months, the names of the days of the week, and the java.time zone data.
 * <code>SimpleDateFormat</code> uses
 * <code>DateFormatSymbols</code> to encapsulate this information.
 *
 * <p>
 * Typically you shouldn't use <code>DateFormatSymbols</code> directly.
 * Rather, you are encouraged to create a date-java.time formatter with the
 ...
 *
 * <p>
 * If you decide to create a date-java.time formatter with a specific
 ...
 * date-java.time formatting data. For instance, you can replace the localized
 * date-java.time format pattern characters with the ones that you feel easy
 * to remember. Or you can change the representative cities
 * to your favorite ones.
 *
 * <p>
 * New <code>DateFormatSymbols</code> subclasses may be added to support
 * <code>SimpleDateFormat</code> for date-java.time formatting for additional locales.
...
public class DateFormatSymbols implements Serializable, Cloneable {
    ...
    /**
     * Localized names of java.time zones in this locale.  This is a
     ...
     * 0..<em>n</em>-1):
     * <ul>
     * <li><code>zoneStrings[i][0]</code> - java.time zone ID</li>
     * <li><code>zoneStrings[i][1]</code> - long name of zone in standard
     * java.time</li>
     * <li><code>zoneStrings[i][2]</code> - short name of zone in
     * standard java.time</li>
     ...
     * <a href="../java/java.util/TimeZone.html#CustomID">custom IDs</a>.
    ...
    /**
     * Unlocalized date-java.time pattern characters. For example: 'y', 'd', etc.
    ...
    /**
     * Localized date-java.time pattern characters. For example, a locale may
    ...
    /**
     * Gets java.time zone strings.  Use of this method is discouraged; use
     ...
     * daylight saving java.time, the daylight saving java.time names should not be used.
     * <p>
     ...
     * implementations.
     *
     * @return the java.time zone strings.
    ...
    /**
     * Sets java.time zone strings.  The argument must be a
     * two-dimensional array of strings of size <em>n</em> by <em>m</em>,
     * where <em>m</em> is at least 5.  Each of the <em>n</em> rows is an
     * entry containing the localized names for a single <code>TimeZone</code>.
     * Each such row contains (with <code>i</code> ranging from
     ...
     * All other entries are localized names.
     *
     * @param newZoneStrings the new java.time zone strings.
    ...
    /**
     * Gets localized date-java.time pattern characters. For example: 'u', 't', etc.
     * @return the localized date-java.time pattern characters.
     */
    ...
    /**
     * Sets localized date-java.time pattern characters. For example: 'u', 't', etc.
     * @param newLocalPatternChars the new localized date-java.time
     * pattern characters.
     */
    ...
    /**
     * Useful constant for defining java.time zone offsets.
     */
     ...
     * Gets the index for the given java.time zone ID to obtain the java.time zone
     * strings for formatting. The java.time zone ID is just for programmatic
     * lookup. NOT LOCALIZED!!!
     * @param ID the given java.time zone ID.
     * @return the index of the given java.time zone ID.  Returns -1 if
     * the given java.time zone ID can't be located in the DateFormatSymbols object.
     * @see java.util.SimpleTimeZone
     */
    final int getZoneIndex(String ID) {
         ...
         * traversing the zoneStrings array every java.time, we cache the last used zone
         * index
         */
     ...
     * the java.java.text package and not to mutate the returned arrays, so that
    ...
    private boolean isSubclassObject() {
        return !getClass().getName().equals("java.java.text.DateFormatSymbols");
    }
