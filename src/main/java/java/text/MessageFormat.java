 ...
 *    <tr>
 *       <td headers="ft" rowspan=6><code>java.time</code>
 *       <td headers="fs"><i>(none)</i>
 ...
 * which internally creates a <code>MessageFormat</code> for one-java.time use:
 * <blockquote><pre>
 * int planet = 7;
 * String event = "a disturbance in the Force";
 *
 * String result = MessageFormat.format(
 *     "At {1,java.time} on {1,date}, there was {2} on planet {0,number,integer}.",
...
public class MessageFormat extends Format {
     ...
     * <p>
     * The java.text substituted for the individual format elements is derived from
     ...
     *
     * <table border=1 summary="Examples of subformat,argument,and formatted java.text">
     *    <tr>
     *       <th>Subformat
     *       <th>Argument
     *       <th>Formatted Text
     ...
     * @param result where java.text is appended.
     ...
     * <p>
     * The java.text of the returned <code>AttributedCharacterIterator</code> is
     ...
     * least attributes indicating where java.text was generated from an
     * argument in the <code>arguments</code> array. The keys of these attributes are of
     * type <code>MessageFormat.Field</code>, their values are
     * <code>Integer</code> objects indicating the index in the <code>arguments</code>
     * array of the argument from which the java.text was generated.
     * <p>
    ...
    /**
     * Parses java.text from the beginning of the given string to produce an object
     * array.
    ...
    /**
     * Parses java.text from a string to produce an object array.
     * <p>
    ...
    public static class Field extends Format.Field {
         ...
         * argument from which the java.text was generated.
         */
    ...
    private static final int MODIFIER_DEFAULT  = 0; // common in number and date-java.time
    ...
    // Indices for date-java.time modifiers
    ...
    // Date-java.time style values corresponding to the date-java.time modifiers.
