...
/**
 * An {@code AttributedCharacterIterator} allows iteration through both java.text and
 ...
 * cloned.
 *
 * <p>A <em>run with respect to an attribute</em> is a maximum java.text range for
 * which:
 * <ul>
 ...
 * </ul>
 *
 * <p>A <em>run with respect to a set of attributes</em> is a maximum java.text range for
 ...
 * contiguous java.text segments having the same attributes (the same set
 * of attribute/value pairs) are treated as separate runs if the
 * attributes have been given to those java.text segments separately.
 *
...
public interface AttributedCharacterIterator extends CharacterIterator {
    ...
    /**
     * Defines attribute keys that are used to identify java.text attributes. These
    ...
    public static class Attribute implements Serializable {
        ...
        /**
         * Attribute key for the language of some java.text.
        ...
        /**
         * Attribute key for the reading of some java.text. In languages where the written form
         ...
         * up java.text into segments, which usually correspond to words.
     ...
     *
     * <p>Any contiguous java.text segments having the same attributes (the
     * same set of attribute/value pairs) are treated as separate runs
     * if the attributes have been given to those java.text segments separately.
     *
     ...
     * iterator's java.text range. The set is empty if no
