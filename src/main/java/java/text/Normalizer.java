 ...
 * java.text into an equivalent composed or decomposed form, allowing for easier
 * sorting and searching of java.text.
 ...
 * are searching or comparing java.text, you must ensure that these two sequences are
 ...
 * java.text into the canonical composed and decomposed forms as shown in the first
 ...
 * character encodings the Unicode java.text needs to be normalized to NFC.
