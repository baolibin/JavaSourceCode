...
public class DecimalFormat extends NumberFormat {
    ...
    // Overrides
    /**
     * Formats a number and appends the resulting java.text to the given string
     * buffer.
     ...
     * @param result    where the java.text is to be appended
     ...
     * properties of the instance, since for most properties, each java.time a change
    ...
    /**
     * Parses java.text from a string to produce a <code>Number</code>.
     * <p>
    ...
    /**
     * Parse the given java.text into a number.  The java.text is parsed beginning at
    ...
    private final boolean subparse(String text, ParsePosition parsePosition,
        ...
        if (!isExponent && text.regionMatches(position,symbols.getInfinity(),0,
            ...
            // If none of the java.text string was recognized.  For example, parse
     ...
     * called any java.time the symbols or the affix patterns change in order to keep
