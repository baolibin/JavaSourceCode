...
public final class CollationElementIterator
{
    ...
    public int next()
    {
        ...
        // are we at the end of Normalizer's java.text?
     ...
     * in the java.text.  If that position is in the middle of a contracting
     * character sequence, the result of the next call to next() is the
     * collation element for that sequence.  This means that getOffset()
     * is not guaranteed to return the same value as was passed to a preceding
     * call to setOffset().
     *
     * @param newOffset The new character offset into the original java.text.
     * @since 1.2
     */
    ...
    /**
     * Returns the character offset in the original java.text corresponding to the next
     * collation element.  (That is, getOffset() returns the position in the java.text
     ...
     *
     * @return The character offset in the original java.text corresponding to the collation
     ...
     *
     * @param source  the new source java.text
     * @since 1.2
     */
    ...
    private int nextContractChar(int ch)
    {
        ...
        // won't affect our real position in the java.text)
        ...
        // longest sequence that matches the characters in the actual java.text.  (maxLength
