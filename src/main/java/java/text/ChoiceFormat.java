...
public class ChoiceFormat extends NumberFormat {
     ...
     * @param toAppendTo where java.text is appended.
   ...
   public StringBuffer format(double number, StringBuffer toAppendTo,
    ...
    /**
     * Parses a Number from the input java.text.
     * @param text the source java.text.
     * @param status an input-output parameter.  On input, the
     * status.index field indicates the first character of the
     * source java.text that should be parsed.  On exit, if no error
     * occurred, status.index is set to the first unparsed character
     * in the source java.text.  On exit, if an error did occur,
