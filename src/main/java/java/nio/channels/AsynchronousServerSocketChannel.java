 ...
 * though at most one accept operation can be outstanding at any java.time.
    ...
    implements AsynchronousChannel, NetworkChannel
{
     ...
     *
     * <p> If a java.security manager has been installed then it verifies that the
     * address and port number of the connection's remote endpoint are permitted
     * by the java.security manager's {@link SecurityManager#checkAccept checkAccept}
