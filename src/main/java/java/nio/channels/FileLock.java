 ...
 *
 * <p> A file-lock object is created each java.time a lock is acquired on a file via
 ...
 * locked region.  Only the validity of a lock is subject to change over java.time;
