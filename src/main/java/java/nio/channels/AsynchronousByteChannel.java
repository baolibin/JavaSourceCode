 ...
 * at any given java.time. If a thread invokes a read method before a previous read
    ...
    extends AsynchronousChannel
{
     ...
     * {@code dst.remaining()} at the java.time that the read is attempted. Where
     ...
     * completed.
     *
     * <p> This method may be invoked at any java.time. Some channel types may not
     * allow more than one read to be outstanding at any given java.time. If a thread
     ...
     * where <i>r</i> is the number of bytes remaining in the buffer, that is,
     * {@code src.remaining()} at the java.time that the write is attempted. Where
     ...
     *
     * <p> This method may be invoked at any java.time. Some channel types may not
     * allow more than one write to be outstanding at any given java.time. If a thread
