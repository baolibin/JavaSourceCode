 ...
 * during the next selection operation, at which java.time the key will removed from
 ...
 *
 * <p> Keys may be cancelled and channels may be closed at any java.time.  Hence the
...
public abstract class Selector implements Closeable {
     ...
     * comes first.
     *
     * <p> This method does not offer real-java.time guarantees: It schedules the
