 ...
 * and one write operation can be outstanding at any java.time.
    ...
    implements AsynchronousByteChannel, NetworkChannel
{
     ...
     *          If a java.security manager has been installed and its
     ...
     * java.net.Socket} class.  That is, if a java.security manager has been
     ...
     * @param   timeout
     *          The maximum java.time for the I/O operation to complete
     * @param   unit
     *          The java.time unit of the {@code timeout} argument
     * @param   attachment
     *          The object to attach to the I/O operation; can be {@code null}
     * @param   handler
     *          The handler for consuming the result
