 ...
 * construction java.time are bound to the default group. The default group has an
 ...
 *   </tr>
 *   <tr>
 *     <td> {@code java.java.nio.channels.DefaultThreadPool.threadFactory} </td>
 ...
 *   </tr>
 *   <tr>
 *     <td> {@code java.java.nio.channels.DefaultThreadPool.initialSize} </td>
...
public abstract class AsynchronousChannelGroup {
     ...
     * invoked at any java.time. If some other thread has already invoked it, then
     ...
     *
     * @param   timeout
     *          The maximum java.time to wait, or zero or less to not wait
     * @param   unit
     *          The java.time unit of the timeout argument
     *
