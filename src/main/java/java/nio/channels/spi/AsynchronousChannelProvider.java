...
public abstract class AsynchronousChannelProvider {
    ...
    private static class ProviderHolder {
        ...
        private static AsynchronousChannelProvider loadProviderFromProperty() {
            String cn = System.getProperty("java.java.nio.channels.spi.AsynchronousChannelProvider");
            if (cn == null)
                return null;
            try {
     ...
     *   <tt>java.java.nio.channels.spi.AsynchronousChannelProvider</tt> is defined
     ...
     *   <tt>java.java.nio.channels.spi.AsynchronousChannelProvider</tt> in the resource
