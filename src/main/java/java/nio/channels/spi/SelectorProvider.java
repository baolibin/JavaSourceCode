...
public abstract class SelectorProvider {
    ...
    private static boolean loadProviderFromProperty() {
        String cn = System.getProperty("java.java.nio.channels.spi.SelectorProvider");
        if (cn == null)
            return false;
        try {
     ...
     *   <tt>java.java.nio.channels.spi.SelectorProvider</tt> is defined then it is
     ...
     *   <tt>java.java.nio.channels.spi.SelectorProvider</tt> in the resource
