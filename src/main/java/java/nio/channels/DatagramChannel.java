 ...
 * avoid the overhead of the java.security checks are otherwise performed as part of
 ...
 *       IP_MULTICAST_TTL} </td>
 *     <td> The <em>java.time-to-live</em> for Internet Protocol (IP) multicast
 *       datagrams </td>
 *   </tr>
 *   <tr>
 ...
 * reading and at most one thread may be writing at any given java.time.  </p>
 *
    ...
    implements ByteChannel, ScatteringByteChannel, GatheringByteChannel, MulticastChannel
{
     ...
     *          If a java.security manager has been installed and its {@link
     ...
     *
     * <p> This method performs exactly the same java.security checks as the {@link
     * java.net.DatagramSocket#connect connect} method of the {@link
     * java.net.DatagramSocket} class.  That is, if a java.security manager has been
     ...
     * remote address.
     *
     * <p> This method may be invoked at any java.time.  It will not have any effect
     ...
     *
     * @throws  SecurityException
     *          If a java.security manager has been installed
     ...
     * from, and sends datagrams to, any remote address so long as the java.security
     ...
     * to a specific remote address and a java.security manager has been installed
     * then for each datagram received this method verifies that the source's
     * address and port number are permitted by the java.security manager's {@link
     * java.lang.SecurityManager#checkAccept checkAccept} method.  The overhead
     * of this java.security check can be avoided by first connecting the socket via
     * the {@link #connect connect} method.
     *
     * <p> This method may be invoked at any java.time.  If another thread has
     ...
     * and port number are permitted by the java.security manager's {@link
     * java.lang.SecurityManager#checkConnect checkConnect} method.  The
     * overhead of this java.security check can be avoided by first connecting the
     ...
     *          denied by the java.security manager, or {@code null} if the
