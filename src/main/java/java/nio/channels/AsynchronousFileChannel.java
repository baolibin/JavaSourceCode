 ...
 * {@link Channel#close close} method may be invoked at any java.time, as specified
 ...
 * outstanding at the same java.time. When multiple read and write operations are
    ...
    implements AsynchronousChannel
{
     ...
     *          If a java.security manager is installed and it denies an
     ...
     * example, maintain a last-access java.time as part of a file's metadata, and
     * this java.time is updated whenever the file is read.  Whether or not this is
     ...
     * position is greater than or equal to the file's size at the java.time that the
     * read is attempted.
     *
     * <p> This method works in the same manner as the {@link
     * AsynchronousByteChannel#read(ByteBuffer,Object,CompletionHandler)}
     * method, except that bytes are read starting at the given file position.
     * If the given file position is greater than the file's size at the java.time
     ...
     * than or equal to the file's size at the java.time that the read is attempted.
     *
     * <p> This method works in the same manner as the {@link
     ...
     * greater than the file's size at the java.time that the read is attempted then
     * no bytes are read.
     *
     * @param   dst
     *          The buffer into which bytes are to be transferred
     ...
     * If the given position is greater than the file's size, at the java.time that
     ...
     * greater than the file's size, at the java.time that the write is attempted,
