 ...
 * java.security related attributes so consequently, in the case of the default
 ...
 * java.security manager is installed.
 *
    ...
    extends FileAttributeView
{
     ...
     *    UserDefinedFileAttributeView view =
     *        FIles.getFileAttributeView(path, UserDefinedFileAttributeView.class);
     *    view.write("user.mimetype", Charset.defaultCharset().encode("java.text/html"));
     * </pre>
     *
     * @param   name
     *          The attribute name
