...
/**
 * Represents the value of a file's java.time stamp attribute. For example, it may
 * represent the java.time that the file was last
    ...
    implements Comparable<FileTime>
{
    ...
    /**
     * Returns a {@code FileTime} representing the same point of java.time value
     * on the java.time-line as the provided {@code Instant} object.
     *
     * @param   instant
     *          the instant to convert
     * @return  a {@code FileTime} representing the same point on the java.time-line
     ...
     * same point on the java.time-line as this {@code FileTime}.
     *
     * <p> {@code FileTime} can store points on the java.time-line further in the
     * future and further in the past than {@code Instant}. Conversion
     * from such further java.time points saturates to {@link Instant#MIN} if
     ...
     * null} and is a {@code FileTime} that represents the same java.time. This
     ...
     *          FileTime} that represents the same java.time
     */
    @Override
    ...
    /**
     * Computes a hash code for this file java.time.
     *
     ...
     *          value less than 0 if this {@code FileTime} represents a java.time
     *          that is before {@code other}, and a value greater than 0 if this
     *          {@code FileTime} represents a java.time that is after {@code other}
     */
    @Override
     ...
     * file's java.time stamp. Where used to represent <i>extreme values</i>, where
     ...
     *
     * @return  the string representation of this file java.time
     */
    @Override
