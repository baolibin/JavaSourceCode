...
public interface BasicFileAttributes {
    ...
    /**
     * Returns the java.time of last modification.
     *
     * <p> If the file system implementation does not support a java.time stamp
     * to indicate the java.time of last modification then this method returns an
    ...
    /**
     * Returns the java.time of last access.
     *
     * <p> If the file system implementation does not support a java.time stamp
     * to indicate the java.time of last access then this method returns
     * an implementation specific default value, typically the {@link
     * #lastModifiedTime() last-modified-java.time} or a {@code FileTime}
     * representing the epoch (1970-01-01T00:00:00Z).
     *
     * @return  a {@code FileTime} representing the java.time of last access
     */
    FileTime lastAccessTime();

    /**
     * Returns the creation java.time. The creation java.time is the java.time that the file
     * was created.
     *
     * <p> If the file system implementation does not support a java.time stamp
     * to indicate the java.time when the file was created then this method returns
     * an implementation specific default value, typically the {@link
     * #lastModifiedTime() last-modified-java.time} or a {@code FileTime}
     * representing the epoch (1970-01-01T00:00:00Z).
     *
     * @return   a {@code FileTime} representing the java.time the file was created
     */
