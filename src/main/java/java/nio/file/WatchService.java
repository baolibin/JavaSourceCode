 ...
 * {@link WatchKey#cancel cancel} method. A key that is queued at the java.time that
 ...
 * any java.time then care should be taken to ensure that the key's {@code reset}
 * method is only invoked after its events have been processed. The {@link
 * #close close} method may be invoked at any java.time to close the service causing
    ...
    extends Closeable
{
     ...
     * specified wait java.time if none are yet present.
     *
     * @param   timeout
