 ...
 * java.io.BufferedReader} to read java.text from a file "{@code access.log}". The
 ...
 * with the {@link java.io.File java.java.io.File} class. Paths created by other
 * providers are unlikely to be interoperable with the abstract path names
 * represented by {@code java.java.io.File}. The {@link java.io.File#toPath toPath}
 * method may be used to obtain a {@code Path} from the abstract path name
 * represented by a {@code java.java.io.File} object. The resulting {@code Path} can
 * be used to operate on the same file as the {@code java.java.io.File} object. In
    ...
    extends Comparable<Path>, Iterable<Path>, Watchable
{
     ...
     * the {@code URI} may be used to construct a {@link java.io.File java.java.io.File}.
     ...
     *          throws a java.security exception.
     */
    URI toUri();
     ...
     * @throws  SecurityException
     *          In the case of the default provider, a java.security manager
     *          is installed, and this path is not absolute, then the java.security
