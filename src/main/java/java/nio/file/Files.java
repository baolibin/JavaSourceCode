...
public final class Files {
     ...
     *          In the case of the default provider, and a java.security manager is
     ...
     *          This may invoke the java.security manager's {@link
     ...
     *          if an I/O error occurs
     * @throws  SecurityException
     *          In the case of the default provider, and a java.security manager
     ...
     *     {@link BasicFileAttributes#lastModifiedTime last-modified-java.time} is
     ...
     *          copied the java.security manager is invoked to check {@link
     ...
     * BasicFileAttributes#lastModifiedTime last-modified-java.time} to the target
     ...
     * named {@code java.java.nio.file.spi.FileTypeDetector} in the resource directory
     ...
     *          if an I/O error occurs
     * @throws  SecurityException
     *          If a java.security manager is installed and it denies an unspecified
     ...
     *          if an I/O error occurs
     * @throws  SecurityException
     *          In the case of the default provider, a java.security manager is
     *          installed, its {@link SecurityManager#checkRead(String) checkRead}
     *          method is invoked to check read access to the file. If this
     *          method is invoked to read java.security sensitive attributes then the
     *          java.security manager may be invoke to check for additional permissions.
     */
     ...
     *          to set java.security sensitive attributes then the java.security manager
     ...
     *          to read java.security sensitive attributes then the java.security manager
     *          may be invoked to check for additional permissions.
     */
     ...
     *   <td> Reads the file size, last modified java.time, and last access java.time
     *     attributes. </td>
     * </tr>
     * <tr>
     *   <td> {@code "posix:*"} </td>
    ...
    /**
     * Returns a file's last modified java.time.
     *
     * <p> The {@code options} array may be used to indicate how symbolic links
     * are handled for the case that the file is a symbolic link. By default,
     * symbolic links are followed and the file attribute of the final target
     ...
     *          options indicating how symbolic links are handled
     *
     * @return  a {@code FileTime} representing the java.time the file was last
     *          modified, or an implementation specific default when a java.time
     *          stamp to indicate the java.time of last modification is not supported
     *          by the file system
     *
     * @throws  IOException
     *          if an I/O error occurs
    ...
    /**
     * Updates a file's last modified java.time attribute. The file java.time is converted
     * to the epoch and precision supported by the file system. Converting from
     * finer to coarser granularities result in precision loss. The behavior of
     * this method when attempting to set the last modified java.time when it is not
     * supported by the file system or is outside the range supported by the
     * underlying file store is not defined. It may or not fail by throwing an
     * {@code IOException}.
     *
     * <p> <b>Usage Example:</b>
     * Suppose we want to set the last modified java.time to the current java.time:
     * <pre>
     *    Path path = ...
     ...
     *          the path to the file
     * @param   time
     *          the new last modified java.time
     *
     * @return  the path
     *
     * @throws  IOException
     *          if an I/O error occurs
     * @throws  SecurityException
     *          In the case of the default provider, the java.security manager's {@link
     ...
     * method in java.security sensitive applications.
     *
     * @param   path
     *          the path to the file to test
     * @param   options
     ...
     * when using this method in java.security sensitive applications.
     *
     * @param   path
     *          the path to the file to test
     * @param   options
     ...
     * using this method in java.security sensitive applications.
     *
     * @param   path
     *          the path to the file to check
     *
     ...
     * file is visited, unless denied by the java.security manager. A value of
     ...
     *
     * <p> When a java.security manager is installed and it denies access to a file
     ...
     * @throws  SecurityException
     *          If the java.security manager denies access to the starting file.
     *          In the case of the default provider, the {@link
     ...
     * used to read java.text from the file in an efficient manner. Bytes from the
     ...
     *
     * @return  a new buffered reader, with default buffer size, to read java.text
     *          from the file
     *
     * @throws  IOException
    ...
    /**
     * Opens a file for reading, returning a {@code BufferedReader} to read java.text
     ...
     * that may be used to write java.text to the file in an efficient manner.
     ...
     *
     * <p> The {@code Writer} methods to write java.text throw {@code IOException}
     * if the java.text cannot be encoded using the specified charset.
     *
     * @param   path
     *          the path to the file
     * @param   cs
     ...
     *          options specifying how the file is opened
     *
     * @return  a new buffered writer, with default buffer size, to write java.text
     *          to the file
     *
     * @throws  IOException
    ...
    /**
     * Opens or creates a file for writing, returning a {@code BufferedWriter}
     * to write java.text to the file in an efficient manner. The java.text is encoded
     ...
     *          {@code REPLACE_EXISTING} option is specified, the java.security
        ...
        throws IOException
    {
        ...
        // FileAlreadyExistsException then it may be because the java.security
    ...
    /**
     * Write lines of java.text to a file. Each line is a char sequence and is
     ...
     *          java.text cannot be encoded using the specified charset
     * @throws  UnsupportedOperationException
     *          if an unsupported option is specified
     * @throws  SecurityException
     *          In the case of the default provider, and a java.security manager is
    ...
    /**
     * Write lines of java.text to a file. Characters are encoded into bytes using
     ...
     * @throws  IOException
     *          if an I/O error occurs writing to or creating the file, or the
     *          java.text cannot be encoded as {@code UTF-8}
     * @throws  UnsupportedOperationException
     *          if an unsupported option is specified
     * @throws  SecurityException
     *          In the case of the default provider, and a java.security manager is
