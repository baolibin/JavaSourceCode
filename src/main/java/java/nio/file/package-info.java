 ...
 *
 * <p> The java.java.nio.file package defines classes to access files and file
 ...
 * the abstract path represented by the {@code java.java.io.File} object. The resulting
 ...
 * and {@code java.java.io.File} objects. </p>
 *
 * <h3>Visibility</h3>
