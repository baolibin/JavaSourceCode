 ...
 * for use by sophisticated or java.security sensitive applications requiring to
 ...
 * provider}, and a java.security manager is set, then the permission checks are
    ...
    extends DirectoryStream<T>
{
     ...
     * file is not required to exist at the java.time that the file attribute view
