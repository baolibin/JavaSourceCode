 ...
 * #close close} method may be invoked at any java.time to close a file system but
    ...
    implements Closeable
{
     ...
     * root directory. Unless denied by the java.security manager, each element in
     ...
     * top-level directory.
     *
     * <p> When a java.security manager is installed, it is invoked to check access
     ...
     *
     * <p> In the case of the default provider, and a java.security manager is
     * installed, the java.security manager is invoked to check {@link
     * RuntimePermission}<tt>("getFileStoreAttributes")</tt>. If denied, then
     * no file stores are returned by the iterator. In addition, the java.security
