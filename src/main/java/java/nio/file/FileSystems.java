 ...
 * provider-configuration file named {@code java.java.nio.file.spi.FileSystemProvider}
...
public final class FileSystems {
    ...
    private static class DefaultFileSystemHolder {
        ...
        private static FileSystemProvider getDefaultProvider() {
            ...
            // if the property java.java.nio.file.spi.DefaultFileSystemProvider is
            // set then its value is the name of the default provider (or a list)
            String propValue = System
                .getProperty("java.java.nio.file.spi.DefaultFileSystemProvider");
            if (propValue != null) {
     ...
     * This allows for interoperability with the {@link java.io.File java.java.io.File}
     * class.
     *
     ...
     * system property {@code java.java.nio.file.spi.DefaultFileSystemProvider} is
     * not defined then the default provider is a system-default provider that
     * is invoked to create the default file system.
     *
     * <p> If the system property {@code java.java.nio.file.spi.DefaultFileSystemProvider}
