 ...
 * href="../../java.lang/Character.html#unicode">code units</a> and sequences of
 ...
 *
 * <p> The IANA charset registry does change over java.time, and so the canonical
 * name and the aliases of a particular charset may also change over java.time.  To
    ...
    implements Comparable<Charset>
{
    ...
    static boolean atBugLevel(String bl) {              // package-private
        ...
        if (level == null) {
            ...
            bugLevel = level = AccessController.doPrivileged(
                new GetPropertyAction("sun.java.nio.cs.bugLevel", ""));
        }
    ...
    // those whose lookup or instantiation causes a java.security exception to be
                    ...
                    while (next == null) {
                        try {
                            ...
                            if (sce.getCause() instanceof SecurityException) {
                                // Ignore java.security exceptions
                                continue;
                            }
                            throw sce;
                        }
     ...
     * resulting map, may cause java.time-consuming disk or network I/O operations
